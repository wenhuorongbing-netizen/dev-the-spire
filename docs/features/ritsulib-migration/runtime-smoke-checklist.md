...
only. They do not prove beta.131 enabled-mode gameplay, full gameplay,
...
3. Spire Plus `v0.1.0-private-beta.131` installed at
   `<GameRoot>\mods\EZMicroBalance` from
   `publish/SpirePlus-v0.1.0-private-beta.131.zip`.
...
| 5 | Check `godot.log` for Spire Plus init | Single Spire Plus initialization line, technical id `EZMicroBalance`, package `v0.1.0-private-beta.131` | PASS: beta.128 monkey packet verifier 1621 / 0 |
...
Current exit status: beta.131 package parity, runtime preflight, and
...
- If any beta.131 loader smoke item fails, do not proceed to gameplay items;
  diagnose first.
