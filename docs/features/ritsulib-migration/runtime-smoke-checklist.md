...
3. Spire Plus package from `publish/SpirePlus-v0.1.0-private-beta.96.zip` installed at `<GameRoot>\mods\EZMicroBalance`; package checker is recorded in `PROJECT_STATE.md` as passed on 2026-06-20.
...
| # | Step | Expected | Evidence |
|---|------|----------|----------|
| 1 | Navigate to Mod Settings | Spire Plus appears in mod list for the beta.96 package | [PENDING] |
