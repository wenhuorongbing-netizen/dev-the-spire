...
Current beta.135 package parity, runtime preflight, and source-workspace
...
3. Spire Plus `v0.1.0-private-beta.135` installed at
   `<GameRoot>\mods\EZMicroBalance` from
   `publish/SpirePlus-v0.1.0-private-beta.135.zip`.
...
Current exit status: beta.135 package parity, runtime preflight, and
