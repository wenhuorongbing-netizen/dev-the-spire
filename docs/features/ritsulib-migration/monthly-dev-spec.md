...
- Current target: Spire Plus `v0.1.0-private-beta.104`, Slay the Spire 2 `v0.107.1`, STS2-RitsuLib `v0.4.33`, direct NuGet runtime layout.
...
- Live-ready and release-ready remain blocked by gameplay, save-load, replacement behavior, current beta.104 enabled-mode registration/gameplay proof, co-op, QA, and tester handoff.
...
2. Keep beta.104 clicked UI smoke and beta.99 previous-package Off proof scoped to startup/loading/UI behavior; capture enabled-mode and gameplay proof separately before making those claims.
