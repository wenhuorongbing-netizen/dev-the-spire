...
- Spire Plus now compiles against NuGet `STS2.RitsuLib` `0.4.31`; the manifest dependency floor is `STS2-RitsuLib >= 0.4.31`, and no BaseLib or separate `STS2.RitsuLib.Compat.*` package is used.
