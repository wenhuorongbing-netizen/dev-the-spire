...
- Current target: Spire Plus `v0.1.0-private-beta.97`, Slay the Spire 2 `v0.107.1`, STS2-RitsuLib `v0.4.31`, runtime variant `lib\0.107.1`.
...
- Live-ready and release-ready remain blocked by gameplay, clicked Ancient UI, save-load, replacement behavior, current beta.97 enabled-mode registration/gameplay proof, co-op, QA, and tester handoff.
...
2. Recapture beta.97 loader proof and clicked settings UI proof before making current runtime claims.
