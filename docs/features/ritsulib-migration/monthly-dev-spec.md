...
- Beta.99 direct Off loader smoke remains pending after the settings-page I18N resource migration; beta.99 clicked RitsuLib settings UI proof is current under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/`, and previous beta.96 Off loader smoke is clean previous-package startup/loading context only.
...
2. Recapture beta.99 direct Off loader proof before making current startup/runtime claims.
