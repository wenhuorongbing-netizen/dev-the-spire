...
- Current target: Spire Plus `v0.1.0-private-beta.99`, Slay the Spire 2 `v0.107.1`, STS2-RitsuLib `v0.4.32`, direct NuGet runtime layout.
...
- Beta.99 direct Off loader smoke is current under `.tools/runtime-evidence/v01071-beta99-ritsulib0432-off-direct-20260621-234221/` for startup/loading and default-Off StS1Events behavior; beta.99 clicked RitsuLib settings UI proof is current under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/`, and previous beta.96 Off loader smoke is clean previous-package startup/loading context only.
...
- Live-ready and release-ready remain blocked by gameplay, clicked Ancient UI, save-load, replacement behavior, current beta.99 enabled-mode registration/gameplay proof, co-op, QA, and tester handoff.
...
2. Keep beta.99 direct Off loader proof scoped to startup/loading and default-Off StS1Events behavior; capture enabled-mode and gameplay proof separately before making those claims.
