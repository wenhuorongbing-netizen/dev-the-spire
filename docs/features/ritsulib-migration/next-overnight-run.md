...
- Current beta.123 smoke applied all 127 migrated RitsuLib patch classes from the packaged beta.123 state. Current source has since moved to 152 migrated patch classes and 18 raw Harmony declarations; recapture publish/package/runtime proof before claiming that source state in-game.
