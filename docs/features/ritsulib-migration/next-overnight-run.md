...
- Current repository HEAD must be checked at run start. The latest observed pushed beta.86 package/runtime validation baseline remains `eaaeb5a1`; later pushed governance/test follow-ups exist through at least `254a6f41`.
