...
- The current local game install is `v0.107.1`; installed beta.105 package parity and clicked Ancient UI smoke pass. Previous beta.99 settings/Off proof, previous beta.96 Off proof, and previous beta.93 AdditiveBatch1 loader proof are retained only as previous-package context.
