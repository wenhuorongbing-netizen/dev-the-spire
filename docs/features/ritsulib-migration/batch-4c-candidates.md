...
- Before citing the current source migration as runtime coverage, capture a fresh package/runtime packet that proves the current 158 migrated Spire Plus patch classes apply in the installed game.
