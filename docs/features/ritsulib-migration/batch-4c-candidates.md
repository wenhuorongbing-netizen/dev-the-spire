...
- The current local game install is `v0.107.1`; installed beta.96 package parity passes. Previous beta.93 Off and AdditiveBatch1 loader proof exists under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`.
