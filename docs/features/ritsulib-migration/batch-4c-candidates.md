...
- Before citing the current source migration as runtime coverage, capture a fresh beta.125 loader packet that proves the current 148 migrated Spire Plus patch classes apply in the installed game.
