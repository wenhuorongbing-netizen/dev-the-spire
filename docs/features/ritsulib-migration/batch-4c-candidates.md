...
- Before citing the current source migration as runtime coverage, capture a fresh beta.126 loader packet that proves the current 151 migrated Spire Plus patch classes apply in the installed game.
