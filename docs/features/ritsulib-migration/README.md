...
- Current source target: Slay the Spire 2 `v0.107.1`, `STS2.RitsuLib` `0.4.34`, and Spire Plus `v0.1.0-private-beta.133`.
...
- Current packaged proof: beta.133 build, publish, package parity, runtime
  preflight, and source-workspace validation for the 165/4 source state.
...
- The source inventory has 165 migrated classes and 4 raw Harmony declarations
  remaining; recapture beta.133 runtime smoke before claiming current
...
- Multiplayer Ancient event startup diagnostics now also use RitsuLib
  `IPatchMethod` / `ModPatcher`.
- Current inventory: 165 migrated source patch classes and 4 raw Harmony
  declarations remain in `docs/patch-inventory.md`.
- Boundary: beta.133 was rebuilt, published, packaged, package-checked, runtime
