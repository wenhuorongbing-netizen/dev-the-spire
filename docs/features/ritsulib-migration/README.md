...
- Spire Plus is RitsuLib-only for beta.124.
- Current source target: Slay the Spire 2 `v0.107.1`, `STS2.RitsuLib` `0.4.34`, and Spire Plus `v0.1.0-private-beta.124`.
...
- Current packaged proof: beta.124 package parity, runtime preflight, and
...
- Packaged beta.124 evidence covers build, publish, package parity, runtime preflight, and source-workspace validation.
- Current beta.124 still needs game-launch, runtime patch-count, and clicked UI
  proof for the packaged 144/26 state.
...
- Current inventory: 144 migrated patch classes and 26 raw Harmony declarations
  remain in `docs/patch-inventory.md`.
- Boundary: beta.124 was rebuilt, published, packaged, package-checked, runtime
  ...
  144/26 source state was packaged.
