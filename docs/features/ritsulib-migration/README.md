...
- Spire Plus is RitsuLib-only for beta.125.
- Current source target: Slay the Spire 2 `v0.107.1`, `STS2.RitsuLib` `0.4.34`, and Spire Plus `v0.1.0-private-beta.125`.
...
- Current packaged proof: beta.125 package parity, runtime preflight, and
...
- Packaged beta.125 evidence covers build, publish, package parity, runtime preflight, and source-workspace validation.
- Current beta.125 still needs game-launch, runtime patch-count, and clicked UI
  proof for the packaged 148/22 state.
...
- Current inventory: 148 migrated patch classes and 22 raw Harmony declarations
  remain in `docs/patch-inventory.md`.
- Boundary: beta.125 was rebuilt, published, packaged, package-checked, runtime
  ...
  148/22 source state was packaged.
