...
- Historical May 2026 work referenced `previous package` `3.1.4`; the current repo references `STS2.RitsuLib` `0.4.33` and has only STS2-RitsuLib as the shared runtime dependency.
