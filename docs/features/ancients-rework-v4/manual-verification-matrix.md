...
Status: automated gates passed for the current RitsuLib-only beta.93 package shape; current Off/AdditiveBatch1 loader proof reaches main menu with exactly STS2-RitsuLib and Spire Plus loaded, but it is loader/registration evidence only. Earlier normal Steam-client startup/log verification, page-level Mod Settings UI, A0/A10/A20 DevConsole combat smoke, A11 map/save-load spot checks, and targeted A14 Rootblight hover/starter-notice checks are historical package contexts until rerun on beta.93.
...
| Private-beta package | Pass for package refresh and real installed-folder checker, `publish\SpirePlus-v0.1.0-private-beta.93.zip`, SHA256 `5E9B851F2EF5B42318C10B51DF6C37C9B80A4177A1FD17FADD35AEAD62BAEEF9`; current beta.93 Off/AdditiveBatch1 loader proof is clean for startup/registration only |
...
| Launch Slay the Spire 2 public/main branch | Game reaches main menu | Current direct beta.93 loader proof passed; normal user-profile proof still pending |
