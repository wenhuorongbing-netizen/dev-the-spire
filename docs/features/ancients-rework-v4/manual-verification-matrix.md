...
Status: automated gates passed for the current RitsuLib-only beta.129 no-launch package shape; previous beta.128 clicked UI smoke is retained separately.
Previous beta.128 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260623-062913/` with 4 / 4 Urda, Morvi, Lotha, and normal Vakuu iterations, clean audits, StS1 Off verifier pass, exact game/Ritsu/package markers, 152/152 default runtime Spire Plus patches applied, and packet verification 1621 / 0.
...
Earlier normal Steam-client startup/log verification, A0/A10/A20 DevConsole combat smoke, A11 map/save-load spot checks, and targeted A14 Rootblight hover/starter-notice checks are historical package contexts until rerun on beta.129.
...
| Private-beta package | Pass for package refresh and real installed-folder checker, `publish\SpirePlus-v0.1.0-private-beta.129.zip`, SHA256 `20077741751E2252254987466E213A3CF119AE04F1BFFE7115FC96099C895FF4`; previous beta.128 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260623-062913/` |
...
| Launch Slay the Spire 2 public/main branch | Game reaches main menu | Previous beta.128 clicked Ancient UI smoke captured under `.tools/runtime-evidence/monkey-stability-20260623-062913/`; this is smoke-level UI evidence only |
| Open Settings -> Mod Settings | STS2-RitsuLib appears and Spire Plus appears with id `EZMicroBalance` | Captured for beta.99 under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/` with clean same-session log audit; previous-package context after beta.129 |
