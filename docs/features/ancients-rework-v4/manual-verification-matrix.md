...
Status: automated gates passed for the current RitsuLib-only beta.115 package shape.
...
| Private-beta package | Pass for package refresh and real installed-folder checker, `publish\SpirePlus-v0.1.0-private-beta.115.zip`, SHA256 `0EA6C9925CC24BA9BB00314F117DFE42ADC9B9B0E51190E3E308FF7D8B84322C`; beta.108 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-beta108-20260622-172312/` |
...
| Open Settings -> Mod Settings | STS2-RitsuLib appears and Spire Plus appears with id `EZMicroBalance` | Captured for beta.99 under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/` with clean same-session log audit; previous-package context after beta.115 |
