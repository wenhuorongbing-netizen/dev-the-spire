...
| Private-beta package | Pass for package refresh and real installed-folder checker, `publish\SpirePlus-v0.1.0-private-beta.123.zip`, SHA256 `C226EA4008807591756D475A710B251B41FD7E89582AA263F1F9057403559CB8`; beta.123 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260622-235746/` |
