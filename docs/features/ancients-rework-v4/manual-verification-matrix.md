...
Status: automated gates passed for the current RitsuLib-only beta.132 no-launch package shape; previous beta.128 clicked UI smoke is retained separately.
...
Earlier normal Steam-client startup/log verification, A0/A10/A20 DevConsole combat smoke, A11 map/save-load spot checks, and targeted A14 Rootblight hover/starter-notice checks are historical package contexts until rerun on beta.132.
...
| Private-beta package | Pass for package refresh and real installed-folder checker, `publish\SpirePlus-v0.1.0-private-beta.132.zip`, SHA256 `19E910A0060A1E843D24F77E962A3F45B33F738B3B312EF4608D92E59BB49FD9`; previous beta.128 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260623-062913/` |
...
| Open Settings -> Mod Settings | STS2-RitsuLib appears and Spire Plus appears with id `EZMicroBalance` | Captured for beta.99 under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/` with clean same-session log audit; previous-package context after beta.132 |
