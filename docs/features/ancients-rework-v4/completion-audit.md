...
- Keep Ancient v4.3 behavior stable while Ascension 11-20 develops separately. A11-A20 single-player and host-multiplayer selection patch is implemented but private-beta default-disabled, with host multiplayer A20 warning logs added and full live Ascension/co-op verification pending.
