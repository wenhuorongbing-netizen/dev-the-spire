...
- Historical May 2026 project state: `EZMicroBalance.csproj` referenced `previous package` `3.1.4`; no RitsuLib package was referenced. Current project state supersedes this: `EZMicroBalance.csproj` references `STS2.RitsuLib` `0.4.34` and no previous package.
