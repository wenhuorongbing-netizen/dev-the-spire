...
- Beta.105 forced clicked UI smoke exists for Urda, Morvi, Lotha, and normal Vakuu; gameplay, hover/readability follow-through, save/load, death/failure path, gated Vakuu fight-option, and co-op evidence remain manual gates.
