...
```text
https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.110/SpirePlus-v0.1.0-private-beta.110.zip
```

公开分享前确认 GitHub Release 存在，并且包含：

```text
SpirePlus-v0.1.0-private-beta.110.zip
```
