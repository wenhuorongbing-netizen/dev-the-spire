...
Beta.107 clicked Ancient UI smoke is recorded elsewhere; this work log does not claim live gameplay, hover/readability follow-through, save-load, failure/death path, or co-op proof.
