...
4. Inspect native game source plus RitsuLib/template APIs and prefer supported APIs over Harmony patches; treat previous package references as historical unless the owner explicitly approves a dependency change.
