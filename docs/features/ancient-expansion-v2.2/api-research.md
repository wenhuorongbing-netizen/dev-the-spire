...
- BaseLib `v3.1.4` XML/decompiled local package evidence exposes `CustomAncientModel.CustomScenePath` and patches the Ancient background scene path only for `CustomAncientModel`.
