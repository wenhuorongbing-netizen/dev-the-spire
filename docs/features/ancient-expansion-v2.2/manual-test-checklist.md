...
Beta.105 already captured forced Urda, Morvi, Lotha, and normal Vakuu clicked-screen screenshots/logs. Keep the gated Vakuu fight-option, hover/readability, relic-bar follow-through, save-load, co-op, and gameplay rows pending until their matching live files exist.
