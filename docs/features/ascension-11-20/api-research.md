...
| Area | Evidence | Status |
| --- | --- | --- |
| UI message | `source code/localization/zhs/main_menu_ui.json` maps `NETWORK_ERROR.VERSION_MISMATCH.body` to `你试图加入的游戏与您的杀戮尖�?的版本不同。` | Source-evidenced |
