...
| Soul Fysh | Soul Tide: unanswered Beckons are counted at player turn end, then grant Block after Soul Fysh's turn so the Block is visible before the next player turn begins; Intangible grants 1 Artifact. | More Block per Beckon and a higher team cap. |
