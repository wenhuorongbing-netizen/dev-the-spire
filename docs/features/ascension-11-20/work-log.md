...
- A12 Firemarked Elites, A13 Fission, A14-A18 Rootbud/Rootblight, A17 deep route, A19 Boss Seals, and A20 King Brand stay within the current A11-A20 scope.
- A21-A30 and custom characters remain out of scope.
- Firemark, Banner, Boss Seal, and shared Ascension combat helpers have been split out of the central combat modifier file.
- Boss Seal effect groups are below the current refactor size threshold.
