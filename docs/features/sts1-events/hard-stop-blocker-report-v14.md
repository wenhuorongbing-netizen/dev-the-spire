...
Current supersession, 2026-06-21: beta.93 `v0.107.1` proof now covers RitsuLib-only Off and AdditiveBatch1 loader/registration only; it still does not prove gameplay, save-load, replacement, multiplayer, image/render, QA, handoff, or release readiness. Treat any extra shared framework dependency wording below as historical, not current instruction.
