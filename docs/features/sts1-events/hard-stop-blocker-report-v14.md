...
1. Historical action at capture time: rerun loader smoke with the then-required BaseLib + STS2-RitsuLib + Spire Plus stack. Current beta.93 action: use the RitsuLib-only runtime commands from `PROJECT_STATE.md` and `docs/features/sts1-events/README.md`.
