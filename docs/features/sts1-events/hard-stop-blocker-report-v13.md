...
Current supersession, 2026-06-21: beta.93 `v0.107.1` proof now covers RitsuLib-only Off and AdditiveBatch1 loader/registration only; it still does not prove gameplay, save-load, replacement, multiplayer, image/render, QA, handoff, or release readiness. Treat any previous package runtime prerequisite text below as historical, not current instruction.
...
D:\Steam\steamapps\common\Slay the Spire 2\mods\previous package: False
...
E:\Steam\steamapps\common\Slay the Spire 2\mods\previous package: True
