...
**Current runtime/co-op fail-closed: PENDING for multiplayer and gameplay proof; previous beta.93 `v0.107.1` Off and AdditiveBatch1 loader proof is clean, but it is not co-op or gameplay evidence, and CanaryOnly-specific claims require fresh current-version proof.**
