...
| 19 | `sts1_shining_light` | `Sts1ShiningLight` | 1 | `false` | Per-player enter/leave decision; per-player card upgrade | Each player independently enters (takes damage, upgrades 2 own cards) or leaves | Each player | Per-player state | — |
