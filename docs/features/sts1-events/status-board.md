...
| Format | previous pass / current rerun pending | `PROJECT_STATE.md` records format results per validation lane. Current format revalidation should rerun after the beta.86 doc/guard edits. |
