...
| Gate | Status | Blocker |
|------|--------|---------|
| Runtime path report (O21) | **current prerequisite pass** | E-drive game root, STS2-RitsuLib v0.4.31 with `lib\0.107.1`, and Spire Plus beta.93 package-parity install are present. previous package is previous-package/other-mod context only. |
