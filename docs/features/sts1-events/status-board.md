...
| Gate | Status | Blocker |
|------|--------|---------|
| Runtime path report (O21) | **current prerequisite pass** | E-drive game root, STS2-RitsuLib v0.4.32 direct NuGet runtime layout, and Spire Plus beta.98 package-parity install are present. previous package is previous-package/other-mod context only. |
