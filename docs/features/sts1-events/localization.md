...
Previous beta.93 resource/package coverage treats the StS1 event localization files as no-game file-parity verified, not source-reference complete and not runtime-render verified.
...
Previous beta.93 Off/AdditiveBatch1 loader proof is not localization render proof.
