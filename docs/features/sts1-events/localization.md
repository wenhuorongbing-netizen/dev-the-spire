...
```json
{
  ...
  "STS1_BIG_FISH.pages.INITIAL.options.BOX.title": "Open the Box",
  "STS1_BIG_FISH.pages.INITIAL.options.BOX.description": "Obtain 1 random relic. Obtain Regret.",
  ...
  "STS1_BIG_FISH.pages.BOX.description": "You open the box and find something useful... and something cursed."
}
```
...
```json
{
  ...
  "STS1_BIG_FISH.pages.INITIAL.options.BOX.title": "打开盒子",
  "STS1_BIG_FISH.pages.INITIAL.options.BOX.description": "获得1个随机遗物。获得悔恨。",
  "STS1_BIG_FISH.pages.BANANA.description": "你吃了香蕉。真好吃！",
  "STS1_BIG_FISH.pages.DONUT.description": "你吃了甜甜圈。你感觉更强壮了！",
  "STS1_BIG_FISH.pages.BOX.description": "你打开盒子，找到了一些有用的东西……还有一些被诅咒的东西。"
}
```
