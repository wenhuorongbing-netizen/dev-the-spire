...
Current beta.85 resource parity coverage treats the StS1 event localization files as no-game file-parity verified, not source-reference complete and not runtime-render verified.
...
Current beta.85 Off loader proof is not localization render proof.
