...
Current beta.91 resource/package coverage treats the StS1 event localization files as no-game file-parity verified, not source-reference complete and not runtime-render verified.
...
Current beta.91 Off/AdditiveBatch1 loader proof is not localization render proof.
