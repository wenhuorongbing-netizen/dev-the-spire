...
1. Current `v0.107.0` CanaryOnly enabled-mode smoke with 4 event types / 6 source registration calls.
2. Current `v0.107.0` AdditiveBatch1 enabled-mode smoke with 10 event types / 14 source registration calls.
