...
> Created: 2026-05-29  
> Status: No StS1 event images exist. All entries require asset creation or local extraction.
...
- Original StS1 art may NOT be committed without redistribution permission
- Options: (a) Spire Plus-owned/generated replacement art, (b) local extraction outside repo, (c) confirmed redistributable sources
- Current approach: placeholder until redistribution policy is resolved
...
| 20 | sts1_dead_adventurer | Sts1DeadAdventurer | — | missing (blocked) | — |
| 21 | sts1_mushrooms | Sts1Mushrooms | — | missing | — |
| 22 | sts1_scorpion_nest | Sts1ScorpionNest | — | missing (blocked) | — |
| 23 | sts1_treasure_ooze | Sts1TreasureOoze | — | missing (blocked) | — |
...
| 33 | sts1_masked_bandits | Sts1MaskedBandits | — | missing (blocked) | — |
| 34 | sts1_nloth | Sts1Nloth | — | missing (blocked) | — |
...
| 42 | sts1_mysterious_sphere | Sts1MysteriousSphere | — | missing (blocked) | — |
...
No redistributable StS1 art sources confirmed. Cannot create runtime-loadable images without:
1. Redistribution permission for original StS1 event art, OR
2. Spire Plus-owned replacement art (generated or commissioned), OR
3. Local extraction path documented (art stays outside repo)

**O12 verdict: BLOCKED — no images to hash, load, or screenshot.**
