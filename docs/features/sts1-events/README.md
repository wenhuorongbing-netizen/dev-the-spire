...
Previous beta.93 `v0.107.1` RitsuLib-only AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` covers loader/registration only: main-menu startup, 25/25 Spire Plus patches, 10 event types, 14 registration calls, clean audit, retained enabled-mode verifier 31 / 0, and runtime packet verifier 61 / 0. Previous beta.93 Off proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` also passed packet verifier 43 / 0. Retained beta.85 Off/CanaryOnly, beta.87 AdditiveBatch1, beta.88 previous package, and beta.90 RitsuLib-only logs remain previous-package/game-version loader context. Runtime gameplay, save-load, image rendering, replacement-pool behavior, multiplayer behavior, independent QA, tester handoff, and game-native AutoSlay/monkey batch proof remain unverified.
