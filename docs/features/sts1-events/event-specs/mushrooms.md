...
### Class: `Sts1Mushrooms`
- **Registration:** `Sts1EventRegistrationService` registers this StS1 Act 1 event into both StS2 Act 1 buckets with `content.ActEvent<Overgrowth, Sts1Mushrooms>()` and `content.ActEvent<Underdocks, Sts1Mushrooms>()`.
- **Layout:** Default
