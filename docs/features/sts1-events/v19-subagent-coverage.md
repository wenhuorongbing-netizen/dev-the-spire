...
| Enabled-Mode Loader Subagent | runtime-blocked | beta.85 default-Off proof exists, but CanaryOnly and AdditiveBatch1 enabled-mode packets do not. | Capture current CanaryOnly and AdditiveBatch1 loader proof after coordination pause. |
