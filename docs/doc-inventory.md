...
- `docs/test-plan.md` current artifact and manual load checks now require the RitsuLib-only lane (`STS2-RitsuLib >= 0.4.32` plus `EZMicroBalance`) and are guarded against reintroducing old dependency-package setup instructions.
