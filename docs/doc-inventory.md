...
- Full historical validation ledger `docs/reviews/current-validation.md` -> `docs/archive/feature-audits/current-validation-full-20260622.md`; active validation file is a compact current beta.107/RitsuLib evidence summary.
...
- `docs/test-plan.md` current artifact and manual load checks now require the RitsuLib-only lane (`STS2-RitsuLib >= 0.4.33` plus `EZMicroBalance`) and are guarded against reintroducing old dependency-package setup instructions.
...
- `docs/goals/m5-revision-m-final-report.md`, `docs/goals/m5-revision-m-owner-review-packet.md`, `docs/goals/m5-revision-m-runtime-drift-report.md`, `docs/goals/m5-revision-m-patch-failure-ledger.md`, `docs/goals/m5-revision-m-version-decision.md`, and `docs/goals/m5-revision-m-commit-slices.md` full beta.85/beta.87 planning records -> `docs/archive/legacy-planning/m5-revision-m-*.md`; active files are now compact historical-boundary stubs.
- `docs/goals/m5-revision-n-final-report.md`, `docs/goals/m5-revision-n-owner-commit-packet.md`, `docs/goals/m5-revision-n-validation-replay.md`, and `docs/goals/m5-revision-n-runtime-evidence-plan.md` full beta.88/previous package planning records -> `docs/archive/legacy-planning/m5-revision-n-*-20260619.md`; active files are now compact historical-boundary stubs.
