...
- Full historical validation ledger `docs/reviews/current-validation.md` -> `docs/archive/feature-audits/current-validation-full-20260622.md`; active validation file is a compact current beta.114/RitsuLib evidence summary.
