...
| Current worktree batch pathspecs | `.tools/worktree-batches/current/` | Ignored local staging aids generated by `scripts/report-worktree-batches.ps1`; current 2026-05-23 snapshot has 151 dirty entries and 0 unclassified paths after the A19/A20 package hash sync. |
