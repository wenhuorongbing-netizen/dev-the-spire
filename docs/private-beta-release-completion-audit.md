...
| Current automated tests | `dotnet build EZMicroBalance.sln -m:1` passes with 0 errors / 89 Sts1Events nullable warnings; current project no-build tests pass with 464 passed / 21 skipped / 0 failed / 485 total; `dotnet test EZMicroBalance.sln -c Release` previously passed with 81 passed / 18 skipped; latest package refresh evidence includes `STS2_PATH=E:\Steam\steamapps\common\Slay the Spire 2` plus `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln` with 473 passed / 0 skipped after the 2026-05-31 E-drive package refresh. | Automated build/test/artifact pass; live/manual evidence pending |
