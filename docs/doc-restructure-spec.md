...
| 3 | **RitsuLib integration** (PR5/PR6+) | `integrations/ritsulib.md`, `migration.md` | Current beta.97 RitsuLib-only compile/manifest/package/settings target active; beta.96 and beta.93 loader/settings proof retained only as previous-package evidence; later patch migrations gated |
