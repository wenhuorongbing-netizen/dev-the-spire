...
| 2026-05-22 | `v0.106.0`, `2026-05-21T16:17:40-07:00` | `v3.1.4` | PARTIAL | `source code/` cleaned and regenerated from current PCK/DLL; Core API diffs recorded; project build, default tests, publish, package refresh, and beta.17 30-field loader smoke passed. Current beta.19 loader and gameplay matrix remain pending. |
