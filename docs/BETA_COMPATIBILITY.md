...
- Active static/package verification: `source code/` was refreshed from the v0.106.1 installed PCK/DLL, project build/test/publish/package pass with BaseLib v3.1.4, and package hashes are synced in current release docs.
