...
- Current source defines 30 SavedSpireFields. Historical 22-field and 16-field startup rows remain useful records only; beta.68 loader parity and gameplay proof still need fresh live evidence.
...
- Current beta.68 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, preview-tools, and co-op verification remain pending.

## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: passed, 296 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: passed, 316 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-26 after the beta.68 Morvi Open-Book state split package sync. Result: exit code 0 with no warnings.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.68.zip`, `D:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.68.zip` were refreshed and hash-checked on 2026-05-26 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.68 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `D45A95A02A5F0920325240E7747FC74459745F9A2CDAA38EBF30547A92772D47`.
- Last staging/versioned DLL hash check: SHA256 `086C7E64C8392F49FBD2D2A5220F59D8B074A4E6756D3F58788A7BECC94AD21E`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.68.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-05-26. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `816E6D22DBAD81B499FFF8A94BCB731471FB2AC69852123E534F548D46F2185E`
  - DLL SHA256: `086C7E64C8392F49FBD2D2A5220F59D8B074A4E6756D3F58788A7BECC94AD21E`
  - README SHA256: `813A22D37EB3E2627D44321644E3651F04D7820265D2A768C35C2E19BE107F0B`
  - Manifest SHA256: `D40110838FE5A284AFA16760ADA394CBD6C305A633A56682FEB70CED1D2A4DA8`
  - PCK SHA256: `D45A95A02A5F0920325240E7747FC74459745F9A2CDAA38EBF30547A92772D47`
