...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.135.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.135.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.135.zip` were refreshed and hash-checked on 2026-06-23 for local manual testing.
  ...
  - beta.135 package parity, source-workspace validation, and runtime preflight are current package context; beta.128 clicked UI smoke is previous-package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.135.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.135.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-23. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - DLL SHA256: `10649A95C03F762B73CA15D13024308CB53E8412B89BC53236B37425535437E2`
  - README SHA256: `9115BA2D49F9D840F0C06FF01EF898B14C4DE432B844EE2ABCF01240BD353CF2`
  - Manifest SHA256: `D1C63A62C6FD30E4713059C22E296413B42620753AC6FB13A4F0615888CF0716`
  - PCK SHA256: `9EF01340EE2118A2ECA1E721A9B131C4D104D35EB1665A698372CF26B89A9F7C`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.135; rerun only if settings UI code/resources or RitsuLib version changes again.
