...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.116.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.116.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.116.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.116 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.116.
...
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `75CC7065689B9803D738D12B1A0170468E05D7C91774408310F40EA6864DCBB9`.
- Last staging/versioned DLL hash check: SHA256 `5BFF7864F426C72625C6FECC0C4BCAA800B60499D8AE8465FDD9A0D58E64C4A4`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.116.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `1910AD3AB8C6AEFF321B577106CC771FE062C6354C498706BAAB74B4CC6F9E83`
  - DLL SHA256: `5BFF7864F426C72625C6FECC0C4BCAA800B60499D8AE8465FDD9A0D58E64C4A4`
  - README SHA256: `1258029C010E1C0ED4E37F9D0D4CF3D26F0B6C0722EF244E18BD0E00F1A161B4`
  - Manifest SHA256: `179E5C75BAA1428FF715435552FC80D66A3C16413C813D6F90961C88249F2E4B`
  - PCK SHA256: `75CC7065689B9803D738D12B1A0170468E05D7C91774408310F40EA6864DCBB9`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.116; rerun only if settings UI code/resources or RitsuLib version changes again.
