...
- Current RitsuLib-only migration evidence: solution build, focused guards, publish, package refresh, installed package checker, runtime preflight, and source-workspace checker passed for beta.125 after the STS2-RitsuLib `v0.4.34` update. Latest clicked Ancient UI smoke remains beta.123 previous-package evidence. The retained beta.88/beta.90/beta.93/beta.96/beta.99 smokes are previous-package contexts only. The direct-smoke verifier now accepts both append-style current-log slices and Godot-rewritten logs only when `godot.log.current-iteration` matches the retained after-launch log. Earlier cross-thread aborts are runner-contamination evidence only.
...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.123.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.125.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.125.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.123 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.123.
  ...
  Live gameplay, save-load, failure/death-path, gated Vakuu fight-option/victory return, and co-op verification remain pending; beta.123 clicked Ancient UI smoke exists under `.tools\runtime-evidence\monkey-stability-20260622-235746`.
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `F8355BA07FEF22649FFDBF2DE27CA62198EEBC34BF924E896848E89769991064`.
- Last staging/versioned DLL hash check: SHA256 `8D1CA98324D2A8974BA913953A689F3617748B3891FE6B1C7AB2D41CCAC90BD2`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.125.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `F26783A66661F0BCA00C79822A16A3F3C4713FD08759FB9CA5545E3270E45492`
  - DLL SHA256: `8D1CA98324D2A8974BA913953A689F3617748B3891FE6B1C7AB2D41CCAC90BD2`
  - README SHA256: `5923B59970AB8CFFCB408674B799F5472191753F65C7371DDBD77CDBBB6DC50C`
  - Manifest SHA256: `62B0B4E1555662DDCDE51C7687A1A6B38BAF2637E3ADC623013F23759050BA3D`
  - PCK SHA256: `F8355BA07FEF22649FFDBF2DE27CA62198EEBC34BF924E896848E89769991064`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.123; rerun only if settings UI code/resources or RitsuLib version changes again.
