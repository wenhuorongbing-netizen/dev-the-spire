...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.130.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.130.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.130.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.130 package parity, source-workspace validation, and runtime preflight are current package context; beta.128 clicked UI smoke is previous-package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.130.
...
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `57B7AE652BD3F375EE6F9730C79D495CC513415CE8DCD50D94690DE6E0D28462`.
- Last staging/versioned DLL hash check: SHA256 `6642A540458D119510BD992E0E3FDEC21CABD75D308F2D306B3FB0502B312DAA`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.130.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `34A63DAD1A44C6E91D03AFE705DCA7F6C9849E64A699D0DC7676DF0923006DAD`
  - DLL SHA256: `6642A540458D119510BD992E0E3FDEC21CABD75D308F2D306B3FB0502B312DAA`
  - README SHA256: `E8F552D66C6B16D8ACC6553D6C06AE11B5BF4C79F2536EA6B1E0FCFB4CC86CC0`
  - Manifest SHA256: `90400C06C926D303E789EF05496833BDEA189448F0C6E290E16DCBD1D7B257C8`
  - PCK SHA256: `57B7AE652BD3F375EE6F9730C79D495CC513415CE8DCD50D94690DE6E0D28462`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.130; rerun only if settings UI code/resources or RitsuLib version changes again.
