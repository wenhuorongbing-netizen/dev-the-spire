...
## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: passed, 282 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: passed, 302 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-25 after the beta.20 Seedbed explanation / mod-overview refresh. Result: exit code 0 with CRLF/LF warnings only.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.20.zip`, the installed `mods\EZMicroBalance` folder, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.20.zip` were refreshed and hash-checked on 2026-05-25 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.20 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-25 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `4448C61BB44D5EEFBE26F7EAE42780CA3068BE29BAA6D691525225A0706521F5`.
- Last staging/versioned DLL hash check: SHA256 `B99691BED8D511435C6A820198BFA713BDF983542D11159D4F690E688D7C448D`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.20.zip` was rebuilt from package staging, copied to the game root, and matched the installed mod artifacts on 2026-05-25.
  ...
  - Zip SHA256: `D15A0B21CB97AC498AE015116D230601F7F42E3EFB8CDF37D3226258FB1E52AD`
  - DLL SHA256: `B99691BED8D511435C6A820198BFA713BDF983542D11159D4F690E688D7C448D`
  - README SHA256: `5C830BC85E13E8A693F442CB30794F5619CDF64FBB1C8736EFF017188737928D`
  - Manifest SHA256: `351F929E813AB59B59E1546585D951A69E80B87D55A4428B0D8804C71B7B0BE2`
  - PCK SHA256: `4448C61BB44D5EEFBE26F7EAE42780CA3068BE29BAA6D691525225A0706521F5`
