...
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-10. Result: passed, 67 passed, 16 skipped release artifact/runtime evidence tests, 0 failed.
- Latest opt-in artifact-validation run: `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-10. Result: passed, 83 passed, 0 skipped, 0 failed.
...
- Last PCK audit: publish/package refresh left the installed, staging, versioned, and zip PCK at SHA256 `6493913D0B1F57A92CF0D1BD24841FCF41E9753C871ED04B4A218531C35BCCDD`. The latest opt-in automated PCK-content audit matches this full artifact set and is current through the latest package refresh.
- Last installed DLL audit: installed, staging, versioned package, and extracted zip DLL SHA256 all match `B1E3C4A7F419B54F339947403FB48FAFF768F8259DB039CA44F79FEDC2E6BF78`.
- Last Harmony patch audit: standalone .NET 9 audit called `Harmony.PatchAll(...)` on `EZMicroBalance.dll` and returned `PatchAll OK`.
- Last private beta package: `publish\EZMicroBalance-v0.1.0-private-beta.0.zip` was rebuilt after the 2026-05-09 Rootblight optional portrait fallback, generated portrait art, and manifest author refresh. The package `README_INSTALL.txt` records the resolved author/generated-art status. SHA256 `4E22172A2078DBCD67F9DEFFDC447BC35E7619107D19961154B21A6B9A72FDDF`; entries are `EZMicroBalance/EZMicroBalance.dll`, `.json`, `.pck`, and `README_INSTALL.txt`.
