...
- Current source defines 30 SavedSpireFields. Historical 22-field and 16-field startup rows remain useful records only; beta.70 loader parity and gameplay proof still need fresh live evidence.
...
- Current beta.70 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, preview-tools, and co-op verification remain pending.

## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: passed, 296 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: passed, 316 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: exit code 0 with no warnings.
- Last attempted default publish: `dotnet publish EZMicroBalance.sln` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: succeeded against the real installed mods root.
- Last successful isolated publish: `dotnet publish EZMicroBalance.sln -p:ModsPath=.tools\publish-game-root\mods\` on 2026-05-26 after the beta.70 Lotha card-play dispatch / release-evidence helper split package sync. Result: succeeded against an isolated temporary mods root; the isolated root is tooling context only and is not the current package-parity source.
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.70.zip`, `D:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.70.zip` were refreshed and hash-checked on 2026-05-26 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.70 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `44C62AD3F39DE63A85EEC55E24F0784464B72037853FE1F2DC702A65369B2D75`.
- Last staging/versioned DLL hash check: SHA256 `8CA7161DEE41662DE76293BB5246C04531969CA7E1FF1318A4C308B027258AA3`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.70.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-05-26. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `779F506CE6DF12DD7C8AC246758E07C46C424AA1BB7B071817E73F0439AF3FDB`
  - DLL SHA256: `8CA7161DEE41662DE76293BB5246C04531969CA7E1FF1318A4C308B027258AA3`
  - README SHA256: `877513B83C1E21F52F9AF959E286971BD2D55E4A52B48682AE30B5FAEDBDD84F`
  - Manifest SHA256: `B92ED1A66A820771A4EFA7C71E6CD70719D198FF6DF1E210CB34508F7CD4EF42`
  - PCK SHA256: `44C62AD3F39DE63A85EEC55E24F0784464B72037853FE1F2DC702A65369B2D75`
