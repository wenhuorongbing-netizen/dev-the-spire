...
- Last successful build: `dotnet build EZMicroBalance.sln -m:1 --no-incremental` on 2026-06-18 during the beta.87 dependency-floor pass. Result: succeeded with 0 warnings and 0 errors.
