...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.115.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.115.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.115.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.115 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.115.
...
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `2630F72AAAA230CF1AC15DEB3091536737FCCB7D6942A6BA6AA921DAB22CAFE3`.
- Last staging/versioned DLL hash check: SHA256 `B66997670206991A362D8E5B70A07076E05422852EDF0AA0034936E61D886E5A`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.115.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `0EA6C9925CC24BA9BB00314F117DFE42ADC9B9B0E51190E3E308FF7D8B84322C`
  - DLL SHA256: `B66997670206991A362D8E5B70A07076E05422852EDF0AA0034936E61D886E5A`
  - README SHA256: `BD5CF353B93E436E011B777F6A1446A561C8D73D6FA49BED3A255124EC388BF4`
  - Manifest SHA256: `13F12FF957ABBB9D43BEEE5FBB65505CFC3B140812B85B8B0679CB373E424790`
  - PCK SHA256: `2630F72AAAA230CF1AC15DEB3091536737FCCB7D6942A6BA6AA921DAB22CAFE3`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.115; rerun only if settings UI code/resources or RitsuLib version changes again.
