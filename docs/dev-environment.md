...
- Current source defines 30 SavedSpireFields. Historical 22-field and 16-field startup rows remain useful records only; beta.51 loader parity and gameplay proof still need fresh live evidence.
...
- Current beta.51 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, preview-tools, and co-op verification remain pending.
...
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.51 Sere Talon visual route service split package sync. Result: passed, 296 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.51 Sere Talon visual route service split package sync. Result: passed, 316 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.51.zip`, `D:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.51.zip` were refreshed and hash-checked on 2026-05-26 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.51 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `DA226590F7671F92829C4710FDB15EA715EE8C73A68E566943F1B3F570498445`.
- Last staging/versioned DLL hash check: SHA256 `6A2F5B6184749D48EE4E922005BA65070588F2D1C734E9344B828145D9A74EBD`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.51.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-05-26. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `2BF2DEFC0E38D33F75B67F528E71596CC57560DC32182A479E75B5D4F0DC5FA1`
  - DLL SHA256: `6A2F5B6184749D48EE4E922005BA65070588F2D1C734E9344B828145D9A74EBD`
  - README SHA256: `86EF9A313F71E38E9162DCEDE91FD3FA2A4080121BDAA3A370CDA6B063D86441`
  - Manifest SHA256: `6C70062E260D75AD3FF7111F8B92ED0CAFEAE91A8428B9A81920D645C4A7F583`
  - PCK SHA256: `DA226590F7671F92829C4710FDB15EA715EE8C73A68E566943F1B3F570498445`
