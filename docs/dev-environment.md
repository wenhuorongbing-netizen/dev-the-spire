...
- Current RitsuLib-only migration evidence: solution build, publish, package refresh, installed package checker, runtime preflight, and source-workspace checker passed for beta.99 after the hash-doc refresh and STS2-RitsuLib `v0.4.32` update. The retained beta.88/beta.90/beta.93/beta.96 smokes are previous-package contexts only. The direct-smoke verifier now accepts both append-style current-log slices and Godot-rewritten logs only when `godot.log.current-iteration` matches the retained after-launch log. Earlier cross-thread aborts are runner-contamination evidence only.
...
- Current Spire Plus runtime framework dependency: `STS2-RitsuLib` `v0.4.32` under `<GameRoot>\mods\STS2-RitsuLib`.
...
- Current source defines 30 SavedAttachedState fields. Historical 22-field and 16-field startup rows remain useful records only. Beta.85/beta.86/beta.87 `v0.107.0`, beta.88 previous package `v0.107.1`, beta.90 RitsuLib-only loader rows, beta.93 AdditiveBatch1 loader/registration rows, and beta.96 Off/Mod Settings rows are previous-context evidence; beta.99 package parity and beta.99 RitsuLib Mod Settings proof are current RitsuLib-only package evidence, and gameplay proof still needs manual verification.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.99.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.99.zip` were refreshed and hash-checked on 2026-06-21 for local manual testing.
  ...
  - beta.99 package parity and RitsuLib Mod Settings proof are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0.
...
- Last PCK hash check: the 2026-06-21 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `C86AC44992541C2E92EE3F064E786E98E50357E6CE3A80ABF2F39EDF42B5F705`.
- Last staging/versioned DLL hash check: SHA256 `49A3CB201D52144E59A7275052EB30B53DE9AE0C4A8DC3F37BD39A91B2239450`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.99.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-21. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `F775CA27F55CAB7D62A529BA45FE307FF0FEB5530861F03A4194F3931294092A`
  - DLL SHA256: `49A3CB201D52144E59A7275052EB30B53DE9AE0C4A8DC3F37BD39A91B2239450`
  - README SHA256: `2FB017D12AB220D70C1C52434D80049BDF715D431303D6FA8CB6524744E544A0`
  - Manifest SHA256: `E41ABEF8AC23CE61641C7BF94559F33101B76079FE5F94ED3ECFA5C7FF495D1E`
  - PCK SHA256: `C86AC44992541C2E92EE3F064E786E98E50357E6CE3A80ABF2F39EDF42B5F705`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is captured at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration. The proof used only STS2-RitsuLib and `EZMicroBalance`, showed `Spire Plus` in the RitsuLib Mods list, rendered the Spire Plus settings page, retained same-session `godot.log`, audited clean, and passed StS1 Off runtime shape verification 21 / 0. Previous beta.96 screenshot/page proof is previous-package context only. Historical list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` showed `Spire Plus` with previous package plus `EZMicroBalance` in an older package context.
