...
- Current RitsuLib-only migration evidence: solution build, focused guards, publish, package refresh, installed package checker, runtime preflight, source-workspace checker, and clicked Ancient UI smoke passed for beta.122 after the STS2-RitsuLib `v0.4.34` update. The retained beta.88/beta.90/beta.93/beta.96/beta.99 smokes are previous-package contexts only. The direct-smoke verifier now accepts both append-style current-log slices and Godot-rewritten logs only when `godot.log.current-iteration` matches the retained after-launch log. Earlier cross-thread aborts are runner-contamination evidence only.
...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.122.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.122.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.122.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.122 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.122.
  ...
  Live gameplay, save-load, failure/death-path, gated Vakuu fight-option/victory return, and co-op verification remain pending; beta.122 clicked Ancient UI smoke exists under `.tools\runtime-evidence\monkey-stability-beta122-20260622-230109`.
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `B9D4BB9543A6CC0089598533C13ED56D045BFCEA55A0900D246F49F5F5C6325F`.
- Last staging/versioned DLL hash check: SHA256 `C6355689524B5A9E680531E7DFFD989B07460BAA6CC4204A81A4719DA881148D`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.122.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `2D9752CBEB98A358D75DF85B2189F61DA3B116A1619A329C2959CB88BB964D98`
  - DLL SHA256: `C6355689524B5A9E680531E7DFFD989B07460BAA6CC4204A81A4719DA881148D`
  - README SHA256: `7280953E68CCA9E208D71D588E52ED889A8212660BEF910AFE253178E5BAB171`
  - Manifest SHA256: `D75A2417583C3B8E0926730AA42295861B99A5FBD2C85006F82B82E3654F4FDB`
  - PCK SHA256: `B9D4BB9543A6CC0089598533C13ED56D045BFCEA55A0900D246F49F5F5C6325F`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.122; rerun only if settings UI code/resources or RitsuLib version changes again.
