...
- Current source defines 30 SavedSpireFields. Historical 22-field and 16-field startup rows remain useful records only; beta.80 loader parity and gameplay proof still need fresh live evidence.
...
- Current beta.80 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, preview-tools, and co-op verification remain pending.

## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: passed, 296 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: passed, 316 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: exit code 0 with no warnings.
- Last attempted default publish: `dotnet publish EZMicroBalance.sln` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: succeeded against the real installed mods root.
- Last successful isolated publish: `dotnet publish EZMicroBalance.sln -p:ModsPath=.tools\publish-game-root\mods\` on 2026-05-27 after the beta.80 AncientBehavior localization/docs guard split package sync. Result: succeeded against an isolated temporary mods root; the isolated root is tooling context only and is not the current package-parity source.
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.80.zip`, `D:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.80.zip` were refreshed and hash-checked on 2026-05-27 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.80 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `6419E3AEED109D594573E759A3A7F88DA03589ADD273FF7231D5AC0884F44F56`.
- Last staging/versioned DLL hash check: SHA256 `B10508E202D8B749422A538A6755E6FC08C65C6A9F15A51B02AB993E55443C12`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.80.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-05-27. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `237F6CDCB4D593654AD3150AC4C3034F6C91EA0263895BB2ED68AE8E7D2920F9`
  - DLL SHA256: `B10508E202D8B749422A538A6755E6FC08C65C6A9F15A51B02AB993E55443C12`
  - README SHA256: `4E98E7F5D42CA41C38304FED5826BFE50E7C5F70202A37BED96504A34A21BFA6`
  - Manifest SHA256: `CC48C32E0B3BDA4AEA77A0EBC18F95E38A450AF6A4A985EBA34D609BE0174A59`
  - PCK SHA256: `6419E3AEED109D594573E759A3A7F88DA03589ADD273FF7231D5AC0884F44F56`
