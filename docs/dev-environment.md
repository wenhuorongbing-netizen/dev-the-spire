...
- BaseLib `v3.1.4` compatibility with v0.106.0:
  ...
  - Historical beta.19 loader evidence: `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` reached startup completion with only BaseLib plus Spire Plus, registered config for `EZMicroBalance`, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, matched its beta.19 package hash, audited clean, stopped the game, and restored the isolated mod setup. The raw local `.tools` runtime-evidence folders were pruned during cleanup, so fresh plug-off evidence must be recaptured before any release-ready claim. The beta.37 package still needs fresh loader proof. The beta.17 loader evidence remains historical context only.
...
## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: passed, 288 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh and installed-folder sync. Result: passed, 308 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: exit code 0 with CRLF/LF warnings only.
- Last attempted default publish: `dotnet publish EZMicroBalance.sln` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: succeeded against the real installed mods root.
- Last successful isolated publish: `dotnet publish EZMicroBalance.sln -p:ModsPath=.tools\publish-game-root\mods\` on 2026-05-26 after the beta.37 Soul Tide / Fission Exhaust / Elite Root refresh. Result: succeeded against an isolated temporary mods root.
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.37.zip`, the isolated `.tools\publish-game-root\mods\EZMicroBalance` folder, `D:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.37.zip` were refreshed and hash-checked on 2026-05-26 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.37 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `8DDBBC1E44D73EC682C00BBF703EA7226EE69DA27DC9E3F73B7B202F5D537D2C`.
- Last staging/versioned DLL hash check: SHA256 `834AADBF7437366D21A73F8C3514D56E8B079C32E21CBFB22833BD244FA5F214`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.37.zip` was rebuilt from isolated package staging, copied to the game root, and synced into the real installed mod folder on 2026-05-26. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `3DF27CE930CDCC9A163D27D9F490C4F793F11DA0D8B3E7BE1A281479BD796BF1`
  - DLL SHA256: `834AADBF7437366D21A73F8C3514D56E8B079C32E21CBFB22833BD244FA5F214`
  - README SHA256: `290856DFB3D51BD9A4B1A368050DB59E9BFBD48804EF7A306B5D4F329A6F1030`
  - Manifest SHA256: `9403F46F6F2041BB0A4A1D526CEAF8D229E8BF2E3E8DA09989486EA6CDAB0A05`
  - PCK SHA256: `8DDBBC1E44D73EC682C00BBF703EA7226EE69DA27DC9E3F73B7B202F5D537D2C`
