...
- Current RitsuLib-only migration evidence: solution build, focused guards, publish, package refresh, installed package checker, runtime preflight, source-workspace checker, and clicked Ancient UI smoke passed for beta.107 after the STS2-RitsuLib `v0.4.33` update. The retained beta.88/beta.90/beta.93/beta.96/beta.99 smokes are previous-package contexts only. The direct-smoke verifier now accepts both append-style current-log slices and Godot-rewritten logs only when `godot.log.current-iteration` matches the retained after-launch log. Earlier cross-thread aborts are runner-contamination evidence only.
...
- Current Spire Plus runtime framework dependency: `STS2-RitsuLib` `v0.4.33` under `<GameRoot>\mods\STS2-RitsuLib`.
...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  It opened Settings -> `Mod Settings (RitsuLib)` in a normal Steam-client isolated session, showed only `RitsuLib` and `Spire Plus`, rendered the Spire Plus Migration Status / `STS2-RitsuLib >= 0.4.33` / evidence-boundary / Preview Tools page, retained same-session `godot.log`, audited clean, and passed StS1 Off runtime shape verification 21 / 0.
  Treat it as previous-package settings-page context after beta.107.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.107.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.107.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.107 package parity, source-workspace validation, and clicked Ancient UI smoke are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.107.
  ...
  Live gameplay, save-load, failure/death-path, gated Vakuu fight-option/victory return, and co-op verification remain pending; beta.107 clicked Ancient UI smoke exists under `.tools\runtime-evidence\monkey-stability-beta107-rerun-20260622-144051`.
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `5615B84136288D4420B69241DAE73D478F58A208EEE7F019CA8FFCF4EDF86A10`.
- Last staging/versioned DLL hash check: SHA256 `3C5F8734B705462515FD4416FBDFCEA77CC8BE1A933D9493978E7DBDC4FC2246`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.107.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `DE6CF70E008ECC336B6E8047A40B274176692CE57AFF7444BD2DD6B60BD4E094`
  - DLL SHA256: `3C5F8734B705462515FD4416FBDFCEA77CC8BE1A933D9493978E7DBDC4FC2246`
  - README SHA256: `1D3FB76EBA38BE95D4B3086FF65C687B9B470CF0690538F087DE9E718BDFDFDF`
  - Manifest SHA256: `E8E16F22297E07ECEBAB844CE30A2E3916092261DF4E4A551B623DEF7EAB4AA9`
  - PCK SHA256: `5615B84136288D4420B69241DAE73D478F58A208EEE7F019CA8FFCF4EDF86A10`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.107; rerun only if settings UI code/resources or RitsuLib version changes again.
