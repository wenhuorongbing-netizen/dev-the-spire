...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.117.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.117.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.117.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.117 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.117.
...
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `642068E74CA47D0E5BC748229E680357B22A31D624B5340A2B7CEE640C847771`.
- Last staging/versioned DLL hash check: SHA256 `25729A2B780617115A892174909CFD9B55422A2D23EEE7EFAE781A0DDD0E811F`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.117.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `4DB40A75B9F98BA30FEFE1A22F8CAEC584389A87665DA499B4C042D673AA7A2B`
  - DLL SHA256: `25729A2B780617115A892174909CFD9B55422A2D23EEE7EFAE781A0DDD0E811F`
  - README SHA256: `14963B09810778F290FBBA861150BA9CE50CF380D06A8F249B9BC3D9DE005513`
  - Manifest SHA256: `532F2E6D6D4E1E43E431A4D4EBA00EC5349A08DC34E18DE95EFAC45EEA145D9D`
  - PCK SHA256: `642068E74CA47D0E5BC748229E680357B22A31D624B5340A2B7CEE640C847771`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.117; rerun only if settings UI code/resources or RitsuLib version changes again.
