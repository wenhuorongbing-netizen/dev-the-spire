...
## Last known commands
- Last attempted default build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful build: `dotnet build EZMicroBalance.sln` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: succeeded with 0 warnings and 0 errors.
- Last successful normal test run: `dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: passed, 283 passed, 20 skipped release artifact/runtime evidence tests, 0 failed.
...
- Latest opt-in artifact-validation run: `SPIREPLUS_RUN_RELEASE_ARTIFACT_TESTS=1 dotnet test EZMicroBalance.sln --no-build` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: passed, 303 passed, 0 skipped, 0 failed. Legacy `EZMB_RUN_RELEASE_ARTIFACT_TESTS=1` remains accepted.
...
- Last formatting check: `dotnet format EZMicroBalance.sln --verify-no-changes --no-restore` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: exit code 0.
- Last required diff check: `git diff --check` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: exit code 0 with CRLF/LF warnings only.
- Last attempted publish: `dotnet publish EZMicroBalance.sln` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: succeeded.
- Last successful publish: `dotnet publish EZMicroBalance.sln` on 2026-05-26 after the beta.26 Seedbed planting rules refresh. Result: succeeded.
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.26.zip`, the installed `mods\EZMicroBalance` folder, and `D:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.26.zip` were refreshed and hash-checked on 2026-05-26 for local manual testing. The zip uses the player-facing `SpirePlus` archive name while the install folder remains `EZMicroBalance`. The beta.19 loader row is historical startup/log proof only; beta.26 loader, live gameplay, save-load, failure/death-path, clicked Ancient UI, and co-op verification remain pending.
- Last PCK hash check: the 2026-05-26 local manual-test package refresh left the staging, versioned, and zip-entry PCK at SHA256 `8D3AD766FFF05AFD92A59298FF0FB9DD7A6AA155973852BF499E002022E31688`.
- Last staging/versioned DLL hash check: SHA256 `08976CF96F3221C99A3B8BE848E3A31F7471E046843836C3D5846820F70F2B2A`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.26.zip` was rebuilt from package staging, copied to the game root, and matched the installed mod artifacts on 2026-05-26.
  ...
  - README SHA256: `170A0BE9D56B14FFF03B0191EDE6DF15CDD73D7FEA775E7B05E7A28E4932E07A`
