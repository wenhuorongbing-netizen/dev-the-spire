...
- Current source defines 30 SavedAttachedState fields. Historical 22-field and 16-field startup rows remain useful records only. Beta.85/beta.86/beta.87 `v0.107.0`, beta.88 previous package `v0.107.1`, beta.90 RitsuLib-only loader rows, and beta.93 RitsuLib-only loader rows are previous-context evidence; beta.94 package parity is current RitsuLib-only evidence, and gameplay proof still needs manual verification.
...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh. Fresh beta.94 Mod Settings page proof remains pending.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.94.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.94.zip` were refreshed and hash-checked on 2026-06-21 for local manual testing.
  ...
  - beta.94 package parity is current package context.
...
- Last PCK hash check: the 2026-06-21 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `D3218EC382F1B9CD86E3CFF5F50D5F45A06D4A173BB529B27F17BF7A15A030DF`.
- Last staging/versioned DLL hash check: SHA256 `92EE170B2EE9D8F17CEDF246042C0EC524D9B9E05B40B1314BFF930EC68099B9`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.94.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-21. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - README SHA256: `587496387BB66B8FCE5F1449348E80F3E61E7AA3094CC90626AD30075867066E`
...
- Beta.94 live gameplay verification remains pending.
