...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.14.zip` was rebuilt from package staging on 2026-05-25 because the installed mod DLL was locked by a running game process.
