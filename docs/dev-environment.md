...
- Historical display-name list evidence under `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342` shows `Spire Plus`; older page-level Mod Settings evidence predates the display-name refresh.
  ...
  Treat it as previous-package settings-page context after beta.119.
...
- Publish/package note: package staging, the versioned package folder, `publish\SpirePlus-v0.1.0-private-beta.119.zip`, `E:\Steam\steamapps\common\Slay the Spire 2\mods\EZMicroBalance`, and `E:\Steam\steamapps\common\Slay the Spire 2\SpirePlus-v0.1.0-private-beta.119.zip` were refreshed and hash-checked on 2026-06-22 for local manual testing.
  ...
  - beta.119 package parity and source-workspace validation are current package context.
  - beta.99 Mod Settings proof is under `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` with clean log audit and StS1 Off runtime shape verification 21 / 0; it is previous-package settings-page context after beta.119.
...
- Last PCK hash check: the 2026-06-22 local package-hash refresh found the staging, versioned, and zip-entry PCK at SHA256 `A75C26038DB31CDF296477BD23C1080249CB979EF70A48E59CE4100AF8666B80`.
- Last staging/versioned DLL hash check: SHA256 `1EBFA239EBE6DF967F5F67EEFFC03A86C6C43E38DB075054C773C325C627D610`.
...
- Last private beta package: `publish\SpirePlus-v0.1.0-private-beta.119.zip` was rebuilt from the real installed mod artifacts, copied to the game root, and synced into the real installed mod folder on 2026-06-22. The staging, versioned, installed, game-root zip, and zip-entry artifacts match the hashes below.
  ...
  - Zip SHA256: `20911A544516954B8ACB7C9DBD7FAEB192FD17EAC8E8C1F9B3F5D990E3545485`
  - DLL SHA256: `1EBFA239EBE6DF967F5F67EEFFC03A86C6C43E38DB075054C773C325C627D610`
  - README SHA256: `3D4A0E4B5301788BCA83795C178E097AD5D8D204D3084B2AE4DAAC7CAFD55BDA`
  - Manifest SHA256: `56502CE729A80377F113219930FC880E6189DF5FEFBA72A92A8C3C828D36CBCC`
  - PCK SHA256: `A75C26038DB31CDF296477BD23C1080249CB979EF70A48E59CE4100AF8666B80`
...
- Current target Mod Settings verification: beta.99 screenshot/page proof is retained at `.tools\runtime-evidence\mod-settings-beta99-ritsulib-click-20260621-223210` after the settings-page I18N resource migration.
  ...
  It is previous-package settings-page context after beta.119; rerun only if settings UI code/resources or RitsuLib version changes again.
