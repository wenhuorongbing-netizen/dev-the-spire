...
| --- | --- | --- | --- | --- |
| Download package `SpirePlus-v0.1.0-private-beta.27.zip` | `content-data.js` download block | `docs/issues.md`, `publish/SpirePlus-v0.1.0-private-beta.27.zip` | partial | Hash can go stale; website must read from release docs or be updated during package. |
