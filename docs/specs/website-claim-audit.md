...
| --- | --- | --- | --- | --- |
| Download package `SpirePlus-v0.1.0-private-beta.84.zip` | `content-data.js` download block | `docs/issues.md`, `publish/SpirePlus-v0.1.0-private-beta.84.zip` | partial | Hash can go stale; website must read from release docs or be updated during package. |
...
| Urda eleven blessings | `content-data.js` Urda section | `EZMicroBalanceCode/Ancients/Expansion/Urda/`, guard tests | partial | Beta.105 forced clicked UI smoke exists; Root Eyes, Seed Bank, hover/readability, save/load, and co-op proof remain pending. |
