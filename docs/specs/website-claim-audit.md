...
| Urda eleven blessings | `content-data.js` Urda section | `EZMicroBalanceCode/Ancients/Expansion/Urda/`, guard tests | partial | Beta.108 forced clicked UI smoke exists; Root Eyes, Seed Bank, hover/readability, save/load, and co-op proof remain pending. |
