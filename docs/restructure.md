...
Current package/runtime target is Spire Plus `v0.1.0-private-beta.99` on Slay
the Spire 2 `v0.107.1` with `STS2-RitsuLib` `0.4.32` in direct NuGet runtime layout
