...
- The latest Steam-client loader smoke under `.tools/runtime-evidence/beta16-loader-smoke-20260525-184743` reported `Found 30 SavedSpireFields` with only BaseLib plus Spire Plus loaded, clean log audit, startup completion, game stop, restored mod isolation, and current beta.16 package hash parity. Older beta.13, `20260524-161744`, 22-field, and `20260523-current` loader smokes remain historical evidence only.
