...
Current package target remains `publish/SpirePlus-v0.1.0-private-beta.2.zip`. The stable technical manifest id remains `EZMicroBalance`; do not edit it in place.
