...
- Before any AdditiveBatch1 gameplay claim, confirm the beta.135 package and STS2-RitsuLib `v0.4.34` direct NuGet runtime are installed and recapture current-package enabled-mode proof.
...
3. Capture current beta.135 enabled-mode loader/registration proof separately before any current enabled-mode claim.
