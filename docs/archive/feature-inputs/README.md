...
- `goal-coop-preview-plan-20260525.md`: archived co-op preview-tools crash-response plan. Current co-op fail-closed policy is in `docs/test-ready-development-goal.md`, `docs/issues.md`, and the source guards.
