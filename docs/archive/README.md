...
| `feature-audits/ritsulib-migration/` | Completed RitsuLib migration-process records moved out of the active feature folder after the source inventory reached 169 migrated patch classes and 0 raw Harmony declarations. |
...
| `legacy-planning/m5-revision-n-*-20260619.md` | Historical beta.88 previous-package owner packet, validation replay, runtime-evidence plan, and final report. Current migration truth is beta.135 RitsuLib-only with 169/0 source inventory. |
...
- `legacy-planning/m5-revision-n-final-report-20260619.md`, `legacy-planning/m5-revision-n-owner-commit-packet-20260619.md`, `legacy-planning/m5-revision-n-validation-replay-20260619.md`, and `legacy-planning/m5-revision-n-runtime-evidence-plan-20260619.md`: previous beta.88 previous-package planning records; current beta.135 RitsuLib-only routing is consolidated in `docs/goals/historical-revision-boundaries.md`.
- `feature-audits/ritsulib-migration/`: archived Batch 4c candidate record, next-runtime QA run plan, May 31 hard-block boundary, and monthly dev-spec stub. These are traceability records only; current RitsuLib development starts from `docs/features/ritsulib-migration/README.md`, `docs/integrations/ritsulib.md`, installed `STS2-RitsuLib.xml`, and unpacked game source.
