...
| `legacy-planning/m5-revision-n-*-20260619.md` | Historical beta.88 previous-package owner packet, validation replay, runtime-evidence plan, and final report. Current migration truth is beta.122 RitsuLib-only. |
