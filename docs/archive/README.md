...
| `legacy-planning/m5-revision-n-*-20260619.md` | Historical beta.88/previous framework-backed owner packet, validation replay, runtime-evidence plan, and final report. Current migration truth is beta.91 RitsuLib-only. |
...
- `legacy-planning/m5-revision-n-final-report-20260619.md`, `legacy-planning/m5-revision-n-owner-commit-packet-20260619.md`, `legacy-planning/m5-revision-n-validation-replay-20260619.md`, and `legacy-planning/m5-revision-n-runtime-evidence-plan-20260619.md`: previous beta.88/previous framework-backed planning records; active stubs under `docs/goals/` point to current beta.91 RitsuLib-only migration truth.
