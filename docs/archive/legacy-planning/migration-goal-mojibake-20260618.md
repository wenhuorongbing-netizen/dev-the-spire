...
CanaryOnly 当前 v0.107 enabled-mode proof：完成（loader only）
AdditiveBatch1 当前 v0.107 enabled-mode proof：blocked（13 observed / 14 expected）
...
beta.85 CanaryOnly 当前 enabled-mode proof：完成（loader only）
beta.85 AdditiveBatch1 当前 enabled-mode proof：blocked（13 observed / 14 expected）
```
...
### 分层状态：current enabled-mode proof
