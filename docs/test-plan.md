...
- Latest Steam-client loader evidence under `.tools/runtime-evidence/beta17-loader-smoke-20260525-194311` reports `Found 30 SavedSpireFields` with only BaseLib plus Spire Plus loaded, clean log audit, stopped game, and restored mod isolation for the previous beta.17 package. Current beta.19 package hash parity has not had a fresh loader smoke yet. Older beta.13, `20260523-current`, 16-field, and 22-field startup/log passes are historical.
