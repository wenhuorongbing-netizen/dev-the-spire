...
- Latest Steam-client loader evidence under `.tools/runtime-evidence/beta17-loader-smoke-20260525-194311` reports `Found 30 SavedSpireFields` with only BaseLib plus Spire Plus loaded, current beta.17 package hash parity, clean log audit, stopped game, and restored mod isolation. Older beta.13, `20260523-current`, 16-field, and 22-field startup/log passes are historical.
