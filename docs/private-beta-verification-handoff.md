...
- Historical current-display Mod Settings list screenshot shows `Spire Plus`; page-level previous package/old-display-name evidence remains historical, and current beta.93 list plus Spire Plus config-page proof remains pending under `mod-settings-current-display`.
