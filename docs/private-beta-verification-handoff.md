...
- Package: `publish\SpirePlus-v0.1.0-private-beta.63.zip`
...
- README_INSTALL SHA256: `C361FD7D16F286BC0AB3E437B7CF511A5294F34CAF4A49640BD58CD513081EE4`

## Known Automated Evidence

- Current automated snapshot: beta.63 passed `dotnet build`, normal `dotnet test`, normal publish/package refresh, `dotnet format`, `git diff --check`, website syntax checks, and real installed-package checking after the Lotha card eligibility split package sync. Gameplay proof is still pending.
