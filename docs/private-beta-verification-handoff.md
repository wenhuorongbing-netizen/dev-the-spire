...
- Package: `publish\SpirePlus-v0.1.0-private-beta.94.zip`
- Player-facing name: `Spire Plus`
- Zip SHA256: `56636753F598B360B3798ED681ED84C3CA08CEC173E7EBA70134F4BC68EF964A`
- Manifest id: `EZMicroBalance`
- DLL SHA256: `92EE170B2EE9D8F17CEDF246042C0EC524D9B9E05B40B1314BFF930EC68099B9`
- Manifest SHA256: `6D7CED263561DE0D2B5E1ED6CEB7B1747CB14F4F5503509B391351681B5AD5D8`
- PCK SHA256: `D3218EC382F1B9CD86E3CFF5F50D5F45A06D4A173BB529B27F17BF7A15A030DF`
- README_INSTALL SHA256: `587496387BB66B8FCE5F1449348E80F3E61E7AA3094CC90626AD30075867066E`

## Known Automated Evidence

- Current automated snapshot: beta.94 passed `dotnet build`, `dotnet publish`, package refresh, installed package parity, runtime preflight, and source-workspace parity after the settings UI migration. The previous beta.93 Off evidence reached main menu with exactly `RitsuLib [STS2-RitsuLib] (0.4.31)` and `Spire Plus [EZMicroBalance] (v0.1.0-private-beta.93)` loaded, audited clean, and passed packet verification with 43 / 0 checks. The previous beta.93 AdditiveBatch1 evidence registered 10 event types through 14 calls, audited clean, passed enabled-mode verifier 31 / 0, and passed packet verification with 61 / 0 checks. Beta.94 loader proof, Mod Settings page proof, and gameplay proof are still pending.
...
- Historical current-display Mod Settings list screenshot shows `Spire Plus`; page-level previous package/old-display-name evidence remains historical, and current beta.94 list plus Spire Plus config-page proof remains pending under `mod-settings-current-display`.
...
4. Confirm Spire Plus appears with id `EZMicroBalance` and can be enabled. Fill `release/mod-settings-current-display/mod-settings-checklist.md` with a previous beta.93 Mods-list screenshot, a current Spire Plus config-page screenshot, route note, same-session `godot.log`, and clean `godot-log-audit.json`. Historical normal Steam logs and `.tools\runtime-evidence\current-spire-plus-modsettings-20260513-111342\02-mod-config-list.png` are context only for this row.
