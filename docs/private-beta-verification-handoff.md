...
4. Confirm EZ Micro Balance appears with id `EZMicroBalance` and can be enabled. RC1 evidence already shows the localized BaseLib config page; rerun only if package or local mod state changes.
