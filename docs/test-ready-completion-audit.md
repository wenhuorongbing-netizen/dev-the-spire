...
Original audit date: 2026-05-14; latest beta.133 RitsuLib-only package refresh/no-launch validation: 2026-06-23; previous beta.128 clicked UI smoke: 2026-06-23; previous beta.123, beta.99, beta.96, and beta.93 evidence remains historical loader/registration/settings proof only.
...
context after the earlier RitsuLib `0.4.31` update. The current beta.133 package
...
`publish/SpirePlus-v0.1.0-private-beta.133.zip` were refreshed from installed
...
| Single package structure | `EZMicroBalance/`, `EZMicroBalanceCode/`, `EZMicroBalance.csproj`, `EZMicroBalance.json`, and `publish/SpirePlus-v0.1.0-private-beta.133.zip` with `EZMicroBalance/` as the install folder; duplicate root mod surfaces are removed from the active tree. | Pass |
...
| Package artifacts | `publish/SpirePlus-v0.1.0-private-beta.133.zip` SHA256 `658AAB5F5FE0793253513F472B2BD5DC6C93BA2FF9EA6911E3130DFC6719115E`; DLL `6F257CCF31280FA002AF75C3507307FA288867BDFF13825CC9289BBB9825F53B`; manifest `2FA3920BC1EC84485A7FBA43E5446F09E8E5AB6A575BBD2FB4C114DA9E34879C`; PCK `2472578F14D4572A2888F41F10D449F0331CB057A112939C7EC43196F501F87B`; README `7607A59DBA274931641B041028B5A06E96EE4DBF9E12EE4D21215B16CDEEAABB`. The README is now a short manual-test install note and says Ancient selections grant visible marker relics. | Pass for local package hash parity; live proof pending |
