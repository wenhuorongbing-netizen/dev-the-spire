...
`publish/SpirePlus-v0.1.0-private-beta.127.zip` were refreshed from installed
...
| Single package structure | `EZMicroBalance/`, `EZMicroBalanceCode/`, `EZMicroBalance.csproj`, `EZMicroBalance.json`, and `publish/SpirePlus-v0.1.0-private-beta.127.zip` with `EZMicroBalance/` as the install folder; duplicate root mod surfaces are removed from the active tree. | Pass |
...
| Package artifacts | `publish/SpirePlus-v0.1.0-private-beta.127.zip` SHA256 `4112340E5362ADDD52AC091715A461C40BE8D2BC31F97157C866EE84A0E5DA14`; DLL `2057F36E44E30C34AED322EF9E48881123FB8478ECB1661413838C2B75AD5ABB`; manifest `3F7433B9A93CC7C1C8CF6AB621E1976520541B48DC86B4583DBB468942E53F5D`; PCK `E51BAC43374D089B4D24EA3C66B451BEB1133AB89237CDC5516B217CE45CA847`; README `F613617DE67249F7721A7AEF4DDB22BCEB25D37E9317F1BA8540AC486B70D298`. The README is now a short manual-test install note and says Ancient selections grant visible marker relics. | Pass for local package hash parity; live proof pending |
