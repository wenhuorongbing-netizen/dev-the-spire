...
Update note, 2026-05-14 package hash refresh: after the source red-team hardening pass, package staging, the versioned package folder, and `publish/SpirePlus-v0.1.0-private-beta.2.zip` were refreshed from installed artifacts. These hashes record automated source validation only; live gameplay, save-load, death/failure path, and co-op verification remain pending.
...
| Single package structure | `EZMicroBalance/`, `EZMicroBalanceCode/`, `EZMicroBalance.csproj`, `EZMicroBalance.json`, and `publish/SpirePlus-v0.1.0-private-beta.2.zip` with `EZMicroBalance/` as the install folder; duplicate root mod surfaces are removed from the active tree. | Pass |
...
| Package artifacts | `publish/SpirePlus-v0.1.0-private-beta.2.zip` SHA256 `AFD1304686A4CABAEAFCEBA75870D52D0449AB854E8E1D65E2693B72E941C62F`; DLL `5CA8EE1A1700A04597860430BE017413AD4A4EC32D691CFB3BA9E0E3D8601F33`; manifest `A7007A3CDE633F661404B00EEBC1154BF4DB5FA9F41CC89AA5030CE7314AC862`; PCK `CF93B736667058E3B6FC2F1AF5D033D26452421374F0E40C6FA6496C6510D3E8`; README `E13627EEB9D658107C0B9CBD48819749EEFE49F6E3B28CF32BD18EA28B4FC7EB`. The README is now a short manual-test install note and says Ancient selections grant visible marker relics. | Pass for installed/staging/versioned/zip artifact parity |
...
These do not block the source-complete test-ready package because the goal doc explicitly says test-ready is not release-ready, but they block private beta release readiness and any live gameplay claim:
...
- Worktree is not clean and no commit/push has been performed; push still requires explicit user approval.
