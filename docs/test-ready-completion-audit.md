...
| Phase 8 required commands | Latest validation passed: 271 passed / 20 skipped, format, diff-check, installed-package checks, current-package loader smoke, and 0 unclassified worktree paths after the player-visible localization naming guard. Latest package refresh evidence still includes 291 passed / 0 skipped artifact tests and package/PCK text checks for Sere Talon / Tanx Claws plus Trial Branch. Gameplay, save-load, clicked UI, route-click, death/failure, and co-op remain pending. | Pass for validation and loader; live manual gameplay pending |
| Package artifacts | `publish/SpirePlus-v0.1.0-private-beta.0.zip` SHA256 `D8C7BB29B45FDA669BC2345B133EF0277E97004B1B6B53992DFF4FAC55F466F4`; DLL `F11BD12A9E60327B07BB5965B777C216684766A310C2CCB8B9D98147C37057A0`; manifest `C2FB53C13AE099080AC71FF7EE2A1F217A2586549A9152DAFE0EBF512EF42FF6`; PCK `42D98CA1DBEDAE9874A7302FBBC8596BF4D971A4B01BDB55A18329699D9046BE`; README `33263ACDEEE8F46DD89FFCF649A259B190805C992F743BC3DC07F716FD212FAA`. The README is now a short manual-test install note and says Ancient selections grant visible marker relics. | Pass for installed/staging/versioned/zip artifact parity |
