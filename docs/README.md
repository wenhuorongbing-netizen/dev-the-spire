...
| Current migration/review state | `../PROJECT_STATE.md`, `features/ritsulib-migration/README.md`, `integrations/ritsulib.md`, and `reviews/current-validation.md` | Current beta.123 RitsuLib-only package state, source-workspace proof, package parity, and clicked UI smoke; full validation history is archived. |
