...
| Current migration/review state | `../PROJECT_STATE.md`, `integrations/ritsulib.md`, and `reviews/current-validation.md` | Current beta.98 RitsuLib-only package state, with beta.96 UI/loader and beta.93 loader proof retained only as previous-package history. |
...
| `migration.md` | Compact RitsuLib migration status index; detailed goal/evidence lives in `goals/migration.md` and `integrations/ritsulib.md`. |
