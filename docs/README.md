...
| Current migration/review state | `../PROJECT_STATE.md`, `features/ritsulib-migration/README.md`, `integrations/ritsulib.md`, and `reviews/current-validation.md` | Current beta.104 RitsuLib-only package state, source-workspace proof, package parity, and clicked Ancient UI smoke; beta.99 settings/Off proof and beta.93 enabled-mode loader proof are retained only as previous-package history. |
