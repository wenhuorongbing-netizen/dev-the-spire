...
| Current migration/review state | `../PROJECT_STATE.md`, `features/ritsulib-migration/README.md`, `integrations/ritsulib.md`, and `reviews/current-validation.md` | Current beta.112 RitsuLib-only package state, source-workspace proof, and package parity; previous beta.108 clicked UI smoke; full validation history is archived. |
