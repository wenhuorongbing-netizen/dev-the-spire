...
| Current migration/review state | `../PROJECT_STATE.md`, `integrations/ritsulib.md`, and `reviews/current-validation.md` | Current beta.96 RitsuLib-only package/UI state, with beta.93 loader proof retained only as previous-package history. |
