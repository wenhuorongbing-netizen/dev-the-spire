...
| Tests | Current no-game pass | Latest current-HEAD recapture: build 0 warnings / 0 errors; focused `RuntimeMonkeyStabilityGuardTests` plus `ReleaseEvidenceGateTests` 21/0/0/21; focused `DocumentationCompactnessGuardTests` 25/0/0/25; focused `EngineeringGovernanceGuardTests` 25/0/0/25; later focused RuntimeMonkey/Ascension milestone guards 23/0/2/25 after runtime-harness offset binding and Rootblight guard split. The broader beta.86 split lane remains 489 passed / 0 failed / 39 skipped / 528 total. |
