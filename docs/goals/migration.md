...
| StS1 static/governance lanes | Current pass | Current-doc claims 1214/0 after beta.88 doc alignment, AutoSlay proof-mode `-ExpectedAncientIds` target coverage, exact `AncientIdCounts` summary aggregation guards including extra zero-count key rejection, non-positive `MinRuns` rejection, ordered-selection AncientId guarding, AutoSlay summary problem-row counter binding, AutoSlay run-result hash binding, AutoSlay analyzer run-result hash fail-closed owner routing, AutoSlay analyzer summary signal binding, proof-command exact target/report switch enforcement, exact `VAKUU,URDA,MORVI,LOTHA` target guarding, `-AllowMissingEventTraversal` bypass rejection, runtime-monkey escaped-path and malformed-path hardening, duplicate/missing iteration-number coverage hardening, runtime-monkey plan `ExpectedPatchCount` binding hardening, runtime-monkey runner path/hash binding hardening, runtime-monkey command-corpus file/hash binding hardening, runtime-monkey per-iteration command-file binding hardening, runtime-monkey per-iteration command-file path/hash binding hardening, runtime-monkey summary command-file path/hash binding hardening, runtime-monkey summary runtime-probe binding hardening, runtime-monkey summary live-session state binding hardening, runtime-monkey restore summary counter binding hardening, runtime-monkey summary max telemetry binding hardening, runtime-monkey summary failure/hang signal binding hardening, analyzer noncanonical-path checks, probe process identity checks, malformed AutoSlay retained-path rejection, direct-smoke analyzer hardening, and live-session restore-state hardening; runtime preflight 27/0 for local `v0.107.1`; retained AdditiveBatch1 packet verifier 62/0; static suite 15/0; static-file hygiene 12/0. |
