...
| Tests | Current no-game pass | Post-baseline no-game/doc-governance recaptures include `bdc002d6`: build 0 warnings / 0 errors; touched focused RuntimeMonkey, AncientBehavior, compactness/governance, StS1 static, format, diff-check, patch-inventory, and batch-classifier lanes passed. The broader beta.86 split lane remains 489 passed / 0 failed / 39 skipped / 528 total and the package/runtime baseline remains `eaaeb5a1`. |
