...
Current package target: Spire Plus `v0.1.0-private-beta.105`

Runtime dependency target: STS2-RitsuLib `v0.4.33` direct NuGet runtime layout, Slay the Spire 2 `v0.107.1`. previous package is not a current Spire Plus dependency.
...
dependency floor is now aligned on STS2-RitsuLib `v0.4.33`, and Spire Plus no longer has a project,
...
| --- | --- | --- |
| Runtime dependency blocker | Closed for package/dependency; runtime recapture pending | STS2-RitsuLib `v0.4.33` direct NuGet runtime layout is installed for Slay the Spire 2 `v0.107.1`; beta.105 package parity and clicked UI smoke are current, while beta.99/beta.96 Off direct proof is previous-package startup/loading evidence only. |
...
| AdditiveBatch1 proof | Previous-package loader/registration pass | beta.93 direct proof records 10 event types / 14 registration calls, 25/25 Spire Plus patches, clean audit, enabled-mode verifier 31 / 0, and packet verifier 61 / 0. Current beta.105 enabled-mode proof still needs recapture before gameplay claims. |
