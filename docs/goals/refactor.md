...
Runtime dependency target: STS2-RitsuLib `v0.4.28` / `lib\0.107.1`, Slay the Spire 2 `v0.107.1`. BaseLib is not a current Spire Plus dependency.
...
dependency floor is now aligned on STS2-RitsuLib `v0.4.28`, and Spire Plus no longer has a project,
manifest, package, or current runtime dependency on BaseLib.

Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous BaseLib-backed context, and beta.91 is the current RitsuLib-only loader/registration proof.
Current beta.91 RitsuLib-only Off proof exists under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/`, and current beta.91 RitsuLib-only AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/`.
...
| --- | --- | --- |
| Runtime dependency blocker | Closed for loader/registration | STS2-RitsuLib `v0.4.28` with `lib\0.107.1` is installed for Slay the Spire 2 `v0.107.1`; beta.91 Off and AdditiveBatch1 direct proof reached main menu with clean retained verifiers and no Spire Plus BaseLib dependency. |
...
| AdditiveBatch1 proof | Current loader/registration pass | beta.91 direct proof records 10 event types / 14 registration calls, 25/25 Spire Plus patches, clean audit, enabled-mode verifier 31 / 0, and packet verifier 61 / 0. |
