...
Current package target: Spire Plus `v0.1.0-private-beta.96`
...
Current beta.96 RitsuLib-only Off proof exists under `.tools/runtime-evidence/v01071-beta96-ritsulib0431-off-direct-20260621-185056/`, and previous beta.93 RitsuLib-only AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`.
...
| --- | --- | --- |
| Runtime dependency blocker | Closed for current Off loader proof | STS2-RitsuLib `v0.4.31` with `lib\0.107.1` is installed for Slay the Spire 2 `v0.107.1`; beta.96 Off direct proof reached main menu with clean retained verifiers and only STS2-RitsuLib as the shared runtime dependency. |
...
| AdditiveBatch1 proof | Previous-package loader/registration pass | beta.93 direct proof records 10 event types / 14 registration calls, 25/25 Spire Plus patches, clean audit, enabled-mode verifier 31 / 0, and packet verifier 61 / 0. Current beta.96 enabled-mode proof still needs recapture before gameplay claims. |
