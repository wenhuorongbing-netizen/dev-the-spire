...
Current note: this ledger is a historical June 10 snapshot. Ascension
...
| Initial localization fallback candidate snapshot | At this June 10 snapshot, a candidate list existed and no migration had been performed; superseded by the 2026-06-22 localization fallback migration. |
