...
### 0.2 Previous beta.93 override

As of 2026-06-21, previous loader truth is beta.93 on Slay the Spire 2 `v0.107.1`: `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` reached main menu with exactly STS2-RitsuLib `v0.4.31` and Spire Plus `v0.1.0-private-beta.93` loaded, only STS2-RitsuLib as the shared runtime dependency, 25/25 Spire Plus patches applied, clean audits, Off packet verifier 43 / 0, AdditiveBatch1 enabled-mode verifier 31 / 0, and AdditiveBatch1 packet verifier 61 / 0. Current beta.96 loader proof is pending. Treat beta.85, beta.86, beta.87, beta.88, and beta.90 loader lines below as retained previous-package or previous-package context unless a line explicitly names beta.93 evidence.
...
这些都有 previous beta.93 validation 记录支持：beta.93 Off proof 和 beta.93 AdditiveBatch1 proof 显示 `v0.1.0-private-beta.93`、STS2-RitsuLib `0.4.31`、compat branch `0.107.1`、25/25 patches、main menu reached、audit clean；beta.93 AdditiveBatch1 proof 显示 10 event types / 14 registration calls、enabled-mode verifier 31 / 0、packet verifier 61 / 0。当前文档也明确这些 proof 只覆盖 loader/registration 层面，不覆盖 beta.96 loader behavior、gameplay、save-load、replacement、multiplayer、image/render 或 QA。
