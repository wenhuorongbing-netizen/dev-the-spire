...
### 0.2 Current beta.105 package override

As of 2026-06-22, current package truth is beta.105 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.33`. Beta.105 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260622-025733/` with 4 / 4 Urda, Morvi, Lotha, and normal Vakuu iterations, clean audits, StS1 Off verifier pass, exact game/Ritsu/package markers, and packet verification 1621 / 0. Beta.99 clicked settings UI and direct Off proof remain previous-package context only. Previous beta.96 Off proof under `.tools/runtime-evidence/v01071-beta96-ritsulib0431-off-direct-20260621-185056/` is previous-package startup context. Previous beta.93 AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` remains previous-package enabled-mode registration context with verifier 31 / 0 and packet verifier 61 / 0. Treat beta.85, beta.86, beta.87, beta.88, beta.90, beta.93, beta.96, and beta.99 loader/settings lines below as retained previous-package or previous-game-version context.
...
Latest beta.105 governance checkpoint after the RitsuLib default-key localization and clicked UI pass: static/source docs must be recaptured for the current package before any handoff. Retained beta.99/beta.96 source-workspace, settings, and Off proof is previous-package or no-launch evidence only and does not close beta.105 enabled-mode registration, gameplay, save-load, replacement, multiplayer, QA, game-native AutoSlay batch proof, release, or handoff gates.
...
source workspace: 57 checks / 0 mismatches against installed v0.107.1, Spire Plus v0.1.0-private-beta.105, and STS2-RitsuLib 0.4.33 direct NuGet runtime layout, with two retained GDRE warnings
