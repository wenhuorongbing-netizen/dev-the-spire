...
current-doc-claims: 992 checks / 0 mismatches
...
| Static suite            | `15 static steps / 0 suite failures`                                                                                                    |
| Current doc claims      | 后续静态检查最高记录为 `992 checks / 0 mismatches`                                                                                                 |
