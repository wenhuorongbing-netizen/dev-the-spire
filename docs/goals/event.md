...
current-doc-claims: 1322 checks / 0 mismatches
...
| Static suite            | `15 static steps / 0 suite failures`                                                                                                    |
| Current doc claims      | 后续静态检查最高记录为 `1322 checks / 0 mismatches` |
