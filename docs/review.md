...
- The beta.123 package proof covers the refreshed package after later RitsuLib source migrations. Current beta.123 clicked UI smoke applied all 127 migrated Spire Plus ModPatcher patches; gameplay and handoff proof remain separate pending gates.
- Previous enabled-mode packets remain historical or previous-package context and do not close current beta.123 enabled-mode gameplay proof.
