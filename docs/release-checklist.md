...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.66 Vakuu Contract offer split package sync.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.66.zip` was rebuilt from the current source and copied to the local game root for manual testing.
  - Current package hashes: DLL `08F73F4B2F1D0DBCE0C34B5CB2B2DC2A5B46341192DFF130A593B89E2C168F89`; manifest `3EE801F5349E705AB35CB8B1F97208F154433A0DD9B520A604C6EE638D91855E`; PCK `DF4DFCD707A5673CFCB14241182B16122748A69B6C7DDD3C295E4E3CC1EC9DD9`; README `5B0677F964814C784E8B98578C3A552DADE26F8225ED5124ED600FA39FD99A26`; zip `B4BE12D11E3CCA7B6B625882BB89FC81613317D6C3C054B536F8DD05BF5A760B`.
...
- [ ] Fresh loader smoke for the current beta.66 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.66 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.66 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.66 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.66.
