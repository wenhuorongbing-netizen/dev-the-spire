...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.52 Ascension localization bridge split package sync.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.52.zip` was rebuilt from the current source and copied to the local game root for manual testing.
  - Current package hashes: DLL `CF83952566E02BEA7FBF28DE35EF17FD66CB55525310958FB8F7F892C87E6669`; manifest `5B96E28B1C322141B53ABDAA8CC65A39B07EA96228E726B207D43682BA7C73EB`; PCK `98B2CF697395B5146D3D5D8F9D7BB68AA56506F893F561F7D33CE24CAAAEBCF6`; README `8DEEEC9108CBF98BABD949C440FA15312DB85CD95318DCA3D502003C3AC45621`; zip `35A66E5BDA61FBD243D0180B4377508F4C2736B8B7ADA0EB869D573A76143F9C`.
...
- [ ] Fresh loader smoke for the current beta.52 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.52 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.52 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.52 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.52.
