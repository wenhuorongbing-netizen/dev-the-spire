...
- [x] `publish/EZMicroBalance-v0.1.0-private-beta.0.zip` is rebuilt from the current installed artifacts. Current zip SHA256 `4BC21B37C9C2D90FC4991F353245DEBB47555026975647341281480BB492F089`.
