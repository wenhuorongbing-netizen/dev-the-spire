...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.75 RootBud room-rule split package sync.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.75.zip` was rebuilt from the current source and copied to the local game root for manual testing.
  - Current package hashes: DLL `0114F0724F495069D8981146078F80E550F6159882016ED72BCDC754D12BD7A9`; manifest `87E97AF008B99E49AB9BD43B5E6A732CDD2DF55088CD189FFFA4029FF7E24969`; PCK `8E904CCDEF99342BA4C0BB4AFBC3FB1E0E5DE86A816638FF429EFD9E06A23E80`; README `28C7124005291D6CA4ACCEDE0325AEF3D72D6F7F93C10167C7EED987678D52C9`; zip `BF34B9B8D28750E19CB1C4D30AE726631C1F201618D5256AEEFF89B341051AE9`.
...
- [ ] Fresh loader smoke for the current beta.75 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.75 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.75 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.75 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.75.
