...
Current status note (2026-06-23): the active manifest is `v0.1.0-private-beta.130` after the RitsuLib compatibility and package refresh pass.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.130.zip` is rebuilt from the beta.128 RitsuLib compatibility and package refresh pass and copied to the local game root for manual testing.
- Current package hashes: DLL `6642A540458D119510BD992E0E3FDEC21CABD75D308F2D306B3FB0502B312DAA`; manifest `90400C06C926D303E789EF05496833BDEA189448F0C6E290E16DCBD1D7B257C8`; PCK `57B7AE652BD3F375EE6F9730C79D495CC513415CE8DCD50D94690DE6E0D28462`; ZIP-entry `README_INSTALL.txt` `E8F552D66C6B16D8ACC6553D6C06AE11B5BF4C79F2536EA6B1E0FCFB4CC86CC0`; zip `34A63DAD1A44C6E91D03AFE705DCA7F6C9849E64A699D0DC7676DF0923006DAD`.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.130 and should be recaptured if the settings row becomes release-blocking.
