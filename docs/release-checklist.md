...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.55 Chosen Decree card-state split and Rootblight combat-start repair package sync.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.55.zip` was rebuilt from the current source and copied to the local game root for manual testing.
  - Current package hashes: DLL `EF1A7BDFF6683822B9AA76540A40BFE72AB4B2D8A6B8E9E659C13597425CDD98`; manifest `A605825AD76F058BAAD8A14E667069F972D399AAB6890A4391EAF924E3CEC5D5`; PCK `1BA8E688583155A2D9A05F95664E8DBE615137EFDFF4519D0E9B50D4238E30D7`; README `E11BCF70072B98C7735A2EB5FBA039DC6FD3F66E1A90D7F777F7DF0C51F7ED0B`; zip `B5E8AD891DD1D7D2B421053D7792713330823927683A5153A6FCB97486AF77A4`.
...
- [ ] Fresh loader smoke for the current beta.55 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.55 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.55 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.55 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.55.
