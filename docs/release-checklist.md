...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.25 manifest/localization UTF-8 refresh.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.25.zip` was rebuilt from the current Seedbed strength/planting source and copied to the local game root for manual testing.
  - Current package hashes: DLL `89103CF5D6662D1B423259C8ED628763B42A6DD83A9B6F4D25BCD951B15DD527`; manifest `61E8F5635D4849279BCA8EE3326F6CF61CF648094D7B1E97B721C66E875A282F`; PCK `B5ACC8813F3068CB19E01737C54C2FAAACA317BC80AE3D417167AB66DB6D8EAA`; README `F894C217C7E3B3BFA67159A814BAED21C9EB4DBD84924BA774EFF3C20FE9183D`; zip `C595FC59D8FAD3731F5A2A1791D5BBCB83E15E1C37A2DDC0C92F0DF08940CD46`.
...
- [ ] Fresh loader smoke for the current beta.25 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.25 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.25 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.25 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.25.
