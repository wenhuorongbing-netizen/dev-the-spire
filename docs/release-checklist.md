...
Current status note (2026-06-23): the active manifest is `v0.1.0-private-beta.135` after the RitsuLib compatibility and package refresh pass.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.135.zip` is rebuilt from the beta.128 RitsuLib compatibility and package refresh pass and copied to the local game root for manual testing.
- Current package hashes: DLL `10649A95C03F762B73CA15D13024308CB53E8412B89BC53236B37425535437E2`; manifest `D1C63A62C6FD30E4713059C22E296413B42620753AC6FB13A4F0615888CF0716`; PCK `9EF01340EE2118A2ECA1E721A9B131C4D104D35EB1665A698372CF26B89A9F7C`; ZIP-entry `README_INSTALL.txt` `9115BA2D49F9D840F0C06FF01EF898B14C4DE432B844EE2ABCF01240BD353CF2`; zip `91D67F837BE34DDEDBECC636D8CF5182FDF201F7490DC05229B1F914A51721CC`.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.135 and should be recaptured if the settings row becomes release-blocking.
