...
Current status note (2026-06-23): the active manifest is `v0.1.0-private-beta.134` after the RitsuLib compatibility and package refresh pass.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.134.zip` is rebuilt from the beta.128 RitsuLib compatibility and package refresh pass and copied to the local game root for manual testing.
- Current package hashes: DLL `AF3EC06BBC6E708C8AC13DB4AC2C39C166929A1EB57CFADFA15B4EB103809288`; manifest `EEC56722EE87F579A4A63D9A980AD2EA62A6596BE1D1E950F64DBA9A4A1F8B83`; PCK `4353CDC0AE2E0531C0E7A3956646895FC7234E748F7FDF3DF2CF07EAC9971A85`; ZIP-entry `README_INSTALL.txt` `F6B0DFE657E2C7B9BE3A246FCFC1FC9CDAB7F02AC8D62F38FD92B1197BD9143C`; zip `ACE8FDD7ED1D7A70BBF1B1767B81632790D4568279321F3907318455FD120201`.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.134 and should be recaptured if the settings row becomes release-blocking.
