...
Current status note (2026-06-23): the active manifest is `v0.1.0-private-beta.131` after the RitsuLib compatibility and package refresh pass.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.131.zip` is rebuilt from the beta.128 RitsuLib compatibility and package refresh pass and copied to the local game root for manual testing.
- Current package hashes: DLL `0B17B22400C3804AB1F05B025C0841CBF50AC9ED2AC869A9751F92B9C7A403A2`; manifest `FD536EB87100F283AF8B86BADD372B6346FA2DDBC9C979774DB539599C3430F8`; PCK `DCD1EF840CAB05E8FDD4688EC1DCE31534059FAF9BFF21901886AA48141A34B9`; ZIP-entry `README_INSTALL.txt` `77CBF63263F1C0F4B2017AD6F24C709F6438194ABB01486D5F880A47593EC7CE`; zip `40A867AF57BE9EEA74D3A0E425391F52C159FA0F4BF4DDBDD4E9BFFEC7F017F5`.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.131 and should be recaptured if the settings row becomes release-blocking.
