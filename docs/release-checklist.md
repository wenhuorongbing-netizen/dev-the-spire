...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.72 Firemark turn-flow split package sync.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.72.zip` was rebuilt from the current source and copied to the local game root for manual testing.
  - Current package hashes: DLL `464131969A55D62E80448F35EF4715A3BD6CCC19468B972F87006350DBC40A0B`; manifest `6565ACB2839C61206D1FA8C74AB39B06CE7C472B1829993A4DDAE678F4BE8F04`; PCK `FD5151B9CE434FDCF341A71FA2F1D8E4726DEAD56FC23EE5AE1AAD1BA63592B9`; README `015B51425D4A7A4765FF242391610C92B1508DA81C073BD93A3383575087AE77`; zip `31F110602473A7358DAB96ACF537B787A8577B11B8DF38B96F3D025168EFB0D9`.
...
- [ ] Fresh loader smoke for the current beta.72 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.72 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.72 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.72 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.72.
