...
- [x] `publish/EZMicroBalance-v0.1.0-private-beta.0.zip` is rebuilt from the current installed artifacts. Current zip SHA256 `F670B27869357DD6F7EE5549948CC9D09AD8711840B655E08896F22B41D803AF`.
