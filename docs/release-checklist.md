...
- [x] Latest source/package build check passed with `dotnet build EZMicroBalance.sln` after the beta.35 manifest/localization UTF-8 refresh.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.35.zip` was rebuilt from the current Seedbed strength/planting source and copied to the local game root for manual testing.
  - Current package hashes: DLL `E4CA3D5957BECA4FFA552A7A9C68185519D2F873AA97630F84B8F7855E4420CA`; manifest `5A3A2FC0E313C15640C223A6CC5D2874881F27B468D1BC7EF4AF602CD7350EFF`; PCK `B538EF54DEC975CB7E4DA91C04D442CCACCC7E1E0088D07C2B750C065FE09BE3`; README `45E605958747C7089D5FCBC0BDE86ED0F7E646DE371658A1435B9C33703BB078`; zip `5C85C7ADD99A2A06E8999654711763A351DD19A5720FE9BF8EA22412BB78382F`.
...
- [ ] Fresh loader smoke for the current beta.35 ZIP hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` remains historical startup evidence only.
...
- [ ] Latest loader smoke for the current beta.35 package hash has not been recaptured yet.
...
- [ ] `godot.log` reviewed after fresh beta.35 normal Steam-client isolated startup/log verification.
...
- Fresh loader smoke for the current beta.35 package hash is pending. The beta.19 smoke under `.tools\runtime-evidence\beta19-loader-smoke-20260525-213336` loaded exactly BaseLib and `EZMicroBalance`, registered config, reported `v0.1.0-private-beta.19`, `Found 30 SavedSpireFields`, reached startup completion, and had 0 release-blocking hits. The helper stopped the game and restored 24 isolated mod entries. This is loader/startup evidence, not gameplay proof; it remains historical context for beta.35.
