...
Current status note (2026-06-23): the active manifest is `v0.1.0-private-beta.129` after the RitsuLib compatibility and package refresh pass.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.129 and should be recaptured if the settings row becomes release-blocking.
