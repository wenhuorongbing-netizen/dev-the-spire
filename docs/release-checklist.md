...
Current status note (2026-06-22): the active manifest is `v0.1.0-private-beta.115` after the Sovereign Blade hover ModPatcher migration and package refresh pass.
...
The beta.115 package/hash rows, runtime preflight, source-workspace
...
- [x] Latest source build check passed with `dotnet build` after the beta.115 Sovereign Blade hover ModPatcher migration and package refresh pass.
...
- [x] `publish/SpirePlus-v0.1.0-private-beta.115.zip` is rebuilt from the beta.115 Sovereign Blade hover ModPatcher migration and package refresh pass and copied to the local game root for manual testing.
- Current package hashes: DLL `B66997670206991A362D8E5B70A07076E05422852EDF0AA0034936E61D886E5A`; manifest `13F12FF957ABBB9D43BEEE5FBB65505CFC3B140812B85B8B0679CB373E424790`; PCK `2630F72AAAA230CF1AC15DEB3091536737FCCB7D6942A6BA6AA921DAB22CAFE3`; ZIP-entry `README_INSTALL.txt` `BD5CF353B93E436E011B777F6A1446A561C8D73D6FA49BED3A255124EC388BF4`; zip `0EA6C9925CC24BA9BB00314F117DFE42ADC9B9B0E51190E3E308FF7D8B84322C`.
...
- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.115 because settings code/resources did not change in the beta.108 pass.
