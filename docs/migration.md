...
| PR 5 | RitsuLib hard dependency | Medium | Compile/manifest dependency added; historical `v0.106.1` loader-gate validated; current `v0.107.1` dependency setup installed with BaseLib `v3.3.0`, STS2-RitsuLib `v0.4.24`, and beta.88 AdditiveBatch1 smoke clean |
| PR 6 | Low-risk RitsuLib API adoption | Medium | Batch 4a+4b source migrated; historical `v0.106.1` loader-gate validated; retained `v0.107.0` beta.87 package proof remains previous-game-version context; current `v0.107.1` beta.88 proof is clean for loader/patch application and AdditiveBatch1 registration shape |
