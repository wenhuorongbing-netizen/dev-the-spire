...
| `docs/reviews/current-validation.md` | Current validation summary | Compact active validation entry for beta.134 RitsuLib-only proof boundaries; full historical validation ledger lives in `docs/archive/feature-audits/`. |
