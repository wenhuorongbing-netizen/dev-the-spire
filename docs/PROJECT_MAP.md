...
| `docs/reviews/current-validation.md` | Current validation summary | Compact active validation entry for beta.135 RitsuLib-only proof boundaries; full historical validation ledger lives in `docs/archive/feature-audits/`. |
...
| RitsuLib migration | `docs/features/ritsulib-migration/README.md` for the compact development entry; use `docs/integrations/ritsulib.md` for dependency/API detail and `docs/patch-inventory.md` for generated patch counts |
| RitsuLib migration runtime smoke | `docs/features/ritsulib-migration/runtime-smoke-checklist.md` |
| RitsuLib migration archive | `docs/archive/feature-audits/ritsulib-migration/README.md` |
...
| M3 | Historical v0.106.1 source context remains available; current `v0.107.1` / STS2-RitsuLib `v0.4.34` beta.135 build, publish, package, runtime preflight, source-workspace validation, and installed parity are refreshed; previous beta.128/beta.99/beta.96/beta.93 clicked UI, loader, settings, and enabled-mode evidence is retained only as previous-package context, and enabled-mode/gameplay live smoke remains pending for beta.135. |
