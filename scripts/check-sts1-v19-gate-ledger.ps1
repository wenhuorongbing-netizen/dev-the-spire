...
$rowContentNeedles = @(
    [pscustomobject]@{ GateId = 'O0'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.86 package/runtime baseline at eaaeb5a1 and newer pushed governance/test follow-up through f686e2f6' },
