...
$rowContentNeedles = @(
    ...
    [pscustomobject]@{ GateId = 'O21'; Field = 'evidence'; Needle = 'beta.91' },
    [pscustomobject]@{ GateId = 'O22'; Field = 'requirement'; Needle = 'STS2-RitsuLib v0.4.28 with lib/0.107.1 installed' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = '.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/godot.log.current-iteration' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = 'v0.107.1' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = 'v0.1.0-private-beta.91' },
    ...
    [pscustomobject]@{ GateId = 'O67'; Field = 'evidence'; Needle = 'status-board records beta.91 RitsuLib-only AdditiveBatch1 current proof plus beta.85/beta.87/beta.88 previous-context loader proof' },
