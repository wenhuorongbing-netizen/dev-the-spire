...
$rowContentNeedles = @(
    [pscustomobject]@{ GateId = 'O0'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.92 RitsuLib-only package/runtime baseline and requires exact HEAD/worktree recapture for later governance/test follow-up commits' },
    ...
    [pscustomobject]@{ GateId = 'O4'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.92 zero-warning validation' },
    ...
    [pscustomobject]@{ GateId = 'O9'; Field = 'evidence'; Needle = 'ZIP SHA F02683DA621A1B116DD47AF13C529088433E4D6F66B0994503090EC23CEC8A57' },
    ...
    [pscustomobject]@{ GateId = 'O21'; Field = 'evidence'; Needle = 'beta.92' },
    [pscustomobject]@{ GateId = 'O22'; Field = 'requirement'; Needle = 'STS2-RitsuLib v0.4.29 with lib/0.107.1 installed' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = '.tools/runtime-evidence/v01071-beta92-ritsulib0429-additivebatch1-direct-20260621/godot.log.current-iteration' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = 'v0.107.1' },
    [pscustomobject]@{ GateId = 'O23'; Field = 'evidence'; Needle = 'v0.1.0-private-beta.92' },
    ...
    [pscustomobject]@{ GateId = 'O67'; Field = 'evidence'; Needle = 'status-board records beta.92 RitsuLib-only AdditiveBatch1 current proof plus beta.85/beta.87/beta.88 previous-context loader proof' },
