...
$rowContentNeedles = @(
    ...
    [pscustomobject]@{ GateId = 'O24'; Field = 'evidence'; Needle = 'runtime-evidence-packet-check.json checks=52 mismatches=0' },
    [pscustomobject]@{ GateId = 'O24'; Field = 'evidence'; Needle = 'enabled-mode log verifier checks=31 mismatches=0' },
    ...
    [pscustomobject]@{ GateId = 'O33'; Field = 'evidence'; Needle = 'enabled-mode-log-check.json checks=31 mismatches=0' },
    ...
    [pscustomobject]@{ GateId = 'O67'; Field = 'evidence'; Needle = 'status-board records beta.87 AdditiveBatch1 proof plus beta.85 Off/CanaryOnly previous-package context' },
