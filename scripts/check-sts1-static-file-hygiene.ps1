...
Add-Check -Name 'sts1_hygiene_scans_archived_ritsu_localization_record' -Passed ($uniquePaths -contains (Resolve-RepoPath 'docs\archive\feature-audits\ritsulib-migration\batch-4c-candidates-20260623.md')) -Detail 'archived RitsuLib localization record must be included in static-file hygiene scope'
