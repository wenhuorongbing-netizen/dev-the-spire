...
Add-ContainsCheck -Name 'fail_closed_current_off_not_coop' -Text $failClosed -Needle 'current beta.91 `v0.107.1` Off and AdditiveBatch1 loader proof is clean, but it is not co-op or gameplay evidence, and CanaryOnly-specific claims require fresh current-version proof.'
