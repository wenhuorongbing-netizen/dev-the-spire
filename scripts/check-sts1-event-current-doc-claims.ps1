...
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_1249' -Text $goalEventDoc -Needle 'current-doc-claims: 1249 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_1249' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*1249 checks / 0 mismatches'
