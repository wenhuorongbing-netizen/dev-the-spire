...
Add-ContainsCheck -Name 'private_beta_handoff_current_beta93_date_boundary' -Text $privateBetaHandoff -Needle 'Date: 2026-06-21 current beta.93 handoff summary; older May notes below are retained only as historical context.'
Add-ContainsCheck -Name 'agents_current_beta93_additive_path' -Text $agents -Needle 'current beta.93 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`'
...
Add-ContainsCheck -Name 'root_readme_beta88_additive_path' -Text $rootReadme -Needle '.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/'
...
Add-ContainsCheck -Name 'root_readme_sts1_enabled_smokes_current_split' -Text $rootReadme -Needle 'The beta.93 RitsuLib-only Off proof reached main menu with exactly `STS2-RitsuLib` and `EZMicroBalance` loaded, clean audit, and packet verifier 43 / 0; beta.93 AdditiveBatch1 registered 10 event types through 14 calls with verifier 31 / 0 and packet 61 / 0.'
...
Add-ContainsCheck -Name 'restructure_doc_current_ritsulib_only_target' -Text $restructureDoc -Needle 'Current package/runtime target is Spire Plus `v0.1.0-private-beta.93` on Slay'
...
Add-ContainsCheck -Name 'doc_restructure_spec_beta93_nonclaim' -Text $docRestructureSpec -Needle 'current beta.93 proves only RitsuLib-only `v0.107.1` Off and AdditiveBatch1 loader/registration behavior, beta.85/beta.87/beta.88/beta.90 rows remain previous-context evidence, and current CanaryOnly gameplay/runtime, save-load, replacement, multiplayer, QA, and handoff proof remain pending or blocked.'
...
Add-ContainsCheck -Name 'remote_setup_beta85_off_path' -Text $remoteDevelopmentSetup -Needle '.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/'
...
Add-ContainsCheck -Name 'docs_readme_sts1_beta93_loader_only' -Text $docsReadme -Needle 'current beta.93 RitsuLib-only AdditiveBatch1 proof covers loader/registration only'
Add-ContainsCheck -Name 'docs_readme_sts1_additive_pending_counts' -Text $docsReadme -Needle 'current beta.93 RitsuLib-only AdditiveBatch1 proof covers loader/registration only with 10 event types / 14 registration calls, while gameplay, save-load, replacement, multiplayer, QA, and handoff proof remain unproven'
...
Add-ContainsCheck -Name 'root_test_plan_additive_still_requires_clean_packet' -Text $rootTestPlan -Needle 'Installed beta.93 package parity is restored, and current beta.93 `v0.107.1` RitsuLib-only direct AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` reached main menu'
Add-ContainsCheck -Name 'migration_doc_current_off_canary_loader_only' -Text $migrationDoc -Needle 'The retained `v0.107.0` beta.87 package proof, BaseLib-backed beta.88 proof, and previous RitsuLib-only beta.90 proof remain previous-context evidence; current `v0.107.1` beta.93 proof is clean at `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` for loader/patch application and AdditiveBatch1 registration shape.'
...
Add-ContainsCheck -Name 'goal_migration_beta87_current_override' -Text $goalMigrationDoc -Needle 'Current beta.93 RitsuLib-only AdditiveBatch1 proof is `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`. The BaseLib `v3.2.1` patch failures in `.tools/runtime-evidence/v01071-beta87-additive-batch1-direct-20260619-102309/` are root-cause history.'
Add-ContainsCheck -Name 'goal_debug_beta85_off_loader_nonclaim' -Text $goalDebugDoc -Needle 'loader proof'
Add-ContainsCheck -Name 'goal_debug_beta87_current_override' -Text $goalDebugDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous BaseLib-backed context, and beta.93 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_refactor_beta87_current_override' -Text $goalRefactorDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous BaseLib-backed context, and beta.93 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_event_beta88_current_override' -Text $goalEventDoc -Needle 'current loader truth is beta.93 on Slay the Spire 2 `v0.107.1`: `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` reached main menu with exactly STS2-RitsuLib `v0.4.31` and Spire Plus `v0.1.0-private-beta.93` loaded, no Spire Plus BaseLib dependency, 25/25 Spire Plus patches applied, clean audits, Off packet verifier 43 / 0, AdditiveBatch1 enabled-mode verifier 31 / 0, and AdditiveBatch1 packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'goal_event_latest_beta93_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.93 governance checkpoint after the gate-ledger/current-doc cleanup: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 1331 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'goal_event_source_workspace_checkpoint_beta93' -Text $goalEventDoc -Needle 'source workspace: 60 checks / 0 mismatches against installed v0.107.1 and STS2-RitsuLib 0.4.31 / compat 0.107.1'
...
Add-ContainsCheck -Name 'goal_event_beta88_additive_loader_current_pass_section' -Text $goalEventDoc -Needle 'Current beta.93 RitsuLib-only AdditiveBatch1 loader registration proof can be treated as current-pass for `O33`.'
Add-ContainsCheck -Name 'goal_event_off_canary_loader_nonextension_boundary' -Text $goalEventDoc -Needle 'Retained beta.85 Off, retained beta.85 CanaryOnly, retained beta.87 AdditiveBatch1, previous BaseLib-backed beta.88 AdditiveBatch1, and current beta.93 AdditiveBatch1 loader proof must not be extended to:'
...
Add-ContainsCheck -Name 'test_ready_goal_beta86_preflight_drift' -Text $testReadyGoal -Needle 'The current retained package/runtime evidence target is `publish/SpirePlus-v0.1.0-private-beta.93.zip`; build, publish, package refresh, installed-package check, runtime preflight, and direct RitsuLib-only Off/AdditiveBatch1 loader proof have run'
Add-ContainsCheck -Name 'dev_environment_sts1_enabled_smokes_current_split' -Text $devEnvironment -Needle 'beta.93 RitsuLib-only AdditiveBatch1 proof is clean current package context under `.tools\runtime-evidence\v01071-beta93-ritsulib0431-additivebatch1-direct-20260621`, with 10 event types / 14 registration calls, enabled-mode verifier 31 / 0, and packet verifier 61 / 0.'
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_boundary' -Text $rootIssues -Needle 'current RitsuLib-only AdditiveBatch1 loader/registration proof exists at `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`'
...
Add-ContainsCheck -Name 'ritsu_monthly_current_off_nonclaim' -Text $ritsuMonthlyDevSpec -Needle 'Current-runtime beta.93 Off loader smoke is clean with exactly STS2-RitsuLib and Spire Plus loaded.'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_beta85_off_path' -Text $ritsuRuntimeHardBlock -Needle '.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_current_package_target' -Text $runtimeMonkeyDocs -Needle '-ExpectedPackageVersion v0.1.0-private-beta.93'
...
Add-ContainsCheck -Name 'runtime_checklist_after_pause_controlled_lane' -Text $runtimeChecklist -Needle 'the 2026-06-21 beta.93 direct packets supersede beta.88/beta.90 for current RitsuLib-only loader/registration proof only.'
...
Add-ContainsCheck -Name 'runtime_evidence_packet_exact_allowed_mod_ids' -Text $runtimeChecklist -Needle 'AllowedModIds` exactly equal to STS2-RitsuLib and EZMicroBalance for the current beta.93 RitsuLib-only lane'
...
Add-ContainsCheck -Name 'next_overnight_beta87_totals' -Text $nextOvernight -Needle 'Latest beta.93 no-game/package validation is summarized in `PROJECT_STATE.md` and `docs/reviews/current-validation.md`: build/publish/package refresh, installed-package parity, runtime preflight, source-workspace check, and RitsuLib-only Off/AdditiveBatch1 packet verification passed for the current dependency target.'
...
Add-ContainsCheck -Name 'next_overnight_head_validation_beta87' -Text $nextOvernight -Needle 'Current HEAD validation refreshed after the beta.93 RitsuLib-only dependency pass and runtime packet-checker hardening; recheck again before handoff if any later edits appear.'
...
Add-ContainsCheck -Name 'next_overnight_batch1_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any AdditiveBatch1 gameplay claim, confirm the beta.93 package and STS2-RitsuLib `v0.4.31` / `lib\0.107.1` runtime are still installed and current'
...
Add-ContainsCheck -Name 'ritsu_monthly_enabled_smokes_boundary' -Text $ritsuMonthlyDevSpec -Needle 'Current beta.93 AdditiveBatch1 enabled-mode smoke is clean with 10 event types / 14 registration calls and retained verifier reports.'
...
Add-ContainsCheck -Name 'ritsu_monthly_batch1_smoke_before_gameplay' -Text $ritsuMonthlyDevSpec -Needle 'Use the current AdditiveBatch1 enabled-mode smoke at `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` as the beta.93 / `v0.107.1` 10 event types / 14 registration-call proof; recapture it after any package/source change before using it for a new claim.'
...
Add-ContainsCheck -Name 'ritsu_batch4c_enabled_smokes_boundary' -Text $ritsuBatch4cCandidates -Needle 'Current beta.93 AdditiveBatch1 retained log and packet verifiers passed with 10 event types / 14 registration lines and exact tuple parity. This is loader/registration proof only and is not Batch 4c approval, gameplay proof, or handoff proof.'
...
Add-ContainsCheck -Name 'sts1_goal_default_off_canary_additive_boundary' -Text $sts1FeatureGoal -Needle 'Current beta.93 proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` covers AdditiveBatch1 loader/registration shape on Slay the Spire 2 `v0.107.1` with RitsuLib `v0.4.31` / `lib\0.107.1` and no BaseLib dependency: 25/25 Spire Plus patches, 10 event types / 14 registration calls, clean audit, retained enabled-mode verifier 31 / 0, and runtime packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'sts1_goal_compile_package_current_split' -Text $sts1FeatureGoal -Needle 'Events must compile against the current repository package reference: `STS2.RitsuLib` `0.4.31`; Spire Plus must not require BaseLib.'
...
Add-ContainsCheck -Name 'closure_plan_runtime_batch1_beta93_10_14' -Text $localizationClosurePlan -Needle 'Current beta.93 `v0.107.1` AdditiveBatch1 enabled-mode smoke with 10 event types / 14 source registration calls, or a fresher package-matched recapture if the worktree/package changes.'
...
Add-ContainsCheck -Name 'sts1_event_engine_research_beta93_nonclaim' -Text $sts1EventEngineResearch -Needle 'Current beta.93 proves only RitsuLib-only Off and AdditiveBatch1 loader/registration behavior; beta.85/beta.87/beta.88/beta.90 rows remain previous-context evidence. CanaryOnly gameplay/runtime, save-load, replacement, multiplayer, QA, handoff, and release-ready proof still require fresh current evidence.'
...
Add-ContainsCheck -Name 'status_board_current_enabled_boundary' -Text $statusBoard -Needle 'Current beta.93 has clean RitsuLib-only `v0.107.1` Off and AdditiveBatch1 direct loader/registration proof with STS2-RitsuLib `v0.4.31`, 25/25 Spire Plus patches applied, 10 event types / 14 registration calls, and exact tuple parity.'
...
Add-ContainsCheck -Name 'test_plan_manual_smoke_batch1_10_14' -Text $testPlan -Needle 'Treat `.tools\runtime-evidence\v01071-beta93-ritsulib0431-additivebatch1-direct-20260621` as current `v0.107.1` AdditiveBatch1 loader smoke only: 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'gate_map_o0_o76_scope' -Text $gateMap -Needle 'Scope: `docs/goals/event.md` Mandatory Overnight Run v19/v21 carry-forward, current `v0.107.1` / beta.93 loader truth.'
...
Add-ContainsCheck -Name 'gate_map_o21_o24_off_pass' -Text $gateMap -Needle '| `O21-O24` | current beta.93 RitsuLib-only loader pass |'
...
Add-ContainsCheck -Name 'gate_map_enabled_log_verifier_non_claim' -Text $gateMap -Needle 'They do not close gameplay gates; `O33` is closed only as loader-registration proof by the current beta.93 AdditiveBatch1 packet'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o9_beta93_zip_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O9'; Field = 'evidence'; Needle = 'ZIP SHA 5E9B851F2EF5B42318C10B51DF6C37C9B80A4177A1FD17FADD35AEAD62BAEEF9'"
...
Add-ContainsCheck -Name 'gate_ledger_package_sha' -Text $gateLedger -Needle 'ZIP SHA 5E9B851F2EF5B42318C10B51DF6C37C9B80A4177A1FD17FADD35AEAD62BAEEF9'
...
Add-ContainsCheck -Name 'current_validation_historical_target_fix_old_shape_nonclaim' -Text $currentValidation -Needle 'Historical Off mode proved 0 StS1 registration lines; historical CanaryOnly proved exactly 4 canary content registrations for that source/runtime state. Retained beta.85 default-Off/CanaryOnly and beta.87 AdditiveBatch1 proof are previous `v0.107.0` loader context; current beta.93 RitsuLib-only Off/AdditiveBatch1 proof is the active loader/registration truth'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pass for beta.93 loader/registration; gameplay evidence pending'
...
Add-ContainsCheck -Name 'private_beta_release_audit_current_beta93_date_boundary' -Text $privateBetaReleaseAudit -Needle 'Original audit date: 2026-05-15; latest beta.93 RitsuLib-only evidence refresh: 2026-06-21.'
Add-ContainsCheck -Name 'test_ready_completion_audit_current_beta93_date_boundary' -Text $testReadyCompletionAudit -Needle 'Original audit date: 2026-05-14; latest beta.93 RitsuLib-only evidence refresh: 2026-06-21.'
...
Add-ContainsCheck -Name 'platform_testing_current_beta85_zip' -Text $platformTesting -Needle 'publish/SpirePlus-v0.1.0-private-beta.93.zip'
