...
Add-ContainsCheck -Name 'restructure_doc_current_ritsulib_only_target' -Text $restructureDoc -Needle 'Current package/runtime target is Spire Plus `v0.1.0-private-beta.91` on Slay'
...
Add-ContainsCheck -Name 'goal_event_latest_beta91_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.91 governance checkpoint after the gate-ledger/current-doc cleanup: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 1324 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'legacy_v5_monthly_spec_beta91_additive_nonclaim' -Text $legacyV5MonthlySpec -Needle 'AdditiveBatch1 loader/registration with STS2-RitsuLib `0.4.28`'
