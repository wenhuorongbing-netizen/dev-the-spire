...
Add-ContainsCheck -Name 'goal_event_latest_beta92_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.92 governance checkpoint after the gate-ledger/current-doc cleanup: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 1331 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'hard_stop_beta92_supersession_note' -Text $hardStop -Needle 'Supersession note, 2026-06-21: this report remains the historical v19 coordination-blocker trace.'
