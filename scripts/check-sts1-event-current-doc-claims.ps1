...
Add-ContainsCheck -Name 'scripts_readme_autoslay_packet_requires_expected_ancient_ids' -Text $scriptsReadme -Needle 'optional `-ExpectedAncientIds` target coverage'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_requires_event_markers' -Text $runtimeMonkeyDocs -Needle 'traversal markers such as `Entering Event room`'
