...
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_boundary' -Text $rootIssues -Needle 'Beta.105 package parity, runtime preflight 28 / 0, source-workspace validation 58 / 0, and clicked UI smoke are current; packet verification passed 1621 / 0.'
