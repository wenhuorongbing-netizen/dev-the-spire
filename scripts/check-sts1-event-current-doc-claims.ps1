...
Add-ContainsCheck -Name 'migration_doc_beta96_boundary' -Text $migrationDoc -Needle 'Spire Plus is on the beta.96 RitsuLib-only target:'
Add-ContainsCheck -Name 'migration_doc_beta93_loader_only' -Text $migrationDoc -Needle 'Prior beta.93 RitsuLib-only Off and AdditiveBatch1 proof is loader and'
