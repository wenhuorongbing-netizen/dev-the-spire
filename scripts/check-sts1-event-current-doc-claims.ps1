...
Add-ContainsCheck -Name 'goal_event_beta99_current_loader_boundary' -Text $goalEventDoc -Needle 'As of 2026-06-22, current package truth is beta.105 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.33`. Beta.105 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-20260622-025733/`'
...
Add-ContainsCheck -Name 'goal_event_latest_beta94_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.105 governance checkpoint after the RitsuLib default-key localization and clicked UI pass: static/source docs must be recaptured for the current package before any handoff.'
...
Add-ContainsCheck -Name 'goal_event_source_workspace_checkpoint_beta93' -Text $goalEventDoc -Needle 'source workspace: 57 checks / 0 mismatches against installed v0.107.1, Spire Plus v0.1.0-private-beta.105, and STS2-RitsuLib 0.4.33 direct NuGet runtime layout'
