...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_beta96_target' -Text $ritsuRuntimeHardBlock -Needle 'Spire Plus `v0.1.0-private-beta.96`'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_current_enabled_pending' -Text $ritsuRuntimeHardBlock -Needle 'Current hard blocks are beta.96 loader'
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_manual_gates_pending' -Text $ritsuRuntimeHardBlock -Needle 'clicked Ancient UI, save-load, replacement behavior,'
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_coordination_boundary' -Text $ritsuRuntimeHardBlock -Needle 'After coordination clears, capture beta.96 loader'
