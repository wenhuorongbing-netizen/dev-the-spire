...
Add-ContainsCheck -Name 'beta_compat_beta96_target' -Text $betaCompatibility -Needle 'Spire Plus `v0.1.0-private-beta.99`'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_beta96_target' -Text $ritsuRuntimeHardBlock -Needle 'Spire Plus `v0.1.0-private-beta.99`'
...
Add-ContainsCheck -Name 'runtime_checklist_beta96_target' -Text $runtimeChecklist -Needle 'Spire Plus `v0.1.0-private-beta.99`'
...
Add-ContainsCheck -Name 'runtime_exit_status_beta96_pending' -Text $runtimeChecklist -Needle 'Current exit status: beta.99 package parity passes; clicked RitsuLib Mod'
