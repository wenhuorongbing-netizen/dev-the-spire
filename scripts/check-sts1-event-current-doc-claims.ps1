...
Add-ContainsCheck -Name 'ritsu_monthly_current_off_nonclaim' -Text $ritsuMonthlyDevSpec -Needle 'Beta.105 package parity, runtime preflight, source-workspace validation, and clicked Ancient UI smoke are current under `.tools/runtime-evidence/monkey-stability-20260622-025733/`; beta.99 direct Off loader smoke and clicked RitsuLib settings UI proof are previous-package context'
