...
Add-ContainsCheck -Name 'agents_current_beta91_additive_path' -Text $agents -Needle 'current beta.91 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/`'
...
Add-ContainsCheck -Name 'root_readme_beta88_additive_path' -Text $rootReadme -Needle '.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/'
...
Add-ContainsCheck -Name 'root_readme_sts1_enabled_smokes_current_split' -Text $rootReadme -Needle 'The beta.91 RitsuLib-only Off proof reached main menu with exactly `STS2-RitsuLib` and `EZMicroBalance` loaded, clean audit, and packet verifier 43 / 0; beta.91 AdditiveBatch1 registered 10 event types through 14 calls with verifier 31 / 0 and packet 61 / 0.'
...
Add-ContainsCheck -Name 'patch_boundaries_sts1_beta88_additive_nonclaim' -Text $patchBoundaries -Needle 'beta.85 proves retained `v0.107.0` default-Off and CanaryOnly loader behavior, beta.87 proves retained `v0.107.0` AdditiveBatch1 loader/registration behavior, beta.88 proves previous BaseLib-backed `v0.107.1` AdditiveBatch1 loader/registration behavior, and current beta.91 proves `v0.107.1` RitsuLib-only Off plus AdditiveBatch1 loader/registration behavior with STS2-RitsuLib `0.4.28`, 25/25 patches, 10 event types / 14 calls, clean audit, enabled-mode verifier 31 / 0, and runtime packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'remote_setup_beta85_off_path' -Text $remoteDevelopmentSetup -Needle '.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/'
...
Add-ContainsCheck -Name 'docs_readme_sts1_beta91_loader_only' -Text $docsReadme -Needle 'current beta.91 RitsuLib-only AdditiveBatch1 proof covers loader/registration only'
Add-ContainsCheck -Name 'docs_readme_sts1_additive_pending_counts' -Text $docsReadme -Needle 'current beta.91 RitsuLib-only AdditiveBatch1 proof covers loader/registration only with 10 event types / 14 registration calls, while gameplay, save-load, replacement, multiplayer, QA, and handoff proof remain unproven'
Add-ContainsCheck -Name 'root_test_plan_beta88_additive_path' -Text $rootTestPlan -Needle '.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620'
...
Add-ContainsCheck -Name 'root_test_plan_additive_still_requires_clean_packet' -Text $rootTestPlan -Needle 'Installed beta.91 package parity is restored, and current beta.91 `v0.107.1` RitsuLib-only direct AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` reached main menu'
Add-ContainsCheck -Name 'migration_doc_current_off_canary_loader_only' -Text $migrationDoc -Needle 'The retained `v0.107.0` beta.87 package proof, BaseLib-backed beta.88 proof, and previous RitsuLib-only beta.90 proof remain previous-context evidence; current `v0.107.1` beta.91 proof is clean at `.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/` and `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` for loader/patch application and AdditiveBatch1 registration shape.'
...
Add-ContainsCheck -Name 'goal_migration_beta87_current_override' -Text $goalMigrationDoc -Needle 'Current beta.91 RitsuLib-only AdditiveBatch1 proof is `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/`. The BaseLib `v3.2.1` patch failures in `.tools/runtime-evidence/v01071-beta87-additive-batch1-direct-20260619-102309/` are root-cause history.'
Add-ContainsCheck -Name 'goal_debug_beta85_off_loader_nonclaim' -Text $goalDebugDoc -Needle 'loader proof'
Add-ContainsCheck -Name 'goal_debug_beta87_current_override' -Text $goalDebugDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous BaseLib-backed context, and beta.91 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_refactor_beta87_current_override' -Text $goalRefactorDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous BaseLib-backed context, and beta.91 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_event_beta88_current_override' -Text $goalEventDoc -Needle 'current loader truth is beta.91 on Slay the Spire 2 `v0.107.1`: `.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/` and `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` reached main menu with exactly STS2-RitsuLib `v0.4.28` and Spire Plus `v0.1.0-private-beta.91` loaded, no Spire Plus BaseLib dependency, 25/25 Spire Plus patches applied, clean audits, Off packet verifier 43 / 0, AdditiveBatch1 enabled-mode verifier 31 / 0, and AdditiveBatch1 packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_1314' -Text $goalEventDoc -Needle 'current-doc-claims: 1314 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'goal_event_autoslay_source_workspace_checkpoint' -Text $goalEventDoc -Needle '`scripts/check-local-godot-source-workspace.ps1` returned 50 checks / 0 mismatches with all AutoSlay contract checks passing'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_1314' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*1314 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'goal_event_beta88_additive_loader_current_pass_section' -Text $goalEventDoc -Needle 'Current beta.91 RitsuLib-only AdditiveBatch1 loader registration proof can be treated as current-pass for `O33`.'
Add-ContainsCheck -Name 'goal_event_off_canary_loader_nonextension_boundary' -Text $goalEventDoc -Needle 'Retained beta.85 Off, retained beta.85 CanaryOnly, retained beta.87 AdditiveBatch1, previous BaseLib-backed beta.88 AdditiveBatch1, and current beta.91 AdditiveBatch1 loader proof must not be extended to:'
...
Add-ContainsCheck -Name 'test_ready_goal_beta86_preflight_drift' -Text $testReadyGoal -Needle 'The current retained package/runtime evidence target is `publish/SpirePlus-v0.1.0-private-beta.91.zip`; build, publish, package refresh, installed-package check, runtime preflight, and direct RitsuLib-only Off/AdditiveBatch1 loader proof have run'
Add-ContainsCheck -Name 'dev_environment_sts1_enabled_smokes_current_split' -Text $devEnvironment -Needle 'beta.91 RitsuLib-only AdditiveBatch1 proof is clean current package context under `.tools\runtime-evidence\v01071-beta91-ritsulib0428-additivebatch1-direct-20260620`, with 10 event types / 14 registration calls, enabled-mode verifier 31 / 0, and packet verifier 61 / 0.'
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_boundary' -Text $rootIssues -Needle 'current RitsuLib-only AdditiveBatch1 loader/registration proof exists at `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/`'
...
Add-ContainsCheck -Name 'legacy_v5_monthly_spec_v19_pointer' -Text $legacyV5MonthlySpec -Needle 'Current StS1 event work routes through `docs/goals/event.md`, `docs/features/sts1-events/v19-gate-evidence-map.md`, `docs/features/sts1-events/v19-gate-ledger.csv`, `docs/features/sts1-events/v20-final-gate-overlay.csv`, `docs/features/sts1-events/hard-stop-blocker-report-v20-coordination-pause-20260617.md`, `PROJECT_STATE.md`, and `docs/test-ready-development-goal.md`'
Add-ContainsCheck -Name 'legacy_v5_monthly_spec_beta86_additive_nonclaim' -Text $legacyV5MonthlySpec -Needle 'beta.85 proves retained `v0.107.0` default-Off and CanaryOnly loader behavior, beta.87 proves retained `v0.107.0` AdditiveBatch1 loader/registration behavior, current `v0.107.1` loader proof needs recapture'
...
Add-ContainsCheck -Name 'ritsu_monthly_current_off_nonclaim' -Text $ritsuMonthlyDevSpec -Needle 'Current-runtime beta.91 Off loader smoke is clean with exactly STS2-RitsuLib and Spire Plus loaded.'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_current_note' -Text $ritsuRuntimeHardBlock -Needle '2026-06-20 current note: this report is historical `v0.106.1` loader-gate evidence.'
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_beta85_off_path' -Text $ritsuRuntimeHardBlock -Needle '.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/'
...
Add-ContainsCheck -Name 'm5_runtime_drift_beta87_additive_path' -Text $m5RevisionMRuntimeDriftReport -Needle 'Current beta.87 AdditiveBatch1 proof is `.tools/runtime-evidence/v01070-beta87-additive-batch1-direct-20260618-152531/`'
...
Add-ContainsCheck -Name 'm5_patch_failure_current_package_proof' -Text $m5RevisionMPatchFailureLedger -Needle '.tools/runtime-evidence/v01070-beta87-additive-batch1-direct-20260618-152531/godot.log.after-launch` is the current package proof'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_current_package_target' -Text $runtimeMonkeyDocs -Needle '-ExpectedPackageVersion v0.1.0-private-beta.91'
Add-ContainsCheck -Name 'runtime_monkey_docs_runtime_current_package_target' -Text $runtimeMonkeyDocs -Needle '.\scripts\check-spire-plus-runtime-monkey-packet.ps1 `
  ...
  -ExpectedPackageVersion v0.1.0-private-beta.91'
...
Add-ContainsCheck -Name 'runtime_exit_status_off_canary_batch1_blocked' -Text $runtimeChecklist -Needle 'Current exit status: beta.91 Off and AdditiveBatch1 loader rows pass for `v0.107.1` with RitsuLib `v0.4.28` / `lib\0.107.1` and no Spire Plus BaseLib dependency; beta.85/beta.87/beta.88/beta.90 loader rows remain previous-package or previous-dependency context.'
...
Add-ContainsCheck -Name 'runtime_checklist_after_pause_controlled_lane' -Text $runtimeChecklist -Needle 'the 2026-06-20 beta.91 direct packets supersede beta.88/beta.90 for current RitsuLib-only loader/registration proof only.'
...
Add-ContainsCheck -Name 'runtime_evidence_packet_exact_allowed_mod_ids' -Text $runtimeChecklist -Needle 'AllowedModIds` exactly equal to STS2-RitsuLib and EZMicroBalance for the current beta.91 RitsuLib-only lane'
...
Add-ContainsCheck -Name 'next_overnight_beta87_totals' -Text $nextOvernight -Needle 'Latest beta.91 no-game/package validation is summarized in `PROJECT_STATE.md` and `docs/reviews/current-validation.md`: build/publish/package refresh, installed-package parity, runtime preflight, source-workspace check, and RitsuLib-only Off/AdditiveBatch1 packet verification passed for the current dependency target.'
...
Add-ContainsCheck -Name 'next_overnight_head_validation_beta87' -Text $nextOvernight -Needle 'Current HEAD validation refreshed after the beta.91 RitsuLib-only dependency pass and runtime packet-checker hardening; recheck again before handoff if any later edits appear.'
...
Add-ContainsCheck -Name 'next_overnight_batch1_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any AdditiveBatch1 gameplay claim, confirm the beta.91 package and STS2-RitsuLib `v0.4.28` / `lib\0.107.1` runtime are still installed and current'
...
Add-ContainsCheck -Name 'ritsu_monthly_enabled_smokes_boundary' -Text $ritsuMonthlyDevSpec -Needle 'Current beta.91 AdditiveBatch1 enabled-mode smoke is clean with 10 event types / 14 registration calls and retained verifier reports.'
...
Add-ContainsCheck -Name 'ritsu_monthly_batch1_smoke_before_gameplay' -Text $ritsuMonthlyDevSpec -Needle 'Use the current AdditiveBatch1 enabled-mode smoke at `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` as the beta.91 / `v0.107.1` 10 event types / 14 registration-call proof; recapture it after any package/source change before using it for a new claim.'
...
Add-ContainsCheck -Name 'ritsu_batch4c_enabled_smokes_boundary' -Text $ritsuBatch4cCandidates -Needle 'Current beta.91 AdditiveBatch1 retained log and packet verifiers passed with 10 event types / 14 registration lines and exact tuple parity. This is loader/registration proof only and is not Batch 4c approval, gameplay proof, or handoff proof.'
...
Add-ContainsCheck -Name 'issue_current_off_plus_canary_correction' -Text $liveRiskIssue -Needle 'current beta.85 `v0.107.0` proof exists for default-Off plus CanaryOnly loader registration only'
...
Add-ContainsCheck -Name 'sts1_goal_revision_n_boundary' -Text $sts1FeatureGoal -Needle 'Current Boundary (Revision P / beta.91)'
Add-ContainsCheck -Name 'sts1_goal_not_complete' -Text $sts1FeatureGoal -Needle 'This goal is not complete.'
Add-ContainsCheck -Name 'sts1_goal_default_off_canary_additive_boundary' -Text $sts1FeatureGoal -Needle 'Current beta.91 proof under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` covers AdditiveBatch1 loader/registration shape on Slay the Spire 2 `v0.107.1` with RitsuLib `v0.4.28` / `lib\0.107.1` and no BaseLib dependency: 25/25 Spire Plus patches, 10 event types / 14 registration calls, clean audit, retained enabled-mode verifier 31 / 0, and runtime packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'sts1_goal_compile_package_current_split' -Text $sts1FeatureGoal -Needle 'Events must compile against the current repository package reference: `STS2.RitsuLib` `0.4.28`; Spire Plus must not require BaseLib.'
Add-ContainsCheck -Name 'sts1_goal_runtime_ritsu_variant_split' -Text $sts1FeatureGoal -Needle 'Current runtime reproof targets the installed official `STS2-RitsuLib` `v0.4.28` variant pack with `lib\0.107.1`.'
...
Add-ContainsCheck -Name 'implementation_plan_revision_n_boundary' -Text $implementationPlan -Needle 'Current boundary, Revision P / beta.91'
...
Add-ContainsCheck -Name 'implementation_plan_current_counts' -Text $implementationPlan -Needle 'Current beta.91 proof under `.tools/runtime-evidence/v01071-beta91-ritsulib0428-off-direct-20260620/` and `.tools/runtime-evidence/v01071-beta91-ritsulib0428-additivebatch1-direct-20260620/` covers `v0.107.1` RitsuLib-only Off/AdditiveBatch1 loader/registration only with STS2-RitsuLib `v0.4.28`, 25/25 patches, clean audit, retained enabled-mode verifier 31 / 0, and AdditiveBatch1 runtime packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'sts1_act_registration_research_source_not_gameplay' -Text $sts1ActEventRegistrationResearch -Needle 'This source-research note documents current intended StS1 registration shape and static source evidence. It is not current `v0.107.0` gameplay proof.'
Add-ContainsCheck -Name 'sts1_act_registration_research_beta86_nonclaim' -Text $sts1ActEventRegistrationResearch -Needle 'Beta.85 proves default-Off and CanaryOnly loader behavior, and beta.86 proves AdditiveBatch1 loader/registration behavior. Gameplay, save-load, replacement, multiplayer, QA, handoff, and release-ready proof still require fresh current evidence.'
...
Add-ContainsCheck -Name 'sts1_event_engine_research_source_not_gameplay' -Text $sts1EventEngineResearch -Needle 'This source-research note documents event-engine APIs and source patterns for StS1 event implementation. It is not current `v0.107.0` gameplay proof.'
Add-ContainsCheck -Name 'sts1_event_engine_research_beta86_nonclaim' -Text $sts1EventEngineResearch -Needle 'Beta.85 proves default-Off and CanaryOnly loader behavior, and beta.86 proves AdditiveBatch1 loader/registration behavior. Gameplay, save-load, replacement, multiplayer, QA, handoff, and release-ready proof still require fresh current evidence.'
...
Add-ContainsCheck -Name 'status_board_current_enabled_boundary' -Text $statusBoard -Needle 'Current beta.91 has clean RitsuLib-only `v0.107.1` Off and AdditiveBatch1 direct loader/registration proof with STS2-RitsuLib `v0.4.28`, 25/25 Spire Plus patches applied, 10 event types / 14 registration calls, and exact tuple parity.'
...
Add-ContainsCheck -Name 'test_plan_manual_smoke_batch1_10_14' -Text $testPlan -Needle 'Treat `.tools\runtime-evidence\v01071-beta91-ritsulib0428-additivebatch1-direct-20260620` as current `v0.107.1` AdditiveBatch1 loader smoke only: 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'gate_map_o0_o76_scope' -Text $gateMap -Needle 'Scope: `docs/goals/event.md` Mandatory Overnight Run v19/v21 carry-forward, current `v0.107.1` / beta.91 loader truth.'
...
Add-ContainsCheck -Name 'gate_map_o21_o24_off_pass' -Text $gateMap -Needle '| `O21-O24` | current beta.91 RitsuLib-only loader pass |'
...
Add-ContainsCheck -Name 'gate_map_enabled_log_verifier_non_claim' -Text $gateMap -Needle 'They do not close gameplay gates; `O33` is closed only as loader-registration proof by the current beta.91 AdditiveBatch1 packet'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o22_ritsulib_requirement' -Text $gateLedgerCheckerScript -Needle "GateId = 'O22'; Field = 'requirement'; Needle = 'STS2-RitsuLib v0.4.28 with lib/0.107.1 installed'"
Add-ContainsCheck -Name 'gate_ledger_checker_o23_off_log_path_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O23'; Field = 'evidence'; Needle = '.tools/runtime-evidence/v01070-beta87-additive-batch1-direct-20260618-152531/godot.log.after-launch'"
Add-ContainsCheck -Name 'gate_ledger_checker_o24_preserve_default_off_action' -Text $gateLedgerCheckerScript -Needle "GateId = 'O24'; Field = 'next_action'; Needle = 'Preserve as AdditiveBatch1 loader proof only'"
Add-ContainsCheck -Name 'gate_ledger_checker_o24_packet_report_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O24'; Field = 'evidence'; Needle = 'runtime-evidence-packet-check.json checks=52 mismatches=0'"
...
Add-ContainsCheck -Name 'gate_ledger_checker_o67_status_board_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O67'; Field = 'evidence'; Needle = 'status-board records beta.87 AdditiveBatch1 proof plus beta.85 Off/CanaryOnly previous-package context'"
...
Add-ContainsCheck -Name 'gate_ledger_o33_blocked' -Text $gateLedger -Needle 'O33,O30-O41,Current v0.107 AdditiveBatch1 enabled-mode smoke exact 10 types / 14 calls,current-pass'
...
Add-ContainsCheck -Name 'current_validation_historical_target_fix_old_shape_nonclaim' -Text $currentValidation -Needle 'Historical Off mode proved 0 StS1 registration lines; historical CanaryOnly proved exactly 4 canary content registrations for that source/runtime state. Current beta.85 keeps default-Off and CanaryOnly `v0.107.0` loader proof clean; current AdditiveBatch1 enabled-mode proof'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pass for beta.91 loader/registration; gameplay evidence pending'
...
Add-ContainsCheck -Name 'platform_testing_current_beta85_zip' -Text $platformTesting -Needle 'publish/SpirePlus-v0.1.0-private-beta.91.zip'
...
Add-AutoSlayProofCommandSwitchValuesCheck -Name 'autoslay_packet_proof_commands_pin_current_target_values' -Paths $autoSlayProofCommandFiles -SwitchValues @{
    ...
    ExpectedRitsuLibVersion = '0.4.28'
