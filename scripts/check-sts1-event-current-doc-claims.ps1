...
Add-ContainsCheck -Name 'runtime_checklist_beta96_target' -Text $runtimeChecklist -Needle 'Spire Plus `v0.1.0-private-beta.96`'
...
Add-ContainsCheck -Name 'runtime_checklist_beta96_loader_pending' -Text $runtimeChecklist -Needle '[PENDING beta.96 recapture]'
...
Add-ContainsCheck -Name 'runtime_exit_status_beta96_pending' -Text $runtimeChecklist -Needle 'Current exit status: beta.96 package parity and clicked RitsuLib Mod Settings'
...
Add-ContainsCheck -Name 'runtime_checklist_after_pause_controlled_lane' -Text $runtimeChecklist -Needle 'Earlier beta.93 Off/AdditiveBatch1 packets remain older package'
