...
Add-ContainsCheck -Name 'current_validation_latest_addendum_date' -Text $currentValidation -Needle 'Date: 2026-06-11; latest addendum: 2026-06-22'
Add-ContainsCheck -Name 'current_validation_20260622_ritsu_latest' -Text $currentValidation -Needle 'NuGet flat-container `https://api.nuget.org/v3-flatcontainer/sts2.ritsulib/index.json` still reports `0.4.33` as the latest `STS2.RitsuLib` package across 163 listed versions.'
