...
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_959' -Text $goalEventDoc -Needle 'current-doc-claims: 959 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_959' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*959 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'gate_map_v20_subagent_alignment_20260617' -Text $gateMap -Needle 'Later active summary cleanup after `eaaeb5a1` updated current-doc summary counts to 959 / 0 in `PROJECT_STATE.md`, `docs/goals/event.md`, `docs/reviews/current-validation.md`, the status board, this gate map, and the current-doc guard; older 956 / 0 rows remain historical.'
