...
Add-ContainsCheck -Name 'project_state_current_off_non_claim' -Text $projectState -Needle 'Do not claim live-ready or release-ready because gameplay, clicked Ancient UI, save-load, co-op, beta.99 loader/settings proof, current beta.99 enabled-mode registration/gameplay proof, independent QA rerun, and tester-package handoff decisions remain pending.'
...
Add-ContainsCheck -Name 'root_readme_manual_rows_pending' -Text $rootReadme -Needle 'Manual feature verification, gameplay, clicked UI, save-load, preview-tools, Vakuu, beta.99 loader/settings proof, current enabled-mode registration/gameplay, co-op, independent QA rerun, and versioned tester-package handoff are still pending.'
...
Add-ContainsCheck -Name 'goal_event_beta96_current_loader_boundary' -Text $goalEventDoc -Needle 'As of 2026-06-21, current package truth is beta.99 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.32`. Beta.99 Off loader and clicked settings UI proof remain pending after the RitsuLib settings-page I18N resource migration.'
...
Add-ContainsCheck -Name 'toreview_sts1_enabled_smokes_current_split' -Text $toReview -Needle 'beta.99 build, publish/package refresh, installed-package parity, and source-workspace check are the current package target.'
...
Add-ContainsCheck -Name 'next_overnight_beta94_totals' -Text $nextOvernight -Needle 'Latest beta.99 no-game/package validation is summarized in `PROJECT_STATE.md` and `docs/reviews/current-validation.md`: build/publish/package refresh, installed-package parity, runtime preflight, and source-workspace checks passed for the current dependency target; beta.99 loader/settings proof remains pending after the RitsuLib I18N settings resource migration.'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pending for beta.99; gameplay evidence pending'
