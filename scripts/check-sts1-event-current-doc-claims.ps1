...
Add-ContainsCheck -Name 'hard_stop_v20_current_head_b0f6d1fa' -Text $hardStopV20 -Needle '| Current HEAD observed in this thread | `b0f6d1fa (HEAD -> main, origin/main, origin/HEAD) Split Ancient interaction text guards` |'
