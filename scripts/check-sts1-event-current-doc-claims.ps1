...
Add-ContainsCheck -Name 'beta_compat_beta96_target' -Text $betaCompatibility -Needle 'Spire Plus `v0.1.0-private-beta.96`'
...
Add-ContainsCheck -Name 'docs_readme_sts1_beta96_settings_boundary' -Text $docsReadme -Needle 'beta.96 settings-page proof covers RitsuLib UI visibility only'
