...
Add-ContainsCheck -Name 'status_board_format_paused_boundary' -Text $statusBoard -Needle '| Format | previous pass / current rerun pending | `PROJECT_STATE.md` records format results per validation lane. Current format revalidation should rerun after the beta.86 doc/guard edits. |'
...
Add-ContainsCheck -Name 'v20_overlay_o81_pause_boundary' -Text $v20FinalGateOverlay -Needle 'O81,O76-O84,no unsupported commit/push,current-pending,Coordination pause forbids commit/push from this thread and current worktree is dirty'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o0_beta85_dirty_worktree_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O0'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.86 package/runtime baseline; current dirty worktree exists'"
