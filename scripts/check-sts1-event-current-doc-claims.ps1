...
Add-ContainsCheck -Name 'patch_boundaries_sts1_revision_n_boundary' -Text $patchBoundaries -Needle '2026-06-20 Revision P StS1Events Boundary'
...
Add-ContainsCheck -Name 'beta_compat_revision_m_boundary' -Text $betaCompatibility -Needle '2026-06-20 Current Compatibility Boundary'
...
Add-ContainsCheck -Name 'remote_setup_current_boundary' -Text $remoteDevelopmentSetup -Needle '2026-06-20 Current Boundary'
...
Add-ContainsCheck -Name 'source_api_drift_audit_current_boundary' -Text $sourceApiDriftAudit -Needle '2026-06-20 Current Boundary'
...
Add-ContainsCheck -Name 'goal_event_latest_beta92_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.92 governance checkpoint after the gate-ledger/current-doc cleanup: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 1324 checks / 0 mismatches'
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_1324' -Text $goalEventDoc -Needle 'current-doc-claims: 1324 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_1324' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*1324 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'current_validation_latest_addendum_date' -Text $currentValidation -Needle 'Date: 2026-06-11; latest addendum: 2026-06-20'
