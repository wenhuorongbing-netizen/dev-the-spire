...
Add-ContainsCheck -Name 'agents_current_beta86_additive_path' -Text $agents -Needle 'current beta.86 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`'
Add-ContainsCheck -Name 'agents_current_off_not_live_ready' -Text $agents -Needle 'Do not claim live-ready or release-ready because event encounter screenshots, save-load, image rendering, replacement functional proof, multiplayer fail-closed, independent QA rerun, and versioned tester-package handoff remain pending; the beta.86 migration validation was committed and pushed at `eaaeb5a1`, but future handoff must recapture HEAD and worktree status.'
...
Add-ContainsCheck -Name 'project_state_sts1_enabled_modes_boundary' -Text $projectState -Needle 'Current `v0.107.0` beta.86 AdditiveBatch1 loader proof is clean; current beta.86 direct loader proof is also clean for Off and CanaryOnly.'
...
Add-ContainsCheck -Name 'root_readme_beta86_additive_path' -Text $rootReadme -Needle '.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/'
...
Add-ContainsCheck -Name 'root_readme_sts1_enabled_smokes_current_split' -Text $rootReadme -Needle 'fresh beta.86 AdditiveBatch1 direct smoke under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` reached main menu'
...
Add-ContainsCheck -Name 'patch_boundaries_sts1_revision_m_boundary' -Text $patchBoundaries -Needle '2026-06-18 Revision M StS1Events Boundary'
...
Add-ContainsCheck -Name 'patch_boundaries_sts1_beta86_additive_nonclaim' -Text $patchBoundaries -Needle 'beta.85 proves current `v0.107.0` default-Off and CanaryOnly loader behavior, beta.86 proves current `v0.107.0` AdditiveBatch1 loader/registration behavior, and gameplay, save-load, replacement, multiplayer, QA, handoff, and release-ready proof remain pending.'
...
Add-ContainsCheck -Name 'beta_compat_revision_m_boundary' -Text $betaCompatibility -Needle '2026-06-18 Revision M Current Compatibility Boundary'
...
Add-ContainsCheck -Name 'remote_setup_revision_m_boundary' -Text $remoteDevelopmentSetup -Needle '2026-06-18 Revision M Current Boundary'
...
Add-ContainsCheck -Name 'docs_readme_sts1_default_off_canary_only' -Text $docsReadme -Needle 'beta.86 direct AdditiveBatch1 proof covers loader/registration only'
Add-ContainsCheck -Name 'docs_readme_sts1_additive_pending_counts' -Text $docsReadme -Needle 'beta.86 direct AdditiveBatch1 proof covers loader/registration only with 10 event types / 14 registration calls, while gameplay, save-load, replacement, multiplayer, QA, and handoff proof remain unproven'
Add-ContainsCheck -Name 'root_test_plan_beta85_off_path' -Text $rootTestPlan -Needle '.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254'
...
Add-ContainsCheck -Name 'root_test_plan_off_canary_loader_only' -Text $rootTestPlan -Needle 'The beta.85 Off/CanaryOnly smokes remain previous-package context, and the beta.85 AdditiveBatch1 13/14 mismatch remains root-cause history only.'
Add-ContainsCheck -Name 'root_test_plan_additive_still_requires_clean_packet' -Text $rootTestPlan -Needle 'Installed beta.86 package parity is restored, and current beta.86 `v0.107.0` direct AdditiveBatch1 proof under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` reached main menu'
Add-ContainsCheck -Name 'migration_doc_current_off_canary_loader_only' -Text $migrationDoc -Needle 'Current runtime dependency drift is resolved for loader and AdditiveBatch1 registration proof'
...
Add-ContainsCheck -Name 'goal_migration_beta86_current_override' -Text $goalMigrationDoc -Needle 'Current beta.85 Off and CanaryOnly loader proof exists, and current beta.86 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`.'
Add-ContainsCheck -Name 'goal_debug_beta85_off_loader_nonclaim' -Text $goalDebugDoc -Needle 'loader proof'
Add-ContainsCheck -Name 'goal_debug_beta86_current_override' -Text $goalDebugDoc -Needle 'Current beta.85 Off and CanaryOnly loader proof exists, and current beta.86 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`.'
...
Add-ContainsCheck -Name 'goal_refactor_beta86_current_override' -Text $goalRefactorDoc -Needle 'Current beta.85 Off and CanaryOnly loader proof exists, and current beta.86 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`.'
...
Add-ContainsCheck -Name 'goal_event_priority_canary_current_4_6' -Text $goalEventDoc -Needle 'preserve current beta.85 CanaryOnly loader proof'
...
Add-ContainsCheck -Name 'goal_event_latest_pause_safe_static_checkpoint_20260618_autoslay' -Text $goalEventDoc -Needle 'Latest pause-safe static checkpoint after the runtime-monkey AutoSlay boundary/source-contract and packet-verifier pass: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 992 checks / 0 mismatches after the v20 subagent coverage'
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_992' -Text $goalEventDoc -Needle 'current-doc-claims: 992 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_992' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*992 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'goal_event_off_canary_loader_nonextension_boundary' -Text $goalEventDoc -Needle 'Beta.85 Off, beta.85 CanaryOnly, and beta.86 AdditiveBatch1 loader proof must not be extended to:'
...
Add-ContainsCheck -Name 'test_ready_goal_sts1_enabled_smokes_boundary' -Text $testReadyGoal -Needle 'The beta.85 Off and CanaryOnly `v0.107.0` packets remain previous-package loader context.'
...
Add-ContainsCheck -Name 'test_ready_goal_beta86_preflight_drift' -Text $testReadyGoal -Needle 'The current retained package/runtime evidence target is `publish/SpirePlus-v0.1.0-private-beta.86.zip`; build, publish, package refresh, installed-package check, runtime preflight, and direct AdditiveBatch1 loader proof have run'
Add-ContainsCheck -Name 'dev_environment_sts1_enabled_smokes_current_split' -Text $devEnvironment -Needle 'Current beta.86 `v0.107.0` proof now covers Off with 0 StS1 registrations, CanaryOnly with 4 event types / 6 registration calls, and AdditiveBatch1 with 10 event types / 14 registration calls and exact tuple parity.'
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_boundary' -Text $rootIssues -Needle 'Fresh beta.86 direct proof: Off, CanaryOnly, and AdditiveBatch1 reached main menu, audited clean, and passed retained mode/packet verifiers with 0 mismatches'
...
Add-ContainsCheck -Name 'toreview_sts1_enabled_smokes_current_split' -Text $toReview -Needle 'The beta.86 AdditiveBatch1 proof is `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` with retained verifier proof for 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'legacy_v5_monthly_spec_beta86_additive_nonclaim' -Text $legacyV5MonthlySpec -Needle 'beta.85 proves current `v0.107.0` default-Off and CanaryOnly loader behavior, beta.86 proves current `v0.107.0` AdditiveBatch1 loader/registration behavior, and gameplay, save-load, replacement, multiplayer, QA, handoff, and release-ready proof remain pending or blocked.'
...
Add-ContainsCheck -Name 'ritsu_integration_beta86_additive_nonclaim' -Text $ritsuIntegrationDoc -Needle 'Current beta.86 proof now includes `.tools/runtime-evidence/v01070-beta86-off-direct-20260618-115305/` (Off, 0 StS1 registrations), `.tools/runtime-evidence/v01070-beta86-canary-direct-cleanlog-20260618-115723/`'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_current_note' -Text $ritsuRuntimeHardBlock -Needle '2026-06-18 current note: this report is historical `v0.106.1` loader-gate evidence.'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_current_enabled_pending' -Text $ritsuRuntimeHardBlock -Needle 'Gameplay, save-load, replacement, multiplayer, QA, and release-ready proof remain pending or blocked.'
...
Add-ContainsCheck -Name 'm5_runtime_drift_beta86_additive_path' -Text $m5RevisionMRuntimeDriftReport -Needle 'Current beta.86 AdditiveBatch1 proof is `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`'
Add-ContainsCheck -Name 'm5_runtime_drift_enabled_modes_pending' -Text $m5RevisionMRuntimeDriftReport -Needle 'Fresh beta.86 default-Off and CanaryOnly smokes are not recorded; retained beta.85 Off/CanaryOnly evidence is previous-package loader context.'
...
Add-ContainsCheck -Name 'm5_patch_failure_current_package_proof' -Text $m5RevisionMPatchFailureLedger -Needle '.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/godot.log.after-launch` is the current package proof'
...
Add-ContainsCheck -Name 'scripts_readme_autoslay_packet_requires_ordered_dual_log_event_sequence' -Text $scriptsReadme -Needle 'ordered event-room traversal markers such as `Entering Event room` plus `Selecting event option:` in both the sidecar and current-iteration logs'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_requires_event_markers' -Text $runtimeMonkeyDocs -Needle 'event-room traversal markers such as `Entering Event room` and'
...
Add-ContainsCheck -Name 'runtime_exit_status_off_canary_batch1_blocked' -Text $runtimeChecklist -Needle 'Current exit status: current beta.86 AdditiveBatch1 loader row passes for `v0.107.0`; beta.85 Off and CanaryOnly loader rows remain previous-package context.'
...
Add-ContainsCheck -Name 'next_overnight_beta86_totals' -Text $nextOvernight -Needle 'split no-build lanes covered 489 passed / 0 failed / 39 skipped / 528 total'
Add-ContainsCheck -Name 'next_overnight_head_validation_pause' -Text $nextOvernight -Needle 'Current HEAD validation refreshed after the beta.86 post-doc/test reconciliation and any later follow-up scope, or any remaining dirty follow-up scope explicitly recorded as stale under the validation coordination pause.'
...
Add-ContainsCheck -Name 'next_overnight_enabled_smoke_boundary' -Text $nextOvernight -Needle 'Current CanaryOnly enabled-mode proof is clean under `.tools/runtime-evidence/v01070-beta85-canary-20260617-233621/`: 4 event types / 6 registration lines'
Add-ContainsCheck -Name 'next_overnight_canary_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any StS1 canary gameplay claim, cite the fresh current CanaryOnly packet at `.tools/runtime-evidence/v01070-beta85-canary-20260617-233621/`.'
Add-ContainsCheck -Name 'next_overnight_batch1_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any AdditiveBatch1 gameplay claim, cite the current beta.86 loader/registration packet at `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` and recapture it if package/source shape changes.'
Add-ContainsCheck -Name 'next_overnight_current_canary_success_closed' -Text $nextOvernight -Needle '- [x] Current `v0.107.0` beta.85 CanaryOnly smoke proves 4 event types / 6 registration calls with retained verifier reports.'
Add-ContainsCheck -Name 'next_overnight_current_batch1_success_closed' -Text $nextOvernight -Needle '- [x] Current `v0.107.0` beta.86 AdditiveBatch1 smoke proves 10 event types / 14 registration calls with retained verifier reports; beta.85 13/14 attempt remains root-cause history only.'
Add-ContainsCheck -Name 'ritsu_monthly_enabled_smokes_boundary' -Text $ritsuMonthlyDevSpec -Needle 'Current CanaryOnly enabled-mode smoke is clean under `.tools/runtime-evidence/v01070-beta85-canary-20260617-233621/`, with 4 event types / 6 registration calls and retained verifier reports.'
Add-ContainsCheck -Name 'ritsu_monthly_handoff_status_recap' -Text $ritsuMonthlyDevSpec -Needle 'the beta.86 migration validation was pushed at `eaaeb5a1`, but handoff must recapture HEAD and worktree status after any later edits.'
...
Add-ContainsCheck -Name 'ritsu_monthly_batch1_smoke_before_gameplay' -Text $ritsuMonthlyDevSpec -Needle 'Use the current AdditiveBatch1 enabled-mode smoke at `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` as the beta.86 / `v0.107.0` 10 event types / 14 registration-call proof; recapture it after any package/source change before using it for a new claim.'
...
Add-ContainsCheck -Name 'ritsu_batch4c_enabled_smokes_boundary' -Text $ritsuBatch4cCandidates -Needle 'Current beta.86 AdditiveBatch1 enabled-mode smoke exists at `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/`; retained log and packet verifiers passed with 10 event types / 14 registration lines and exact tuple parity.'
...
Add-ContainsCheck -Name 'sts1_goal_revision_m_boundary' -Text $sts1FeatureGoal -Needle 'Current Boundary (Revision M / beta.86)'
Add-ContainsCheck -Name 'sts1_goal_not_complete' -Text $sts1FeatureGoal -Needle 'This goal is not complete.'
Add-ContainsCheck -Name 'sts1_goal_default_off_canary_additive_boundary' -Text $sts1FeatureGoal -Needle 'Current beta.85 `v0.107.0` proof covers default-Off loader startup/patch application and CanaryOnly enabled-mode loader registration; current beta.86 proof under `.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/` covers AdditiveBatch1 loader/registration shape with 10 event types / 14 registration calls.'
...
Add-ContainsCheck -Name 'implementation_plan_revision_m_boundary' -Text $implementationPlan -Needle 'Current boundary, Revision M / beta.86'
...
Add-ContainsCheck -Name 'implementation_plan_current_counts' -Text $implementationPlan -Needle 'beta.85 CanaryOnly 4 event types / 6 registration calls, and beta.86 AdditiveBatch1 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'status_board_current_enabled_boundary' -Text $statusBoard -Needle 'Current beta.86 has clean `v0.107.0` AdditiveBatch1 direct loader proof with 10 event types / 14 registration calls and exact tuple parity.'
...
Add-RegexCheck -Name 'status_board_batch1_current_pass' -Text $statusBoard -Pattern 'AdditiveBatch1 runtime launch.*current pass'
...
Add-ContainsCheck -Name 'status_board_date_v20_static_alignment_20260617' -Text $statusBoard -Needle '> Last updated: 2026-06-18 (current beta.86 AdditiveBatch1 verifier packet captured and passed; latest CanaryOnly-mode packet remains beta.85 previous-package context; no gameplay or release-status change)'
...
Add-ContainsCheck -Name 'status_board_pause_safe_static_v20_autoslay_992' -Text $statusBoard -Needle 'the runtime-monkey AutoSlay boundary/source-contract and packet-verifier follow-up later raised the active current-doc guard to 992 / 0 and static-file hygiene to 12 / 0 while preserving the same static-only boundary'
...
Add-ContainsCheck -Name 'status_board_format_paused_boundary' -Text $statusBoard -Needle '| Format | beta.86 post-doc format passed | `PROJECT_STATE.md` and `docs/dev-environment.md` record format/diff-check/patch-inventory/batch-classifier checks passing after the final beta.86 doc/website recap edits. This remains no-game validation and should be recaptured after future code, resource, package, or handoff changes. |'
...
Add-ContainsCheck -Name 'status_board_o15_source_identity_static' -Text $statusBoard -Needle '| AdditiveBatch1 source identity (O15) | **static-pass / current runtime pass** |'
...
Add-ContainsCheck -Name 'test_plan_manual_smoke_runtime_preflight_prereq' -Text $testPlan -Needle 'Run `.\scripts\check-sts1-runtime-preflight.ps1 -FailOnMismatch` and stop before launching if the installed game, RitsuLib, repo/installed Spire Plus package manifests, or source-only expected shapes do not match the retained beta.85 evidence target or a newly documented post-pause package target.'
...
Add-ContainsCheck -Name 'test_plan_manual_smoke_batch1_10_14' -Text $testPlan -Needle 'Use `.tools\runtime-evidence\v01070-beta86-additive-batch1-direct-20260618-031254` as the fresh current `v0.107.0` AdditiveBatch1 smoke: 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'gate_map_o0_o76_scope' -Text $gateMap -Needle 'Scope: `docs/goals/event.md` Mandatory Overnight Run v19/v21 carry-forward, current `v0.107.0` / beta.86 truth.'
...
Add-ContainsCheck -Name 'gate_map_o21_o24_off_pass' -Text $gateMap -Needle '| `O21-O24` | current beta.86 AdditiveBatch1 loader pass |'
...
Add-ContainsCheck -Name 'gate_map_enabled_log_verifier_non_claim' -Text $gateMap -Needle 'They do not close gameplay gates; `O33` is closed only as loader-registration proof by the retained beta.86 AdditiveBatch1 packet'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o23_off_log_path_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O23'; Field = 'evidence'; Needle = '.tools/runtime-evidence/v01070-beta86-additive-batch1-direct-20260618-031254/godot.log.after-launch'"
...
Add-ContainsCheck -Name 'gate_ledger_checker_o24_packet_report_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O24'; Field = 'evidence'; Needle = 'runtime-evidence-packet-check.json checks=45 mismatches=0'"
...
Add-ContainsCheck -Name 'gate_ledger_checker_o67_status_board_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O67'; Field = 'evidence'; Needle = 'status-board records beta.86 AdditiveBatch1 proof plus beta.85 Off/CanaryOnly previous-package context'"
...
Add-ContainsCheck -Name 'gate_ledger_package_sha' -Text $gateLedger -Needle 'ZIP SHA 3EDA50CCF8E2ECD49DCF1F6B4CEE7B7E3DE604793E8059253179914834781FFE'
...
Add-ContainsCheck -Name 'current_validation_downstream_remains_pending_or_blocked' -Text $currentValidation -Needle 'This addendum closes only beta.86 package/source-shape loader registration proof for AdditiveBatch1.'
...
Add-ContainsCheck -Name 'current_validation_latest_addendum_date' -Text $currentValidation -Needle 'Date: 2026-06-11; latest addendum: 2026-06-18'
...
Add-ContainsCheck -Name 'hard_stop_v20_blocked_o25_o33' -Text $hardStopV20 -Needle '`O25`: current `v0.107.0` CanaryOnly enabled-mode smoke has since been captured by the shared validation lane and is loader proof only; this thread did not create it.'
...
Add-ContainsCheck -Name 'handoff_sts1_enabled_smokes_current_split' -Text $privateBetaHandoff -Needle 'Current AdditiveBatch1 enabled-mode proof remains loader evidence only and does not prove gameplay.'
...
Add-ContainsCheck -Name 'release_evidence_status_beta85_off_nonclaim' -Text $releaseEvidenceStatus -Needle 'the current beta.86 `v0.107.0` AdditiveBatch1 direct loader smoke audited clean for loader/registration proof, while Mod Settings page refresh, gameplay, clicked UI, save-load, preview-tools, Vakuu, co-op, and full release-evidence packaging rows remain pending.'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pass for beta.86 AdditiveBatch1 loader registration only; gameplay rows pending'
...
Add-ContainsCheck -Name 'platform_testing_current_beta85_zip' -Text $platformTesting -Needle 'publish/SpirePlus-v0.1.0-private-beta.86.zip'
