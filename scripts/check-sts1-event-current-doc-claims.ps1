...
Add-ContainsCheck -Name 'v20_overlay_o81_pause_boundary' -Text $v20FinalGateOverlay -Needle 'O81,O76-O84,no unsupported commit/push,current-pending,Coordination pause forbids commit/push from this thread; package/runtime baseline remains eaaeb5a1 and latest pushed governance/test follow-up is f686e2f6'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o0_beta86_baseline_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O0'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.86 package/runtime baseline at eaaeb5a1 and newer pushed governance/test follow-up through f686e2f6'"
