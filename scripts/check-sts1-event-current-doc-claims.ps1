...
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_956' -Text $goalEventDoc -Needle 'current-doc-claims: 956 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_956' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*956 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'next_overnight_head_validation_pause' -Text $nextOvernight -Needle 'Current HEAD validation refreshed after the beta.86 post-doc/test reconciliation, or any later dirty follow-up scope explicitly recorded as stale under the validation coordination pause.'
...
Add-ContainsCheck -Name 'next_overnight_post_baseline_scope' -Text $nextOvernight -Needle 'Any dirty files after `eaaeb5a1` are post-baseline follow-up scope. Classify them before any validation claim, package handoff, commit, or push.'
...
Add-ContainsCheck -Name 'status_board_pause_safe_static_v20_alignment_20260617' -Text $statusBoard -Needle '| **v20 2026-06-17/18 pause-safe static alignment** | `PROJECT_STATE.md`, `docs/goals/event.md`, `docs/reviews/current-validation.md`, `docs/features/sts1-events/test-plan.md`, `docs/features/sts1-events/v19-gate-evidence-map.md`, `docs/features/sts1-events/v20-final-gate-overlay.csv`, and `docs/features/sts1-events/hard-stop-blocker-report-v20-coordination-pause-20260617.md` record static suite 15 / 0, beta.86 runtime preflight 27 / 0, current-doc claims 956 / 0, static-file hygiene 11 / 0, v19 gate ledger 534 / 0, v20 final-gate overlay 29 / 0, subagent coverage 70 / 0'
...
Add-ContainsCheck -Name 'gate_map_v20_subagent_alignment_20260617' -Text $gateMap -Needle 'The retained static-only rerun returned static suite 15 / 0, beta.86 runtime preflight 27 / 0 after package/source alignment, current-doc claims 956 / 0, static-file hygiene 11 / 0, v19 gate ledger 534 / 0, v20 final-gate overlay 29 / 0, subagent coverage 70 / 0'
...
Add-ContainsCheck -Name 'v20_overlay_o81_pause_boundary' -Text $v20FinalGateOverlay -Needle 'O81,O76-O84,no unsupported commit/push,current-pending,Coordination pause forbids commit/push from this thread; latest pushed baseline is eaaeb5a1'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o0_beta86_baseline_evidence' -Text $gateLedgerCheckerScript -Needle "GateId = 'O0'; Field = 'evidence'; Needle = 'PROJECT_STATE.md records beta.86 package/runtime baseline at eaaeb5a1'"
