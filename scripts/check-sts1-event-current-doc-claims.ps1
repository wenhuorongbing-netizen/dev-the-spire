...
Add-ContainsCheck -Name 'private_beta_handoff_current_beta96_date_boundary' -Text $privateBetaHandoff -Needle 'Date: 2026-06-21 beta.98 handoff summary; older May notes below are retained only as historical context.'
...
Add-ContainsCheck -Name 'project_state_current_off_non_claim' -Text $projectState -Needle 'Do not claim live-ready or release-ready because gameplay, clicked Ancient UI, save-load, co-op, beta.98 loader/settings proof, current beta.98 enabled-mode registration/gameplay proof, independent QA rerun, and tester-package handoff decisions remain pending.'
...
Add-ContainsCheck -Name 'root_readme_manual_rows_pending' -Text $rootReadme -Needle 'Manual feature verification, gameplay, clicked UI, save-load, preview-tools, Vakuu, beta.98 loader/settings proof, current enabled-mode registration/gameplay, co-op, independent QA rerun, and versioned tester-package handoff are still pending.'
...
Add-ContainsCheck -Name 'restructure_doc_current_ritsulib_only_target' -Text $restructureDoc -Needle 'Current package/runtime target is Spire Plus `v0.1.0-private-beta.98` on Slay'
...
Add-ContainsCheck -Name 'beta_compat_beta96_target' -Text $betaCompatibility -Needle 'Spire Plus `v0.1.0-private-beta.98`'
...
Add-ContainsCheck -Name 'root_test_plan_additive_still_requires_clean_packet' -Text $rootTestPlan -Needle 'Installed beta.98 package parity is the current package evidence.'
...
Add-ContainsCheck -Name 'migration_doc_beta96_boundary' -Text $migrationDoc -Needle 'Spire Plus is on the beta.98 RitsuLib-only target:'
...
Add-ContainsCheck -Name 'goal_event_beta96_current_loader_boundary' -Text $goalEventDoc -Needle 'As of 2026-06-21, current package truth is beta.98 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.32`. Beta.98 Off loader and clicked settings UI proof remain pending after the RitsuLib settings-page I18N resource migration.'
...
Add-ContainsCheck -Name 'goal_event_latest_beta94_governance_checkpoint' -Text $goalEventDoc -Needle 'Latest beta.98 governance checkpoint after the RitsuLib settings-page I18N resource migration: static/source docs must be recaptured for the current package before any handoff.'
...
Add-ContainsCheck -Name 'goal_event_source_workspace_checkpoint_beta93' -Text $goalEventDoc -Needle 'source workspace: 57 checks / 0 mismatches against installed v0.107.1, Spire Plus v0.1.0-private-beta.98, and STS2-RitsuLib 0.4.32 direct NuGet runtime layout'
...
Add-ContainsCheck -Name 'test_ready_goal_beta94_preflight_drift' -Text $testReadyGoal -Needle 'The current retained package target is `publish/SpirePlus-v0.1.0-private-beta.98.zip`; build, publish, package refresh, installed-package check, runtime preflight, and source-workspace check have run for the settings-page I18N resource migration plus STS2-RitsuLib `v0.4.32` update.'
...
Add-ContainsCheck -Name 'toreview_sts1_enabled_smokes_current_split' -Text $toReview -Needle 'beta.98 build, publish/package refresh, installed-package parity, and source-workspace check are the current package target.'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_beta96_target' -Text $ritsuRuntimeHardBlock -Needle 'Spire Plus `v0.1.0-private-beta.98`'
...
Add-ContainsCheck -Name 'ritsu_runtime_hard_block_manual_gates_pending' -Text $ritsuRuntimeHardBlock -Needle 'current beta.98 enabled-mode'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_current_package_target' -Text $runtimeMonkeyDocs -Needle '-ExpectedPackageVersion v0.1.0-private-beta.98'
...
Add-ContainsCheck -Name 'runtime_checklist_beta96_target' -Text $runtimeChecklist -Needle 'Spire Plus `v0.1.0-private-beta.98`'
...
Add-ContainsCheck -Name 'runtime_exit_status_beta96_pending' -Text $runtimeChecklist -Needle 'Current exit status: beta.98 package parity passes; clicked RitsuLib Mod'
...
Add-ContainsCheck -Name 'next_overnight_beta94_totals' -Text $nextOvernight -Needle 'Latest beta.98 no-game/package validation is summarized in `PROJECT_STATE.md` and `docs/reviews/current-validation.md`: build/publish/package refresh, installed-package parity, runtime preflight, and source-workspace checks passed for the current dependency target; beta.98 loader/settings proof remains pending after the RitsuLib I18N settings resource migration.'
...
Add-ContainsCheck -Name 'next_overnight_head_validation_beta87' -Text $nextOvernight -Needle 'Current HEAD validation refreshed after the beta.98 RitsuLib-only settings page I18N pass; recheck again before handoff if any later edits appear.'
...
Add-ContainsCheck -Name 'next_overnight_batch1_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any AdditiveBatch1 gameplay claim, confirm the beta.98 package and STS2-RitsuLib `v0.4.32` direct NuGet runtime are installed and recapture current-package enabled-mode proof'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pending for beta.98; gameplay evidence pending'
...
Add-ContainsCheck -Name 'private_beta_release_audit_current_beta94_date_boundary' -Text $privateBetaReleaseAudit -Needle 'Original audit date: 2026-05-15; latest beta.98 RitsuLib-only package refresh: 2026-06-21; previous beta.96 Off loader proof and previous beta.93 AdditiveBatch1 evidence remain historical loader/registration proof only.'
Add-ContainsCheck -Name 'test_ready_completion_audit_current_beta94_date_boundary' -Text $testReadyCompletionAudit -Needle 'Original audit date: 2026-05-14; latest beta.98 RitsuLib-only settings-page I18N package refresh: 2026-06-21; previous beta.96 Off loader proof and previous beta.93 AdditiveBatch1 evidence remain historical loader/registration proof only.'
Add-ContainsCheck -Name 'test_ready_completion_audit_beta85_loader_nonclaim' -Text $testReadyCompletionAudit -Needle 'These hashes and earlier loader proof do not close beta.98 loader proof, live gameplay, save-load, death/failure path, or co-op verification.'
...
Add-ContainsCheck -Name 'platform_testing_current_beta85_zip' -Text $platformTesting -Needle 'publish/SpirePlus-v0.1.0-private-beta.98.zip'
