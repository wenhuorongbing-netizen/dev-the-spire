...
Add-ContainsCheck -Name 'gate_map_v20_subagent_alignment_20260617' -Text $gateMap -Needle '2026-06-17 pause-safe v20 subagent/current-claim alignment: `docs/goals/event.md`, `docs/features/sts1-events/v19-subagent-coverage.md`, `docs/features/sts1-events/status-board.md`, `docs/reviews/current-validation.md`, and the current-doc claim guard now record the v20 15-role subagent coverage shape. The static-only rerun returned static suite 14 / 0, current-doc claims 878 / 0, static-file hygiene 11 / 0, v19 gate ledger 531 / 0, subagent coverage 66 / 0'
