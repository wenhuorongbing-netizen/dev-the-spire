...
Add-ContainsCheck -Name 'patch_boundaries_sts1_registration_canary_4_6' -Text $patchBoundaries -Needle 'CanaryOnly registers 4 event types through 6 registration calls'
...
Add-ContainsCheck -Name 'goal_migration_revision_o_static_governance' -Text $goalMigrationDoc -Needle 'Revision O static-governance note, 2026-06-11: the beta.84 runtime-failure body below is preserved as historical root-cause context only.'
Add-ContainsCheck -Name 'goal_migration_beta85_off_table_pass' -Text $goalMigrationDoc -Needle '| v0.107.0 Off smoke clean            | beta.85 clean, 25/25 patches                 | PASS for default-Off loader only |'
Add-ContainsCheck -Name 'goal_migration_beta85_ectoplasm_table_pass' -Text $goalMigrationDoc -Needle '| EctoplasmGoldGatePatch runtime      | fixed for beta.85 Off loader proof           | PASS for default-Off loader only |'
Add-ContainsCheck -Name 'goal_migration_beta85_package_smoke_table_pass' -Text $goalMigrationDoc -Needle '| Current-source package built/smoked | beta.85 built/package-smoked for Off only    | PASS for default-Off loader only |'
Add-ContainsCheck -Name 'goal_migration_current_proof_pending' -Text $goalMigrationDoc -Needle 'current CanaryOnly, AdditiveBatch1, gameplay, save-load, replacement, multiplayer, QA, and release-ready proof remain pending.'
Add-ContainsCheck -Name 'goal_debug_revision_m_current_note' -Text $goalDebugDoc -Needle 'The earlier conclusion below is now historical root-cause context.'
Add-ContainsCheck -Name 'goal_debug_beta85_off_nonclaim' -Text $goalDebugDoc -Needle 'Do not extend that loader proof to live-ready or release-ready; gameplay, clicked UI, save-load, co-op, independent QA, and non-Off StS1 runtime proof remain pending.'
Add-ContainsCheck -Name 'goal_refactor_revision_m_current_note' -Text $goalRefactorDoc -Needle '2026-06-11 Revision M current override'
Add-ContainsCheck -Name 'goal_refactor_beta85_off_nonclaim' -Text $goalRefactorDoc -Needle 'Current beta.85 has clean `v0.107.0` default-Off loader proof only; current CanaryOnly, AdditiveBatch1, gameplay, save-load, replacement, multiplayer, QA, handoff, and release-ready proof remain pending.'
Add-ContainsCheck -Name 'goal_refactor_current_canary_4_6' -Text $goalRefactorDoc -Needle '4 canary event types / 6 registration calls'
...
Add-ContainsCheck -Name 'goal_refactor_direct_off_default_only' -Text $goalRefactorDoc -Needle 'beta.85 has clean v0.107.0 Off loader proof, but that proof is default-Off startup/patch-application proof only.'
Add-ContainsCheck -Name 'goal_refactor_direct_canary_current_4_6' -Text $goalRefactorDoc -Needle 'run current v0.107.0 CanaryOnly smoke and verify 4 event types / 6 registration calls.'
Add-ContainsCheck -Name 'goal_refactor_direct_batch1_current_10_14' -Text $goalRefactorDoc -Needle 'run current v0.107.0 AdditiveBatch1 smoke and verify 10 event types / 14 registration calls.'
Add-ContainsCheck -Name 'goal_refactor_direct_final_priority' -Text $goalRefactorDoc -Needle 'Current priority is preserving beta.85 default-Off proof without extending it'
...
Add-RegexCheck -Name 'goal_event_priority_canary_current_4_6' -Text $goalEventDoc -Pattern 'current `v0\.107\.0` CanaryOnly smoke.{0,40}4 event types / 6 registration calls'
Add-RegexCheck -Name 'goal_event_go_nogo_canary_current_4_6' -Text $goalEventDoc -Pattern 'Current `v0\.107\.0` CanaryOnly smoke clean.{0,40}4 event types / 6 registration calls'
Add-RegexCheck -Name 'goal_event_direct_canary_current_4_6' -Text $goalEventDoc -Pattern 'current v0\.107 CanaryOnly smoke.{0,40}4 event types / 6 registration calls'
...
Add-RegexCheck -Name 'goal_event_downstream_pause_boundary' -Text $goalEventDoc -Pattern 'runtime.{0,120}gameplay.{0,120}build/test/publish.{0,120}coordination pause'
Add-RegexCheck -Name 'goal_event_direct_instruction_after_pause' -Text $goalEventDoc -Pattern 'coordination pause.{0,40}Mandatory Overnight Run v19'
Add-ContainsCheck -Name 'goal_event_latest_pause_safe_static_checkpoint_20260615' -Text $goalEventDoc -Needle 'Latest pause-safe static checkpoint: `scripts/check-sts1-event-current-doc-claims.ps1 -FailOnMismatch` returned 872 checks / 0 mismatches after the RitsuLib monthly spec and Batch 4c proposal were directly guarded in static-file hygiene scope; `scripts/check-sts1-event-static-suite.ps1` returned 14 static steps / 0 suite failures with the known 33-key localization gap; `scripts/check-sts1-static-file-hygiene.ps1 -FailOnMismatch` returned 11 checks / 0 mismatches; `scripts/check-sts1-v19-gate-ledger.ps1 -FailOnMismatch` returned 531 checks / 0 mismatches; `scripts/check-sts1-v19-subagent-coverage.ps1 -FailOnMismatch` returned 63 checks / 0 mismatches; focused `git diff --check --` exited 0. This is static-only evidence and does not close O25, O33, gameplay, save/load, replacement, multiplayer, QA, release, or handoff gates.'
Add-ContainsCheck -Name 'goal_event_direct_localization_nonproof' -Text $goalEventDoc -Needle 'Fixing `STS1_GOLDEN_IDOL.pages.LEAVE.description` only removes the direct localization missing-key blocker; it does not close O25/O33 or replace the enabled-mode log verifier/runtime evidence packet.'
Add-Check -Name 'goal_event_no_old_exact_4_claim' -Passed (-not $goalEventDoc.Contains('exact 4')) -Detail 'active event goal must use 4 event types / 6 registration calls wording'
...
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_pending_counts' -Text $rootIssues -Needle 'Current StS1 CanaryOnly/AdditiveBatch1 proof remains pending: CanaryOnly must show 4 event types / 6 registration calls and AdditiveBatch1 must show 10 event types / 14 registration calls before gameplay or handoff claims.'
...
Add-ContainsCheck -Name 'test_plan_v19_subagent_non_claim' -Text $testPlan -Needle 'without treating read-only/static subagent work as runtime, gameplay, or QA proof'
...
Add-ContainsCheck -Name 'subagent_coverage_roles_14' -Text $subagentCoverage -Needle 'Release Documentation Subagent'
Add-ContainsCheck -Name 'subagent_coverage_date_current_static_governance' -Text $subagentCoverage -Needle 'Date: 2026-06-15 (v19 opened 2026-06-11; latest pause-safe static-governance update)'
...
Add-ContainsCheck -Name 'current_validation_latest_addendum_date' -Text $currentValidation -Needle 'Date: 2026-06-11; latest addendum: 2026-06-15'
...
Add-NoRegexCheck -Name 'no_unsuperseded_legacy_current_doc_claim_counts_in_active_summaries' -Paths @('docs\goals\event.md', 'docs\features\sts1-events\status-board.md', 'docs\reviews\current-validation.md', 'docs\features\sts1-events\v19-gate-evidence-map.md') -Pattern 'current-doc claims (692|695|698|701|703|705|708|711|715) / 0|returned (692|695|698|701|703|705|708|711|715) checks / 0 mismatches(?![^\r\n]*(later superseded|was later superseded))'
Add-NoRegexCheck -Name 'no_unsuperseded_recent_current_doc_claim_counts_in_active_summaries' -Paths @('docs\goals\event.md', 'docs\features\sts1-events\status-board.md', 'docs\reviews\current-validation.md', 'docs\features\sts1-events\v19-gate-evidence-map.md') -Pattern 'current-doc claims (744|745|746|748|749|750|751|752|753|754|756|759|761|762|763|764|768|769|775|778|783|784|787|788|790|791|792|793|798|802|803|811|812|813|814|832|836|838|848|850|856|859|863|868) / 0(?![^\r\n]*(later superseded|was later superseded))|returned (744|745|746|748|749|750|751|752|753|754|756|759|761|762|763|764|768|769|775|778|783|784|787|788|790|791|792|793|798|802|803|811|812|813|814|832|836|838|848|850|856|859|863|868) checks / 0 mismatches(?![^\r\n]*(later superseded|was later superseded))|(744|745|746|748|749|750|751|752|753|754|756|759|761|762|763|764|768|769|775|778|783|784|787|788|790|791|792|793|798|802|803|811|812|813|814|832|836|838|848|850|856|859|863|868)-check follow-up'
