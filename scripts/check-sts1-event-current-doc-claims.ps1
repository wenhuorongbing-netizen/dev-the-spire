...
Add-ContainsCheck -Name 'hard_stop_v20_current_head_7f81861e' -Text $hardStopV20 -Needle '| Current HEAD observed in this thread | `7f81861e (HEAD -> main, origin/main, origin/HEAD) Recapture v20 hard-stop baseline` |'
