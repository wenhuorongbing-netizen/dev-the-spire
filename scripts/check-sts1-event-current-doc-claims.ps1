...
Add-ContainsCheck -Name 'project_state_sts1_enabled_modes_boundary' -Text $projectState -Needle 'Current installed game is `v0.107.1`. Current beta.93 RitsuLib-only Off and AdditiveBatch1 proof is the active loader/registration evidence. Older beta.85/beta.86/beta.87/beta.88/beta.90 rows are previous-package or previous-game-version context only. Gameplay, clicked UI, save-load, replacement, multiplayer, QA, and handoff claims still need separate evidence.'
...
Add-ContainsCheck -Name 'migration_doc_current_off_canary_loader_only' -Text $migrationDoc -Needle 'The retained beta.85-beta.90 proof rows remain previous-context evidence; current `v0.107.1` beta.93 proof is clean at `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` for loader/patch application and AdditiveBatch1 registration shape.'
...
Add-ContainsCheck -Name 'goal_migration_beta85_off_loader_pass' -Text $goalMigrationDoc -Needle 'Current Off proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/`'
...
Add-ContainsCheck -Name 'goal_migration_beta87_current_override' -Text $goalMigrationDoc -Needle 'Current AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` reached main menu'
Add-ContainsCheck -Name 'goal_debug_beta85_off_loader_nonclaim' -Text $goalDebugDoc -Needle 'loader proof'
Add-ContainsCheck -Name 'goal_debug_beta87_current_override' -Text $goalDebugDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous-package context, and beta.93 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_refactor_beta87_current_override' -Text $goalRefactorDoc -Needle 'Beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, beta.88 remains previous-package context, and beta.93 is the current RitsuLib-only loader/registration proof.'
...
Add-ContainsCheck -Name 'goal_event_beta88_current_override' -Text $goalEventDoc -Needle 'current loader truth is beta.93 on Slay the Spire 2 `v0.107.1`: `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/` reached main menu with exactly STS2-RitsuLib `v0.4.31` and Spire Plus `v0.1.0-private-beta.93` loaded, only STS2-RitsuLib as the shared runtime dependency, 25/25 Spire Plus patches applied, clean audits, Off packet verifier 43 / 0, AdditiveBatch1 enabled-mode verifier 31 / 0, and AdditiveBatch1 packet verifier 61 / 0.'
...
Add-ContainsCheck -Name 'goal_event_off_canary_loader_nonextension_boundary' -Text $goalEventDoc -Needle 'Retained beta.85 Off, retained beta.85 CanaryOnly, retained beta.87 AdditiveBatch1, previous package beta.88 AdditiveBatch1, and current beta.93 AdditiveBatch1 loader proof must not be extended to:'
