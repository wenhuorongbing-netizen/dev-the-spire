...
Add-ContainsCheck -Name 'root_readme_beta88_additive_path' -Text $rootReadme -Needle '.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/'
...
Add-ContainsCheck -Name 'root_readme_sts1_enabled_smokes_current_split' -Text $rootReadme -Needle 'the current beta.88 pass upgraded BaseLib to `v3.3.0` and captured clean AdditiveBatch1 direct proof under `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/`: main menu reached, audit clean'
...
Add-ContainsCheck -Name 'patch_boundaries_sts1_revision_n_boundary' -Text $patchBoundaries -Needle '2026-06-19 Revision N StS1Events Boundary'
...
Add-ContainsCheck -Name 'patch_boundaries_sts1_beta88_additive_nonclaim' -Text $patchBoundaries -Needle 'beta.85 proves retained `v0.107.0` default-Off and CanaryOnly loader behavior, beta.87 proves retained `v0.107.0` AdditiveBatch1 loader/registration behavior, and current beta.88 proves `v0.107.1` AdditiveBatch1 loader/registration behavior with BaseLib `v3.3.0`, 25/25 patches, 10 event types / 14 calls, clean audit, retained enabled-mode verifier 31 / 0, and runtime packet verifier 0 mismatches.'
...
Add-ContainsCheck -Name 'beta_compat_revision_m_boundary' -Text $betaCompatibility -Needle '2026-06-19 Current Compatibility Boundary'
...
Add-ContainsCheck -Name 'remote_setup_current_boundary' -Text $remoteDevelopmentSetup -Needle '2026-06-19 Current Boundary'
...
Add-ContainsCheck -Name 'root_test_plan_beta88_additive_path' -Text $rootTestPlan -Needle '.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937'
...
Add-ContainsCheck -Name 'root_test_plan_additive_still_requires_clean_packet' -Text $rootTestPlan -Needle 'Installed beta.88 package parity is restored, and current beta.88 `v0.107.1` direct AdditiveBatch1 proof under `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/` reached main menu'
Add-ContainsCheck -Name 'migration_doc_current_off_canary_loader_only' -Text $migrationDoc -Needle 'The retained `v0.107.0` beta.87 package proof remains previous-game-version context for loader/patch application and AdditiveBatch1 registration shape; current `v0.107.1` beta.88 proof is clean at `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/` for loader/patch application and AdditiveBatch1 registration shape.'
...
Add-ContainsCheck -Name 'goal_refactor_beta87_current_override' -Text $goalRefactorDoc -Needle 'Current beta.85/beta.86/beta.87 loader proof remains previous-package/game-version context, and current beta.88 AdditiveBatch1 loader/registration proof exists under `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/`.'
...
Add-ContainsCheck -Name 'goal_event_validation_matrix_current_doc_claims_1133' -Text $goalEventDoc -Needle 'current-doc-claims: 1133 checks / 0 mismatches'
...
Add-RegexCheck -Name 'goal_event_lower_audit_current_doc_claims_1133' -Text $goalEventDoc -Pattern '\| Current doc claims\s+\|[^\r\n]*1133 checks / 0 mismatches'
...
Add-ContainsCheck -Name 'goal_event_off_canary_loader_nonextension_boundary' -Text $goalEventDoc -Needle 'Retained beta.85 Off, retained beta.85 CanaryOnly, retained beta.87 AdditiveBatch1, and current beta.88 AdditiveBatch1 loader proof must not be extended to:'
...
Add-ContainsCheck -Name 'test_ready_goal_sts1_enabled_smokes_boundary' -Text $testReadyGoal -Needle 'The beta.85 Off/CanaryOnly, beta.86 AdditiveBatch1, and beta.87 AdditiveBatch1 `v0.107.0` packets remain previous-package/game-version loader context.'
...
Add-ContainsCheck -Name 'test_ready_goal_beta86_preflight_drift' -Text $testReadyGoal -Needle 'The current retained package/runtime evidence target is `publish/SpirePlus-v0.1.0-private-beta.88.zip`; build, publish, package refresh, installed-package check, runtime preflight, and direct AdditiveBatch1 loader proof have run'
Add-ContainsCheck -Name 'dev_environment_sts1_enabled_smokes_current_split' -Text $devEnvironment -Needle 'retained `v0.107.0` beta.85/beta.86/beta.87 direct smokes remain previous-package/game-version loader context. The first `v0.107.1` beta.87 recapture at `.tools\runtime-evidence\v01071-beta87-additive-batch1-direct-20260619-102309` reached main menu and matched AdditiveBatch1 registration shape, but failed clean-loader proof because BaseLib `v3.2.1` logged 2 patch failures against `v0.107.1`. The beta.88 BaseLib `v3.3.0` recapture at `.tools\runtime-evidence\v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937` reached main menu'
Add-ContainsCheck -Name 'root_issues_sts1_enabled_smokes_boundary' -Text $rootIssues -Needle 'Fresh beta.88 direct proof: `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/` reached main menu, audited clean, passed retained enabled-mode verifier 31 / 0, and passed packet verification with 0 mismatches.'
...
Add-ContainsCheck -Name 'ritsu_integration_beta87_additive_nonclaim' -Text $ritsuIntegrationDoc -Needle 'Current beta.88 AdditiveBatch1 direct proof is clean for `v0.107.1` loader/registration only.'
...
Add-ContainsCheck -Name 'runtime_monkey_docs_autoslay_current_package_target' -Text $runtimeMonkeyDocs -Needle '-ExpectedPackageVersion v0.1.0-private-beta.88'
...
Add-ContainsCheck -Name 'autoslay_packet_script_expected_ancient_ids_observed_normalized' -Text (Get-Content -LiteralPath (Resolve-RepoPath 'scripts\check-spire-plus-autoslay-packet.ps1') -Raw -Encoding UTF8) -Needle '$observedAncientIdSet.Add($runAncientId.ToUpperInvariant())'
...
Add-ContainsCheck -Name 'runtime_exit_status_off_canary_batch1_blocked' -Text $runtimeChecklist -Needle 'Current exit status: beta.88 AdditiveBatch1 loader row passes for `v0.107.1` with BaseLib `v3.3.0`; beta.85 Off and CanaryOnly loader rows remain previous-package context.'
...
Add-ContainsCheck -Name 'runtime_checklist_after_pause_controlled_lane' -Text $runtimeChecklist -Needle 'the 2026-06-19 beta.88 direct packet supersedes the BaseLib `v3.2.1` clean-audit failure for current `v0.107.1` loader/registration proof only.'
...
Add-ContainsCheck -Name 'next_overnight_beta87_totals' -Text $nextOvernight -Needle 'split no-build lanes covered 139 passed / 0 failed / 15 skipped / 154 total for the migration-focused surface'
...
Add-ContainsCheck -Name 'next_overnight_batch1_smoke_step_before_gameplay' -Text $nextOvernight -Needle 'Before any AdditiveBatch1 gameplay claim, confirm the beta.88 package and BaseLib `v3.3.0` runtime are still installed and current'
...
Add-ContainsCheck -Name 'sts1_goal_compile_package_current_split' -Text $sts1FeatureGoal -Needle 'Events must compile against the current repository package references: `STS2.RitsuLib` `0.4.24` and BaseLib `3.3.0`.'
Add-ContainsCheck -Name 'sts1_goal_runtime_ritsu_variant_split' -Text $sts1FeatureGoal -Needle 'Current runtime reproof targets the installed official `STS2-RitsuLib` `v0.4.24` variant pack with `lib\0.107.0`.'
...
Add-ContainsCheck -Name 'implementation_plan_revision_n_boundary' -Text $implementationPlan -Needle 'Current boundary, Revision N / beta.88'
...
Add-ContainsCheck -Name 'implementation_plan_current_counts' -Text $implementationPlan -Needle 'current beta.88 proof under `.tools/runtime-evidence/v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937/` covers `v0.107.1` AdditiveBatch1 loader/registration only with BaseLib `v3.3.0`, 25/25 patches, clean audit, retained enabled-mode verifier 31 / 0, and runtime packet verifier 0 mismatches.'
...
Add-ContainsCheck -Name 'status_board_current_enabled_boundary' -Text $statusBoard -Needle 'Current beta.88 has clean `v0.107.1` AdditiveBatch1 direct loader/registration proof with BaseLib `v3.3.0`, 25/25 Spire Plus patches applied, 10 event types / 14 registration calls, and exact tuple parity.'
...
Add-ContainsCheck -Name 'status_board_date_v20_static_alignment_20260617' -Text $statusBoard -Needle '> Last updated: 2026-06-19 (current beta.88 `v0.107.1` AdditiveBatch1 verifier packet captured and passed for loader/registration only; latest CanaryOnly-mode packet remains beta.85 previous-package context; gameplay and release proof remain pending)'
...
Add-ContainsCheck -Name 'test_plan_manual_smoke_batch1_10_14' -Text $testPlan -Needle 'Treat `.tools\runtime-evidence\v01071-beta88-baselib330-additive-batch1-direct-cleanlog-20260619-103937` as current `v0.107.1` AdditiveBatch1 loader smoke only: 10 event types / 14 registration calls'
...
Add-ContainsCheck -Name 'gate_map_o0_o76_scope' -Text $gateMap -Needle 'Scope: `docs/goals/event.md` Mandatory Overnight Run v19/v21 carry-forward, current `v0.107.1` / beta.88 loader truth.'
...
Add-ContainsCheck -Name 'gate_map_o21_o24_off_pass' -Text $gateMap -Needle '| `O21-O24` | current beta.88 AdditiveBatch1 loader pass |'
...
Add-ContainsCheck -Name 'gate_map_enabled_log_verifier_non_claim' -Text $gateMap -Needle 'They do not close gameplay gates; `O33` is closed only as loader-registration proof by the current beta.88 AdditiveBatch1 packet'
...
Add-ContainsCheck -Name 'gate_ledger_checker_o22_ritsulib_requirement' -Text $gateLedgerCheckerScript -Needle "GateId = 'O22'; Field = 'requirement'; Needle = 'STS2-RitsuLib v0.4.24 with lib/0.107.0 installed'"
...
Add-ContainsCheck -Name 'current_validation_latest_addendum_date' -Text $currentValidation -Needle 'Date: 2026-06-11; latest addendum: 2026-06-19'
...
Add-ContainsCheck -Name 'release_evidence_status_beta85_off_nonclaim' -Text $releaseEvidenceStatus -Needle 'the current beta.88 `v0.107.1` AdditiveBatch1 direct loader smoke audited clean for loader/registration proof, while Mod Settings page refresh, gameplay, clicked UI, save-load, preview-tools, Vakuu, co-op, and full release-evidence packaging rows remain pending.'
...
Add-ContainsCheck -Name 'private_beta_release_audit_loader_only' -Text $privateBetaReleaseAudit -Needle 'Pass for beta.88 AdditiveBatch1 loader registration only; gameplay rows pending'
...
Add-ContainsCheck -Name 'platform_testing_current_beta85_zip' -Text $platformTesting -Needle 'publish/SpirePlus-v0.1.0-private-beta.88.zip'
