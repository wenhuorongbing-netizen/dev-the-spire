...
if (Test-Path -LiteralPath $pckPath) {
    ...
    $requiredPckFragments = [ordered]@{
        ...
        'Sere Talon EN effect' = '"SERE_TALON.description": "On pickup, add [blue]2[/blue] random Curses and [blue]3[/blue] Wish to your deck."'
