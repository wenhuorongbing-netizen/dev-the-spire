...
| `check-sts1-event-current-doc-claims.ps1` | Static guard for active current-facing StS1 docs, count matrix wording, beta.85 default-Off-only proof boundaries, current-pending enabled-mode rows, and references to the current static/runtime verifier scripts. |
