...
Add-ContainsCheck -Name 'coverage_additive_retained_loader_packet' -Text $coverageText -Needle 'Current beta.93 AdditiveBatch1 packet at `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`'
