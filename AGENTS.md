...
- Current dependency configurations are aligned on STS2-RitsuLib `v0.4.32` and Slay the Spire 2 `v0.107.1`. Installed beta.99 package/hash parity, runtime preflight, source-workspace validation, and beta.99 RitsuLib Mod Settings clicked UI proof are recorded on 2026-06-21; beta.99 direct Off loader proof remains pending.
  Current beta.99 RitsuLib Mod Settings clicked UI proof is captured under `.tools/runtime-evidence/mod-settings-beta99-ritsulib-click-20260621-223210/`, previous beta.96 RitsuLib-only Off proof is captured under `.tools/runtime-evidence/v01071-beta96-ritsulib0431-off-direct-20260621-185056/`, and beta.93 RitsuLib-only AdditiveBatch1 direct proof remains previous-package loader/registration evidence only.
