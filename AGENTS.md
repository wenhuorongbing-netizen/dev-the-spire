...
- Current dependency configurations are aligned on STS2-RitsuLib `v0.4.31` and Slay the Spire 2 `v0.107.1`. Installed beta.97 package/hash parity and source-workspace validation are recorded on 2026-06-21; beta.97 RitsuLib Mod Settings clicked UI proof and Off loader proof remain pending.
...
- Install STS2-RitsuLib `v0.4.31` under `<GameRoot>\mods\STS2-RitsuLib` with the `lib\0.107.1` runtime variant.
