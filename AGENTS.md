...
- Current dependency configurations are aligned on STS2-RitsuLib `v0.4.32` and Slay the Spire 2 `v0.107.1`. Installed beta.98 package/hash parity, runtime preflight, and source-workspace validation are recorded on 2026-06-21; beta.98 RitsuLib Mod Settings clicked UI proof and Off loader proof remain pending.
