...
- Current dependency configurations are aligned on STS2-RitsuLib `v0.4.34` and Slay the Spire 2 `v0.107.1`. The 2026-06-22 NuGet flat-container and `dotnet list package --outdated --include-transitive` recheck found `0.4.34` as the latest `STS2.RitsuLib` package. Installed beta.110 build/publish/package refresh is current; beta.108 clicked Ancient UI smoke remains previous-package UI proof.
