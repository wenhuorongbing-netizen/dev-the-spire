...
- Current dependency configurations are aligned on STS2-RitsuLib `v0.4.32` and Slay the Spire 2 `v0.107.1`. Installed beta.99 package/hash parity, runtime preflight, source-workspace validation, beta.99 RitsuLib Mod Settings clicked UI proof, and beta.99 direct Off loader proof are recorded on 2026-06-21.
