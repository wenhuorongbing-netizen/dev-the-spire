...
- Slay the Spire 2 public beta. Historical loader proof used `v0.106.1`; the current local install is `v0.107.1` with STS2-RitsuLib `v0.4.29` / `lib\0.107.1`. Installed beta.92 package parity plus RitsuLib-only Off and AdditiveBatch1 loader proof are current evidence; the active beta.92 migration removes BaseLib from the project and manifest, while gameplay/manual verification remains pending.
- .NET SDK 9.0.313 or compatible
- Godot .NET / Mono 4.5.1
- STS2-RitsuLib runtime `v0.4.29` or newer installed under `<GameRoot>\mods\STS2-RitsuLib`
