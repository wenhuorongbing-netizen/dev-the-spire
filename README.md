...
- The latest local implementation state targets Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.31` / `lib\0.107.1`. The active manifest is `v0.1.0-private-beta.93`; the latest RitsuLib-only migration publish/package pass refreshed the zip, installed folder, game-root zip, and hash docs. Fresh beta.93 RitsuLib-only Off and AdditiveBatch1 loader proof is clean under `.tools/runtime-evidence/v01071-beta93-ritsulib0431-off-direct-20260621/` and `.tools/runtime-evidence/v01071-beta93-ritsulib0431-additivebatch1-direct-20260621/`.
...
- Slay the Spire 2 public beta. Historical loader proof used `v0.106.1`; the current local install is `v0.107.1` with STS2-RitsuLib `v0.4.31` / `lib\0.107.1`. Installed beta.93 package parity plus RitsuLib-only Off and AdditiveBatch1 loader proof are current evidence; the active beta.93 migration removes BaseLib from the project and manifest, while gameplay/manual verification remains pending.
