...
internal sealed class HolyDazeBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：圣昏",
        "首次眩晕期间，每次受击最多受到[blue]1[/blue]点伤害。眩晕结束后，A19获得[blue]1[/blue]点[gold]力量[/gold]；[gold]A20烙印[/gold]获得[blue]2[/blue]点。",
        "首次眩晕会限制受击，并在结束后加力量。",
...
internal sealed class MartyrOathBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：殉誓",
        "亲族随从死亡时，亲族祭司获得[gold]殉誓[/gold]，最多[blue]2[/blue]枚。下一次施加负面状态时，每枚殉誓使持续时间+[blue]1[/blue]；下一次攻击时，每枚殉誓额外造成[blue]3[/blue]点伤害。[gold]A20烙印[/gold]改为每枚[blue]4[/blue]点；同一回合两名随从死亡时，祭司获得[blue]1[/blue]层[gold]人工制品[/gold]。",
        "随从死亡会强化祭司的下一次负面状态或攻击。",
        "Dedicated Ability: Martyr Oath",
        "When a Kin follower dies, Kin Priest gains [gold]Martyr Oath[/gold], up to [blue]2[/blue]. The next debuff lasts [blue]1[/blue] longer per Oath; the next attack deals [blue]3[/blue] extra damage per Oath. [gold]Branded Form[/gold] changes the attack bonus to [blue]4[/blue], and if both followers die in one turn the Priest gains [blue]1[/blue] [gold]Artifact[/gold].",
...
internal sealed class InkReturnBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：墨返",
        "[gold]滑溜[/gold]第一次被完全移除后，下个敌方回合开始时返还一部分。A19返还清除量的[blue]25%[/blue]，至少[blue]3[/blue]、最多[blue]12[/blue]层。[gold]A20烙印[/gold]返还[blue]35%[/blue]，至少[blue]5[/blue]、最多[blue]18[/blue]层。每场触发[blue]1[/blue]次。",
        "首次清除滑溜后会返还一次。",
...
internal sealed class StartledShellBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：多重护甲苏醒",
        "乐加维林族母被提前打醒时获得[blue]4[/blue]层[gold]多重护甲[/gold]，自然醒来时获得[blue]8[/blue]层。第一次[gold]摄魂[/gold]后，当前多重护甲减少一半。[gold]A20烙印[/gold]改为[blue]6[/blue]/[blue]10[/blue]层，摄魂只减少三分之一。多人模式按首领战规则缩放最终层数。",
        "醒来时获得多重护甲；第一次摄魂会削减它。",
        "Dedicated Ability: Plating Wake",
        "Lagavulin Matriarch gains [blue]4[/blue] [gold]Plating[/gold] when woken early, or [blue]8[/blue] when it wakes naturally. After the first [gold]Soul Siphon[/gold], current Plating is halved. [gold]Branded Form[/gold] changes this to [blue]6[/blue]/[blue]10[/blue] Plating and only removes one third. Multiplayer uses the boss Plating scaling.",
...
internal sealed class SoulTideBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：魂潮",
        "灵魂异鱼进入[gold]无形[/gold]时获得[blue]1[/blue]层[gold]人工制品[/gold]。玩家回合结束时，手牌中每张[gold]呼唤[/gold]使它下个敌方回合获得格挡。A19每张[blue]2[/blue]格挡，上限[blue]8/12/16[/blue]；[gold]A20烙印[/gold]每张[blue]3[/blue]格挡，上限[blue]12/16/20[/blue]。",
        "未处理的呼唤会让灵魂异鱼下回合获得格挡。",
        "Dedicated Ability: Soul Tide",
        "When Soul Fysh becomes [gold]Intangible[/gold], it gains [blue]1[/blue] [gold]Artifact[/gold]. At player turn end, each [gold]Beckon[/gold] in hand gives it Block next enemy turn. A19: [blue]2[/blue] Block each, capped at [blue]8/12/16[/blue]. [gold]Branded Form[/gold]: [blue]3[/blue] Block each, capped at [blue]12/16/20[/blue].",
...
internal sealed class BoilingCriticalBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：不可削弱",
        "瀑布巨兽进入爆发回合时，清除自身[gold]负面状态[/gold]和攻击降低。本回合爆发伤害不受[gold]虚弱[/gold]或力量降低影响，并获得足够[gold]人工制品[/gold]。受爆发影响的玩家获得[gold]易伤[/gold]：A19为[blue]1[/blue]回合，[gold]A20烙印[/gold]为[blue]2[/blue]回合。",
        "爆发不能被虚弱或降攻压低，并会施加易伤。",
        "Dedicated Ability: Unweakenable",
        "When Waterfall Giant enters its explosion turn, clear its [gold]debuffs[/gold] and attack reduction. The explosion ignores [gold]Weak[/gold] and Strength loss, and the Giant gains enough [gold]Artifact[/gold]. Players hit by the explosion gain [gold]Vulnerable[/gold]: A19 [blue]1[/blue] turn, [gold]Branded Form[/gold] [blue]2[/blue] turns.",
...
internal sealed class MisalignedShellBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：错壳校准",
        "玩家回合结束时，检查两只爪的生命百分比。若差距至少[blue]35%[/blue]，生命百分比较高的爪获得[blue]1[/blue]层校准。校准达到[blue]2[/blue]层时，该爪下一次攻击额外造成[blue]4[/blue]点伤害；每只爪每场最多触发[blue]1[/blue]次。[gold]A20烙印[/gold]改为[blue]30%[/blue]差距和[blue]5[/blue]点伤害。",
        "两只爪血线差距过大时，高血爪会校准攻击。",
        "Dedicated Ability: Claw Calibration",
        "At player turn end, compare both claws' HP percentages. If the gap is at least [blue]35%[/blue], the higher-HP claw gains [blue]1[/blue] Calibration. At [blue]2[/blue] Calibration, its next attack deals [blue]4[/blue] extra damage; each claw can trigger once per combat. [gold]Branded Form[/gold] changes this to a [blue]30%[/blue] gap and [blue]5[/blue] extra damage.",
...
internal sealed class MarginalNoteBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：旁注",
        "[gold]知识诅咒[/gold]后，每名玩家的弃牌堆加入[blue]1[/blue]张临时[gold]旁注[/gold]。打出旁注会抽[blue]1[/blue]张牌。若回合结束时旁注仍在手牌中，知识恶魔获得[gold]深思[/gold]并消耗旁注。深思会给下一次知识诅咒添加附加代价。[gold]A20烙印[/gold]使深思上限变为[blue]3[/blue]，每回合最多增加[blue]2[/blue]层。",
        "旁注不处理会让下一次知识诅咒更重。",
...
internal sealed class StruggleBaitBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：逃亡疲劳",
        "无厌沙虫获得[gold]力量[/gold]或推进[gold]沙坑[/gold]时，将[blue]1[/blue]张由首领能力生成的[gold]狂乱逃离[/gold]加入受影响玩家的弃牌堆。全队每打出第[blue]3[/blue]张这类逃离，无厌沙虫获得[gold]活力[/gold]：A19为[blue]2[/blue]点，[gold]A20烙印[/gold]为[blue]3[/blue]点。每个玩家回合最多触发[blue]1[/blue]次。",
        "打出多张首领生成的逃离会让沙虫获得活力。",
...
internal sealed class ChosenDecreeBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：御令",
        "女王施加[gold]束缚[/gold]时，其中[blue]1[/blue]张束缚牌获得[gold]御令[/gold]。打出御令牌不会触发额外惩罚。打出非御令束缚牌时，女王获得[blue]1[/blue]层[gold]威仪[/gold]；没有打出束缚牌时，女王获得[blue]1[/blue]层威仪，火炬头获得[blue]1[/blue]点[gold]力量[/gold]。威仪使下一次防御或屏障动作额外获得[blue]8[/blue]格挡。[gold]A20烙印[/gold]使威仪上限变为[blue]3[/blue]。",
        "打出正确的束缚牌可以避开御令惩罚。",
...
internal sealed class ResidualSampleBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：实验记录",
        "实验体进入新阶段时，根据上一阶段记录获得[blue]1[/blue]份残留样本：力量残留、技能适应、攻击适应、抗体样本或污染样本。[gold]A20烙印[/gold]每次获得[blue]2[/blue]份不同样本。样本会改变下一阶段的首次出牌、负面状态或洗牌结算。",
        "上一阶段的打法会留下样本影响下一阶段。",
...
internal sealed class AeonglassHourglassBossSealMarkerPower : BossSealMarkerPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "专属能力：时砂回流",
        "永世沙漏使用[gold]消退[/gold]后生成时砂。下个玩家回合中，每花费[blue]1[/blue]点能量移除[blue]1[/blue]枚。回合结束时，每剩余[blue]1[/blue]枚时砂，使下一次[gold]加大力度[/gold]额外加入[blue]1[/blue]张[gold]枯萎[/gold]。[gold]A20烙印[/gold]生成[blue]3[/blue]枚时砂；若[gold]眼部激光[/gold]开始时仍有时砂，额外命中[blue]1[/blue]次，每场最多[blue]2[/blue]次。",
        "花费能量清时砂；剩余时砂会增加枯萎。",
...
internal sealed class MartyrOathStrikePower : BossSealPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        ...
        "The next attack deals extra damage.");
...
internal sealed class KaiserCalibrationPower : BossSealPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "校准",
        "达到[blue]2[/blue]层时，下一次攻击会额外造成伤害。每只爪每场战斗最多触发[blue]1[/blue]次。",
        "正在校准下一次攻击。",
        "Calibration",
        "At [blue]2[/blue] stacks, the next attack deals extra damage. Each claw can trigger this once per combat.",
        "Calibrating the next attack.");
}
...
internal sealed class DeepThoughtPower : BossSealPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "深思",
        "下一次知识诅咒会附带额外代价。每层：崩解触发时额外造成[blue]1[/blue]点伤害；心智腐烂洗入[blue]1[/blue]张[gold]晕眩[/gold]。懒惰使本回合下一张牌费用+[blue]1[/blue]；枯竭使本回合失去[blue]1[/blue]点能量。",
        "下一次知识诅咒更重。",
        "Deep Thought",
        "The next Knowledge curse adds a side cost. Per stack: Disintegration deals +[blue]1[/blue] when it triggers; Mind Rot shuffles [blue]1[/blue] [gold]Dazed[/gold] into discard. Sloth makes your next card this turn cost +[blue]1[/blue]; Waste Away makes you lose [blue]1[/blue] [gold]Energy[/gold] this turn.",
    ...
    public override async Task AfterPowerAmountChanged(PlayerChoiceContext choiceContext, PowerModel power, decimal amount, Creature? applier, CardModel? cardSource)
    {
        ...
        {
            await PowerCmd.Apply<DeepThoughtCostTaxPower>(choiceContext, player.Creature, 1m, applier, cardSource);
        }
...
internal sealed class RoyalMajestyPower : BossSealPower
{
    ...
    public override List<(string, string)>? Localization => Loc(
        "威仪",
        "下一次防御或屏障动作每层额外获得[blue]8[/blue]点格挡。[gold]A20烙印[/gold]最多一次消耗[blue]2[/blue]层。",
        "下一次防御获得更多格挡。",
        "Majesty",
