...
internal static class UrdaBlessingIds
{
    public const string Seedbed = "urda_seedbed";
    public const string HumusPact = "urda_humus_pact";
    public const string Molting = "urda_molting";
    ...
    public const string SeedBank = "urda_seed_bank";
}
