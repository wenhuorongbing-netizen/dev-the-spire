...
{
    static string IPatchMethod.PatchId => "spire-plus-mod-info-localization";
    static bool IPatchMethod.IsCritical => false;
    static string IPatchMethod.Description => "Localize the Spire Plus mod information panel description";
