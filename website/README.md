...
```text
https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.95/SpirePlus-v0.1.0-private-beta.95.zip
```

The release-page button points to:

```text
https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.95
```
