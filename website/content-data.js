...
const cardDescOverrides = {
  ...
  EZMB_URDA_SEEDBED: "1费技能。消耗。获得8/12点格挡，设置总共2/3格苗床。打出时可先用1/2格，从抽牌堆或弃牌堆种下合格牌；剩余格数继续拦截之后进入手牌的污染。种下=本战隔离：不是消耗、打出或弃牌，也不会永久删除诅咒。根芽按已处理结算，不生成根蚀；根蚀只冻结这一场，不变好也不恶化，战后保持原等级。每种下1张，获得1张枯壳。",
...
const mechanicGlossary = [
  ...
  mechanic(
    "seedbed",
    "苗床",
    "乌尔妲的负面牌处理轴。种下=本战隔离：牌在进入手牌前被移出本场战斗；种下不是关键词消耗，也不算打出或丢弃。",
    ["苗床可以种下临时状态牌、临时诅咒牌、根芽和根蚀；也就是 Temporary Status cards, Temporary Curse cards, Blight Sprouts, and Rootblight。", "种下不是消耗诅咒。它把牌从本场战斗隔离出去，不触发打出、弃牌或消耗收益；永久诅咒不会被苗床删除。", "种下临时状态/诅咒会把它移出本战，战后消失。", "种下根芽按“已处理”结算，效果接近本场解决了它，但不算真的打出；战后不会加入根蚀 I。", "种下根蚀是冻结这一场：不净化、不降级、不移除，不会在这场战斗后恶化，战后仍保留原阶段。", "苗床强在三段收益：先给8/12点格挡，少抽1张本战污染牌，再给1张枯壳。枯壳被消耗时获得3点格挡。", "苗床总共2/3格；打出时立即种下的1/2张会占用这些格子，剩余格数继续拦截后续污染。苗床不会种下枯壳本身。"],
    ["苗床", "种下", "枯壳"],
    ...
    {
      titleEn: "Seedbed",
      descEn: "Urda's negative-card handling axis. Planting means combat-only isolation: the card is removed from this combat before it enters hand. Planting does not count as play, discard, or Exhaust.",
      bulletsEn: ["Seedbed can plant Temporary Status cards, Temporary Curse cards, Blight Sprouts, and Rootblight.", "Planting is not exhausting a Curse. It isolates the card from this combat, does not trigger play, discard, or Exhaust payoffs, and does not delete permanent Curses.", "A planted Temporary Status or Curse leaves this combat and disappears after combat.", "A planted Blight Sprout counts as handled, like solving it for this combat, but is not actually played and adds no Rootblight I after combat.", "A planted Rootblight is frozen for this combat: it does not cleanse, downgrade, remove, or worsen, and remains at the same level after combat.", "Seedbed is strong as a package: 8/12 Block now, one fewer pollution draw this combat, and 1 Withered Husk that later Exhausts for 3 Block.", "Seedbed has 2/3 total spaces. Immediate planting spends those spaces; any remaining spaces catch later pollution. Seedbed cannot plant Withered Husk itself."],
...
window.SPIRE_PLUS_DATA = {
  ...
  summary: [
    {
      ...
      copy: "先古奖励、原版遗物、高进阶路线和预览工具都放在同一个 Mod 里。页面按“触发时机、获得什么、付出什么、战后怎么结算”说明。"
    },
    {
      title: "苗床和种下",
      copy: "种下=本战隔离。牌会被移出本场战斗；种下不是关键词消耗，也不算打出或弃牌。根芽按已处理结算，不生成根蚀；根蚀冻结到战后，保持原等级。"
    },
    {
      title: "苗床强度",
      copy: "苗床先给8/12点格挡，再少抽污染牌，并把每张被种下的牌换成枯壳。枯壳被消耗时获得3点格挡，所以它不是单纯防御牌，而是防御、滤污染和后续缓冲一起结算。"
    }
  ],
  package: {
    localDownload: "../publish/SpirePlus-v0.1.0-private-beta.25.zip",
    releaseDownload:
      "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.25/SpirePlus-v0.1.0-private-beta.25.zip",
    latestReleaseApi: "https://api.github.com/repos/wenhuorongbing-netizen/dev-the-spire/releases/latest",
    releasesPage: "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.25",
    ...
    meta: [
      ["\u6587\u4ef6", "SpirePlus-v0.1.0-private-beta.25.zip"],
      ["\u7248\u672c", "v0.1.0-private-beta.25"],
      ["\u663e\u793a\u540d", "Spire Plus"],
      ["\u4f9d\u8d56", "BaseLib v3.1.4"],
      ["\u6e38\u620f\u7248\u672c", "Slay the Spire 2 v0.106.0"],
      ["\u4f53\u79ef", "18,943,553 \u5b57\u8282"],
      ["\u54c8\u5e0c", "C595FC59D8FAD3731F5A2A1791D5BBCB83E15E1C37A2DDC0C92F0DF08940CD46"]
    ]
  },
  installSteps: [
    "\u4e0b\u8f7d SpirePlus-v0.1.0-private-beta.25.zip\u3002",
  ...
  forum: {
    ...
    links: [
      ...
      ["发布页", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.25"]
    ]
  },
  updateGroups: [
    {
    ...
    },
    {
      ...
      items: [
        ...
        manual("苗床与根芽", "原版无苗床与根芽机制。", "乌尔妲与进阶14/15/18的连带机制。苗床先给8/12格挡，并设置2/3格苗床。种下是本战隔离：不是消耗、打出或弃牌，也不会永久删除诅咒。根芽像本场解决了它，战后不会变根蚀；根蚀只冻结这一场，不变好也不恶化。每次种下还给一张枯壳，之后被消耗时再换3点格挡。", ["机制"], "assets/card_portraits/rootblight_i.png", "mechanic_seedbed"),
  ...
  changeLog: [
    ...
    ["\u5f53\u524d\u5305", "SpirePlus-v0.1.0-private-beta.25.zip；游戏内显示名为 Spire Plus。"],
...
window.SPIRE_PLUS_DATA.i18n = {
  en: {
    ...
    summary: [
      {
        ...
        copy: "Ancient rewards, vanilla relic changes, higher-Ascension routes, and preview tools live in one mod. Entries explain timing, payoff, cost, and after-combat resolution."
      },
      {
        title: "Seedbed and Planting",
        copy: "Planting means combat-only isolation. It is not play, discard, or Exhaust. Blight Sprout counts as handled and adds no Rootblight; Rootblight is frozen until combat ends and keeps its level."
      },
      {
    ...
    package: {
      meta: [
        ["File", "SpirePlus-v0.1.0-private-beta.25.zip"],
        ["Version", "v0.1.0-private-beta.25"],
        ["Display name", "Spire Plus"],
        ["Dependency", "BaseLib v3.1.4"],
        ["Game version", "Slay the Spire 2 v0.106.0"],
        ["Size", "18,943,553 bytes"],
        ["Hash", "C595FC59D8FAD3731F5A2A1791D5BBCB83E15E1C37A2DDC0C92F0DF08940CD46"]
      ]
    },
    installSteps: [
      "Download SpirePlus-v0.1.0-private-beta.25.zip.",
    ...
    assetPolicy: [
      ...
      forum: {
        ...
        links: [
          ...
          ["Release Page", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.25"]
        ]
      },
    updateGroups: [
      {
    ...
    items: {
      ...
      "EZMB_URDA_SEEDBED.description": {
        desc: "1-cost Skill. Exhaust. Gain 8 Block, set up a 2-space Seedbed, and immediately plant 1 eligible draw/discard card. Later Temporary Status cards, Temporary Curse cards, Blight Sprouts, or Rootblight that enter hand are planted first; each planted card adds 1 Withered Husk. Upgraded: gain 12 Block, capacity becomes 3, and immediately plant 2 cards."
      },
      ...
      "mechanic_seedbed": {
        ...
        desc: "Urda and Ascension 14/15/18 mechanic. Seedbed gives 8/12 Block and 2/3 total spaces. Planting isolates eligible pollution from the current combat without play, discard, or Exhaust triggers. Planted Blight Sprouts count as handled; planted Rootblight is frozen for this combat only, keeps its level after combat, and does not improve or worsen."
      },
      "mechanic_firemarked": {
    ...
    changeLog: [
      ...
      ["Current package", "SpirePlus-v0.1.0-private-beta.25.zip; the in-game display name is Spire Plus."],
...
window.SPIRE_PLUS_EMBEDDED_LOC = {
  "zh": {
    "relics": {
      ...
      "EZMICROBALANCE-UrdaSeedbedOptionRelic.description": "第[blue]1[/blue]幕普通卡牌奖励可改拿[gold]苗床[/gold]：失去[blue]2[/blue]点[gold]最大生命[/gold]并加入[gold]苗床[/gold]。首个[gold]苗床[/gold]会升级。累计获得[blue]4[/blue]次后获得[blue]10[/blue]点[gold]最大生命[/gold]。[gold]苗床[/gold]是[blue]1[/blue]费防御牌：获得[blue]8[/blue]/[blue]12[/blue]点格挡，并设置总共[blue]2[/blue]/[blue]3[/blue]格苗床。打出时可先用[blue]1[/blue]/[blue]2[/blue]格，从抽牌堆或弃牌堆[gold]种下[/gold]合格牌；剩余格数会继续拦截之后进入手牌的污染。可种下：[gold]临时[/gold]状态牌、[gold]临时[/gold]诅咒牌、[gold]根芽[/gold]和[gold]根蚀[/gold]。种下是本战隔离：牌在进入手牌前被移出本场战斗；种下不是关键词消耗，也不算打出或弃牌，不会触发消耗诅咒收益，也不会永久删除诅咒。临时状态/诅咒战后消失。根芽按已处理结算，像本场解决了它，但不算真的打出，战后不会加入根蚀；根蚀只冻结这一场，不变好也不恶化，战后仍保持原等级。每成功种下[blue]1[/blue]张牌，获得[blue]1[/blue]张[gold]枯壳[/gold]；枯壳被消耗时获得[blue]3[/blue]点格挡。",
    ...
    "ancients": {
      ...
      "EZMB_URDA.pages.INITIAL.options.urda_seedbed.description": "第[blue]1[/blue]幕普通卡牌奖励可改拿[gold]苗床[/gold]：失去[blue]2[/blue]点[gold]最大生命[/gold]并加入[gold]苗床[/gold]。首个[gold]苗床[/gold]会升级。累计获得[blue]4[/blue]次后获得[blue]10[/blue]点[gold]最大生命[/gold]。[gold]苗床[/gold]是[blue]1[/blue]费防御牌：获得[blue]8[/blue]/[blue]12[/blue]点格挡，并设置总共[blue]2[/blue]/[blue]3[/blue]格苗床。打出时可先用[blue]1[/blue]/[blue]2[/blue]格，从抽牌堆或弃牌堆[gold]种下[/gold]合格牌；剩余格数会继续拦截之后进入手牌的污染。种下是本战隔离：牌在进入手牌前被移出本场战斗；种下不是关键词消耗，也不算打出或弃牌，不会触发消耗诅咒收益，也不会永久删除诅咒。[gold]临时[/gold]状态牌/诅咒牌被种下后战后消失；[gold]根芽[/gold]按已处理结算，像本场解决了它，但不算真的打出，战后不会加入[gold]根蚀 I[/gold]；[gold]根蚀[/gold]只冻结这一场，不变好也不恶化，战后仍保持原等级。每成功种下[blue]1[/blue]张牌，获得[blue]1[/blue]张[gold]枯壳[/gold]；枯壳被消耗时获得[blue]3[/blue]点格挡。",
    ...
    "cards": {
      ...
      "EZMB_URDA_SEEDBED.description": "获得{Block:diff()}点[gold]格挡[/gold]。设置[blue]{Capacity}[/blue]格[gold]苗床[/gold]。{ImmediateLine}\n之后合格牌进入手牌前，苗床会用剩余格数将其[gold]种下[/gold]。种下=本战隔离：移出这场战斗，不算打出、弃牌或关键词消耗，不会触发这些联动，也不是永久删除诅咒。每种下[blue]1[/blue]张，获得[blue]1[/blue]张[gold]枯壳[/gold]。\n可种下：[gold]临时[/gold]状态牌、[gold]临时[/gold]诅咒牌、[gold]根芽[/gold]、[gold]根蚀[/gold]。临时状态/诅咒战后消失。[gold]根芽[/gold]按已处理结算，像本场解决了它，但不算真的打出，战后不会加入根蚀。[gold]根蚀[/gold]只冻结这一场：不变好、不恶化、不分裂、不移除，战后保持原等级。",
      "EZMB_URDA_SEEDBED.upgradeLine": "\n立即从抽牌堆或弃牌堆中种下至多[blue]{ImmediatePlantCount}[/blue]张可种下的牌。",
      "EZMB_URDA_SEEDBED.selectionScreenPrompt": "选择要种下的牌。种下=本战隔离，不触发打出、弃牌或消耗。根芽按已处理，不生成根蚀；根蚀冻结到战后，保持原等级。",
  ...
  "en": {
    "relics": {
      ...
      "EZMICROBALANCE-UrdaSeedbedOptionRelic.description": "Act [blue]1[/blue] normal card rewards can be replaced by [gold]Seedbed[/gold]: lose [blue]2[/blue] [gold]Max HP[/gold] and add a [gold]Seedbed[/gold]. The first one is upgraded. Collecting [blue]4[/blue] grants [blue]10[/blue] [gold]Max HP[/gold]. [gold]Seedbed[/gold] is a [blue]1[/blue]-cost Skill: gain [blue]8[/blue]/[blue]12[/blue] Block and set up [blue]2[/blue]/[blue]3[/blue] total spaces. On play, it can spend [blue]1[/blue]/[blue]2[/blue] spaces to [gold]plant[/gold] eligible draw/discard cards immediately; remaining spaces catch later pollution before it enters hand. Eligible cards include [gold]Temporary[/gold] Status cards, [gold]Temporary[/gold] Curse cards, [gold]Blight Sprouts[/gold], and [gold]Rootblight[/gold]. Planting is combat-only isolation: the card leaves this combat before it enters hand; it is not play, discard, or the [gold]Exhaust[/gold] keyword, does not trigger Exhaust-Curse payoffs, and does not permanently delete Curses. Temporary Status/Curses disappear after combat. Sprouts count as handled for this combat and do not add [gold]Rootblight I[/gold]. Rootblight is frozen for this combat only: it does not improve, worsen, split, or clean itself, and stays the same level after combat. Each plant gives [blue]1[/blue] [gold]Withered Husk[/gold], which gains [blue]3[/blue] Block when exhausted.",
    ...
    "ancients": {
      ...
      "EZMB_URDA.pages.INITIAL.options.urda_seedbed.description": "Act [blue]1[/blue] normal card rewards can be replaced by [gold]Seedbed[/gold]: lose [blue]2[/blue] [gold]Max HP[/gold] and add a [gold]Seedbed[/gold]. The first one is upgraded. Collecting [blue]4[/blue] grants [blue]10[/blue] [gold]Max HP[/gold]. [gold]Seedbed[/gold] is a [blue]1[/blue]-cost Skill: gain [blue]8[/blue]/[blue]12[/blue] Block and set up [blue]2[/blue]/[blue]3[/blue] total spaces. On play, it can spend [blue]1[/blue]/[blue]2[/blue] spaces to [gold]plant[/gold] eligible draw/discard cards immediately; remaining spaces catch later pollution before it enters hand. Planting is combat-only isolation: the card leaves this combat before entering hand. It is not play, discard, or the [gold]Exhaust[/gold] keyword, does not trigger Exhaust-Curse payoffs, and does not permanently delete Curses. Planted [gold]Temporary[/gold] Status/Curse cards disappear after combat. Planted [gold]Blight Sprouts[/gold] count as handled for this combat and do not add [gold]Rootblight I[/gold]. Planted [gold]Rootblight[/gold] is frozen for this combat only: it does not improve, worsen, split, or clean itself, and stays the same level after combat. Each successful plant gives [blue]1[/blue] [gold]Withered Husk[/gold], which gains [blue]3[/blue] Block when exhausted.",
    ...
    "cards": {
      ...
      "EZMB_URDA_SEEDBED.description": "Gain {Block:diff()} [gold]Block[/gold]. Set up a [blue]{Capacity}[/blue]-space [gold]Seedbed[/gold].{ImmediateLine}\nLater, before eligible cards enter your hand, Seedbed spends remaining spaces to [gold]plant[/gold] them. Planting = combat-only isolation: remove that card from this combat. It is not play, discard, or the [gold]Exhaust[/gold] keyword, does not trigger those synergies, and does not permanently delete Curses. Each plant gives [blue]1[/blue] [gold]Withered Husk[/gold].\nEligible: [gold]Temporary[/gold] Status cards, [gold]Temporary[/gold] Curse cards, [gold]Blight Sprouts[/gold], and [gold]Rootblight[/gold]. Temporary Status/Curses disappear after combat. [gold]Blight Sprouts[/gold] count as handled, like solving them for this combat, but are not actually played and add no Rootblight. [gold]Rootblight[/gold] is frozen for this combat only: it does not improve, worsen, split, or remove itself, and keeps the same level after combat.",
      "EZMB_URDA_SEEDBED.upgradeLine": "\nImmediately plant up to [blue]{ImmediatePlantCount}[/blue] eligible cards from your draw or discard pile.",
      "EZMB_URDA_SEEDBED.selectionScreenPrompt": "Choose cards to plant. Planting isolates them for this combat without play, discard, or Exhaust triggers. Sprouts count as handled and add no Rootblight; Rootblight is frozen at the same level.",
