...
window.SPIRE_PLUS_DATA = {
  ...
  package: {
    localDownload: "../publish/SpirePlus-v0.1.0-private-beta.92.zip",
    releaseDownload:
      "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.92/SpirePlus-v0.1.0-private-beta.92.zip",
    latestReleaseApi: "https://api.github.com/repos/wenhuorongbing-netizen/dev-the-spire/releases/latest",
    releasesPage: "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.92",
    ...
    meta: [
      ["\u6587\u4ef6", "SpirePlus-v0.1.0-private-beta.92.zip"],
      ["\u7248\u672c", "v0.1.0-private-beta.92"],
      ["\u663e\u793a\u540d", "Spire Plus"],
      ["\u4f9d\u8d56", "STS2-RitsuLib v0.4.29"],
      ["\u6e38\u620f\u7248\u672c", "Slay the Spire 2 v0.107.1"],
      ["\u4f53\u79ef", "19,023,377 \u5b57\u8282"],
      ["\u54c8\u5e0c", "F02683DA621A1B116DD47AF13C529088433E4D6F66B0994503090EC23CEC8A57"]
    ]
  },
  installSteps: [
    "\u4e0b\u8f7d SpirePlus-v0.1.0-private-beta.92.zip\u3002",
    "下载 STS2-RitsuLib v0.4.29 或更新版本，并解压到游戏的 mods\\STS2-RitsuLib 目录。",
  ...
  requirements: [
    ...
    "STS2-RitsuLib v0.4.29；此版本按该依赖构建。",
  ...
  forum: {
    ...
    links: [
      ...
      ["发布页", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.92"]
    ]
  },
  updateGroups: [
    {
  ...
  changeLog: [
    ...
    ["\u5f53\u524d\u5305", "SpirePlus-v0.1.0-private-beta.92.zip；游戏内显示名为 Spire Plus。"],
...
window.SPIRE_PLUS_DATA.i18n = {
  zh: {
    ...
    requirements: [
      "Slay the Spire 2 public beta v0.107.1。",
      "STS2-RitsuLib v0.4.29。这个构建按该依赖版本测试。",
      "模组列表应显示 Spire Plus。",
  ...
  en: {
    ...
    package: {
      meta: [
        ["File", "SpirePlus-v0.1.0-private-beta.92.zip"],
        ["Version", "v0.1.0-private-beta.92"],
        ["Display name", "Spire Plus"],
        ["Dependency", "STS2-RitsuLib v0.4.29"],
        ["Game version", "Slay the Spire 2 v0.107.1"],
        ["Size", "19,023,377 bytes"],
        ["Hash", "F02683DA621A1B116DD47AF13C529088433E4D6F66B0994503090EC23CEC8A57"]
      ]
    },
    installSteps: [
      "Download SpirePlus-v0.1.0-private-beta.92.zip.",
      "Download STS2-RitsuLib v0.4.29 or newer and extract it to the game's mods\\STS2-RitsuLib folder.",
    ...
    requirements: [
      "Slay the Spire 2 public beta v0.107.1.",
      "STS2-RitsuLib v0.4.29. This build targets that dependency version.",
    ...
    assetPolicy: [
      ...
      forum: {
        ...
        links: [
          ...
          ["Release Page", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.92"]
        ]
      },
    updateGroups: [
      {
    ...
    changeLog: [
      ...
      ["Current package", "SpirePlus-v0.1.0-private-beta.92.zip; the in-game display name is Spire Plus."],
