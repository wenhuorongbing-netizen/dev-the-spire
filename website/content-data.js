...
window.SPIRE_PLUS_DATA = {
  ...
  package: {
    localDownload: "../publish/SpirePlus-v0.1.0-private-beta.132.zip",
    releaseDownload:
      "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.132/SpirePlus-v0.1.0-private-beta.132.zip",
    latestReleaseApi: "https://api.github.com/repos/wenhuorongbing-netizen/dev-the-spire/releases/latest",
    releasesPage: "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.132",
    ...
    meta: [
      ["\u6587\u4ef6", "SpirePlus-v0.1.0-private-beta.132.zip"],
      ["\u7248\u672c", "v0.1.0-private-beta.132"],
      ["\u663e\u793a\u540d", "Spire Plus"],
      ["\u4f9d\u8d56", "STS2-RitsuLib v0.4.34"],
      ["\u6e38\u620f\u7248\u672c", "Slay the Spire 2 v0.107.1"],
      ["\u4f53\u79ef", "19,050,165 \u5b57\u8282"],
      ["\u54c8\u5e0c", "19E910A0060A1E843D24F77E962A3F45B33F738B3B312EF4608D92E59BB49FD9"]
    ]
  },
  installSteps: [
    "\u4e0b\u8f7d SpirePlus-v0.1.0-private-beta.132.zip\u3002",
  ...
  forum: {
    ...
    links: [
      ...
      ["发布页", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.132"]
    ]
  },
  updateGroups: [
    {
  ...
  changeLog: [
    ...
    ["\u5f53\u524d\u5305", "SpirePlus-v0.1.0-private-beta.132.zip；游戏内显示名为 Spire Plus。"],
...
window.SPIRE_PLUS_DATA.i18n = {
  ...
  en: {
    ...
    package: {
      meta: [
        ["File", "SpirePlus-v0.1.0-private-beta.132.zip"],
        ["Version", "v0.1.0-private-beta.132"],
        ["Display name", "Spire Plus"],
        ["Dependency", "STS2-RitsuLib v0.4.34"],
        ["Game version", "Slay the Spire 2 v0.107.1"],
        ["Size", "19,050,165 bytes"],
        ["Hash", "19E910A0060A1E843D24F77E962A3F45B33F738B3B312EF4608D92E59BB49FD9"]
      ]
    },
    installSteps: [
      "Download SpirePlus-v0.1.0-private-beta.132.zip.",
    ...
    assetPolicy: [
      ...
      forum: {
        ...
        links: [
          ...
          ["Release Page", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.132"]
        ]
      },
    updateGroups: [
      {
    ...
    changeLog: [
      ...
      ["Current package", "SpirePlus-v0.1.0-private-beta.132.zip; the in-game display name is Spire Plus."],
