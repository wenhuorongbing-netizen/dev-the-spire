...
const mechanicGlossary = [
  mechanic(
    ...
    ["抽牌页：抽 2 张牌。", "帷幕页：获得 14 点格挡。", "焚页：对全体敌人造成 10 点伤害。", "折扣页：本回合下一张牌费用变为 0。", "勇气页：获得 2 点临时力量。", "敏捷页：获得 2 点临时敏捷。"],
  ...
  mechanic(
    ...
    ["第 1 回合额外抽 5 张牌并获得 2 点能量。", "回合结束时未打出的额外牌封存到消耗牌堆。", "第 3 回合以 0 费返回手牌（需有空位）。"],
    ["开卷", "开卷考试", "封存"],
  ...
  mechanic(
    ...
    ["I：打出移除；未打出恶化为 II。", "II：打出移除并加入 I；未打出恶化为 III。", "III：打出移除并加入 II；未打出保持 III 并额外加入 I。", "最多 4 张。休息时移除最高阶段。"],
  ...
  mechanic(
    ...
    ["第 3/4 回合若未抽到，强制移到抽牌堆顶部。", "从未抽到则战后枯萎消失。", "苗床种下视为已处理，不生成根蚀。"],
    ["根芽"],
  ...
  mechanic(
    ...
    ["每层使瓦库攻击 +2 伤害。", "战后每层扣除 15 赃物金币，不足部分以非致命生命支付。"],
    ["血债"],
  ...
  mechanic(
    "contract",
    "契约",
    "瓦库试炼中第 1、3、5 回合提供的抉择牌，用于破锁但通常增加血债。",
    ["刀契：对瓦库造成伤害，失去生命，破 1 锁 +1 血债。", "金契：获得能量和抽牌，失去生命，破 1 锁 +1 血债。", "避债契：获得格挡，移除血债。", "诈契：破 1 锁 +血债，强化瓦库下次攻击。", "收手：破锁后可随时结束战斗并带走奖励。"],
    ["契约", "刀契", "金契", "避债契", "诈契", "兑现"],
  ...
  mechanic(
    ...
    ["打出契约或单回合对瓦库造成 40 未格挡伤害可破锁。", "至少破 1 把锁才能收手结算。", "破锁收益优先偿还血债，剩余归你。"],
    ["赃物锁", "破锁"],
  ...
  mechanic(
    ...
    "裁决",
    "洛莎的爆发机制。打出的牌触发额外结算。",
    ["攻击牌和技能牌额外打出 1 次。", "能力牌变为 0 费并抽 1 张牌。", "延期判决在第 4 回合获得 3 层；若战斗提前结束，回复 4 点生命。"],
    ["裁决"],
  ...
  mechanic(
    ...
    "额外打出",
    "卡牌效果再次结算，不额外消耗能量。",
    ["攻击牌和技能牌的所有效果再结算一次。", "能力牌替换为 0 费并抽 1 张牌。", "同一效果不会递归触发自身。"],
    ["额外打出", "重放"],
  ...
  mechanic(
    ...
    ["债务清算：立即获得 220 金币、删牌和升级，记下 320 点债务。", "每战偿还 40 金币；每短缺 10 金币失去 3 点非致命生命。", "黄金之印等遗物会加入债务诅咒牌，被消耗时失去最多 5 金币。"],
    ["债务"],
  ...
  mechanic(
    "red_ink_debt",
    "红墨债",
    "莫尔维的短期透支。0 能量时可打出透支牌，获得抽牌和能量，战后用金币偿还。",
    ["每回合限 1 次。0 能量时抽 2 张牌、获得 1 点能量。", "战后每笔透支扣 12 金币，不足时失去 3 点非致命生命。"],
    ["红墨债", "透支"],
  ...
  mechanic(
    ...
    ["普通战 10%、战旗房 15%、火印精英 20%、首领 5%。", "仅限普通/罕见/稀有攻击和技能牌。排除 0 费、X 费、已附魔和消耗牌。"],
    ["裂变"],
  ...
  mechanic(
    ...
    ["击败后获得铸令（已持有则转化为 15 金币）。", "四种类型：烈力、巨体、锻甲、恒愈。", "溢火：宿主触发效果或弱点被打破时，部分能力扩散到一名其他敌人。"],
    ["火印", "火印精英"],
  ...
  mechanic(
    ...
    "铸令",
    "击败火印精英获得，在下一个休息处消耗。",
    ["休息：回复生命并随机升级 1 张普通/罕见牌（已全升级则额外回复 5 HP）。", "锻造：额外回复 7 HP。", "最多持有 1 枚；重复获得转化为 15 金币。"],
    ["铸令"],
  ...
  mechanic(
    ...
    ["五种规则：先锋、盾阵、血赏、压阵、残阵。", "盾阵和残阵需多敌人战；单敌人回退为血赏。", "战旗房卡牌奖励裂变率为 15%。"],
    ["战旗", "战旗房"],
...
window.SPIRE_PLUS_DATA = {
  ...
  summary: [
    {
      ...
      copy: "高进阶 A11-A20、先古奖励、遗物调整和预览工具，一个 Mod 搞定。每项改动都说明触发、收益、代价和战后结算。"
    },
    {
      title: "苗床和种下",
      copy: "苗床在污染牌进入手牌前拦截它，移出本场战斗并给你枯壳。临时状态/诅咒战后消失；根芽种下后不生成根蚀；根蚀种下后冻结状态。"
    },
    {
      title: "苗床为什么值得拿",
  ...
  package: {
    localDownload: "../publish/SpirePlus-v0.1.0-private-beta.125.zip",
    releaseDownload:
      "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.125/SpirePlus-v0.1.0-private-beta.125.zip",
    latestReleaseApi: "https://api.github.com/repos/wenhuorongbing-netizen/dev-the-spire/releases/latest",
    releasesPage: "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.125",
    ...
    meta: [
      ["\u6587\u4ef6", "SpirePlus-v0.1.0-private-beta.125.zip"],
      ["\u7248\u672c", "v0.1.0-private-beta.125"],
      ["\u663e\u793a\u540d", "Spire Plus"],
      ["\u4f9d\u8d56", "STS2-RitsuLib v0.4.34"],
      ["\u6e38\u620f\u7248\u672c", "Slay the Spire 2 v0.107.1"],
      ["\u4f53\u79ef", "19,048,002 \u5b57\u8282"],
      ["\u54c8\u5e0c", "F26783A66661F0BCA00C79822A16A3F3C4713FD08759FB9CA5545E3270E45492"]
    ]
  },
  installSteps: [
    "\u4e0b\u8f7d SpirePlus-v0.1.0-private-beta.125.zip\u3002",
    "下载 STS2-RitsuLib v0.4.34 或更新版本，并解压到游戏的 mods\\STS2-RitsuLib 目录。",
  ...
  requirements: [
    ...
    "STS2-RitsuLib v0.4.34；此版本按该依赖构建。",
  ...
  forum: {
    ...
    links: [
      ...
      ["发布页", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.125"]
    ]
  },
  updateGroups: [
    {
  ...
  changeLog: [
    ...
    ["\u5f53\u524d\u5305", "SpirePlus-v0.1.0-private-beta.125.zip；游戏内显示名为 Spire Plus。"],
...
window.SPIRE_PLUS_DATA.i18n = {
  zh: {
    ...
    requirements: [
      "Slay the Spire 2 public beta v0.107.1。",
      "STS2-RitsuLib v0.4.34。这个构建按该依赖版本测试。",
      "模组列表应显示 Spire Plus。",
  ...
  en: {
    ...
    package: {
      meta: [
        ["File", "SpirePlus-v0.1.0-private-beta.125.zip"],
        ["Version", "v0.1.0-private-beta.125"],
        ["Display name", "Spire Plus"],
        ["Dependency", "STS2-RitsuLib v0.4.34"],
        ["Game version", "Slay the Spire 2 v0.107.1"],
        ["Size", "19,048,002 bytes"],
        ["Hash", "F26783A66661F0BCA00C79822A16A3F3C4713FD08759FB9CA5545E3270E45492"]
      ]
    },
    installSteps: [
      "Download SpirePlus-v0.1.0-private-beta.125.zip.",
      "Download STS2-RitsuLib v0.4.34 or newer and extract it to the game's mods\\STS2-RitsuLib folder.",
    ...
    requirements: [
      "Slay the Spire 2 public beta v0.107.1.",
      "STS2-RitsuLib v0.4.34. This build targets that dependency version.",
    ...
    assetPolicy: [
      ...
      forum: {
        ...
        links: [
          ...
          ["Release Page", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.125"]
        ]
      },
    updateGroups: [
      {
    ...
    changeLog: [
      ...
      ["Current package", "SpirePlus-v0.1.0-private-beta.125.zip; the in-game display name is Spire Plus."],
