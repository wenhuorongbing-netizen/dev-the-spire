...
window.SPIRE_PLUS_DATA = {
  ...
  package: {
    localDownload: "../publish/SpirePlus-v0.1.0-private-beta.114.zip",
    releaseDownload:
      "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/download/v0.1.0-private-beta.114/SpirePlus-v0.1.0-private-beta.114.zip",
    latestReleaseApi: "https://api.github.com/repos/wenhuorongbing-netizen/dev-the-spire/releases/latest",
    releasesPage: "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.114",
    ...
    meta: [
      ["\u6587\u4ef6", "SpirePlus-v0.1.0-private-beta.114.zip"],
      ["\u7248\u672c", "v0.1.0-private-beta.114"],
      ["\u663e\u793a\u540d", "Spire Plus"],
      ["\u4f9d\u8d56", "STS2-RitsuLib v0.4.34"],
      ["\u6e38\u620f\u7248\u672c", "Slay the Spire 2 v0.107.1"],
      ["\u4f53\u79ef", "19,039,910 \u5b57\u8282"],
      ["\u54c8\u5e0c", "5CF6DA713066D91BF84D1AE019F30047D159CD3FA7F22F35AE42F9EAD9B86003"]
    ]
  },
  installSteps: [
    "\u4e0b\u8f7d SpirePlus-v0.1.0-private-beta.114.zip\u3002",
    "下载 STS2-RitsuLib v0.4.34 或更新版本，并解压到游戏�?mods\\STS2-RitsuLib 目录�?,
  ...
  forum: {
    ...
    links: [
      ...
      ["发布�?, "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.114"]
    ]
  },
  updateGroups: [
    {
  ...
  changeLog: [
    ...
    ["\u5f53\u524d\u5305", "SpirePlus-v0.1.0-private-beta.114.zip；游戏内显示名为 Spire Plus�?],
...
window.SPIRE_PLUS_DATA.i18n = {
  ...
  en: {
    ...
    package: {
      meta: [
        ["File", "SpirePlus-v0.1.0-private-beta.114.zip"],
        ["Version", "v0.1.0-private-beta.114"],
        ["Display name", "Spire Plus"],
        ["Dependency", "STS2-RitsuLib v0.4.34"],
        ["Game version", "Slay the Spire 2 v0.107.1"],
        ["Size", "19,039,910 bytes"],
        ["Hash", "5CF6DA713066D91BF84D1AE019F30047D159CD3FA7F22F35AE42F9EAD9B86003"]
      ]
    },
    installSteps: [
      "Download SpirePlus-v0.1.0-private-beta.114.zip.",
    ...
    assetPolicy: [
      ...
      forum: {
        ...
        links: [
          ...
          ["Release Page", "https://github.com/wenhuorongbing-netizen/dev-the-spire/releases/tag/v0.1.0-private-beta.114"]
        ]
      },
    updateGroups: [
      {
    ...
    changeLog: [
      ...
      ["Current package", "SpirePlus-v0.1.0-private-beta.114.zip; the in-game display name is Spire Plus."],
