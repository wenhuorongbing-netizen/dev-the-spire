...
public sealed partial class DocumentationCompactnessGuardTests
{
    ...
    public void DebugGoalStaysCompactAndArchivedPromptDumpStaysOutOfActivePath()
    {
        ...
        AssertSourceContains(
            debug,
            "# Debug Governance",
            "Current beta.116 package truth is RitsuLib-only",
    ...
    public void EventGoalStaysCompactAndFullLedgerStaysArchived()
    {
        ...
        AssertSourceContains(
            ...
            "Current package truth is beta.116 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.34`.",
    ...
    public void AncientV4DocsUseCurrentRuntimeTargetAndArchiveOldBaseline()
    {
        ...
        AssertSourceContains(
            ...
            "Current Spire Plus now compiles against `STS2.RitsuLib` `0.4.34`",
            "Historical runtime target in `docs/dev-environment.md`: public beta `v0.106.1`, source-refreshed locally on `2026-05-22`",
            "Historical local project package at the time: `previous package` `3.1.4`; current local project package: `STS2.RitsuLib` `0.4.34`",
        ...
        AssertSourceContains(
            ...
            "- Runtime framework: `STS2-RitsuLib` `v0.4.34` in direct NuGet runtime layout",
    ...
    public void RestructureDocStaysCurrentReadableAndRitsuLibOnly()
    {
        ...
        AssertSourceContains(
            ...
            "Current package/runtime target is Spire Plus `v0.1.0-private-beta.116`",
    ...
    public void CurrentAgentEntryDocsStayRitsuLibOnly()
    {
        ...
        AssertSourceContains(
            ...
            "2026-06-22 source-workspace recheck pass 58 checks / 0 mismatches",
    ...
    public void RitsuLibIntegrationDocsReflectCurrentActiveDependency()
    {
        ...
        AssertSourceContains(
            ...
            "The RitsuLib integration lane is current for beta.116",
            "compile package",
            "manifest dependency",
            "package parity",
        ...
        AssertSourceContains(
            ...
            "Spire Plus is RitsuLib-only for beta.116.",
        ...
        AssertSourceContains(
            ...
            "`0.4.34`, and Spire Plus `v0.1.0-private-beta.116`.",
            ...
            "Packaged beta.116 evidence covers build, publish, package parity, runtime preflight",
        ...
        AssertSourceContains(
            archiveReadme,
            "Current migration truth is beta.116 RitsuLib-only.",
            "current beta.116 RitsuLib-only routing is consolidated in `docs/goals/historical-revision-boundaries.md`.");
    ...
    public void HistoricalGoalRedTeamReviewStaysCompactAndArchivedOutOfActivePath()
    {
        ...
        AssertSourceContains(
            ...
            "Previous beta.108 forced Ancient clicked UI smoke is retained");
    ...
    public void CurrentValidationStaysCompactAndFullLedgerStaysArchived()
    {
        ...
        AssertSourceContains(
            ...
            "Current package target is Spire Plus `v0.1.0-private-beta.116`",
