...
public sealed class DocumentationCompactnessGuardTests
{
    ...
    public void ProjectStateStaysCurrentAndHistoricalPassLogIsArchived()
    {
        ...
        Assert.Contains("beta.45 Rooted Route reward split package sync", projectState, StringComparison.Ordinal);
    ...
    public void IssuesQueueStaysCompactAndDoesNotBecomeAReleaseJournal()
    {
        ...
        AssertSourceContains(
            ...
            "current committed worktree is clean after the beta.45 batch commit",
    ...
    public void CurrentGovernanceDocsDoNotCarryStaleCleanupState()
    {
        ...
        AssertSourceContains(
            ...
            "beta.45 startup remains pending",
            "beta.45 loader proof still needs a fresh run");
        AssertSourceContains(
            docsByPath["docs/worktree-cleanup-audit.md"],
            "Current beta.45 evidence should be read from the latest validated HEAD");
        AssertSourceContains(
            docsByPath["docs/worktree-cleanup-audit.md"],
    ...
    public void CurrentReleaseDocsAvoidReleaseJournalLines()
    {
        ...
        AssertSourceContains(
            ...
            "Detailed pass history lives in `docs/review.md` and `docs/archive/**`.",
            "Fresh loader smoke for the current beta.45 package hash is pending",
