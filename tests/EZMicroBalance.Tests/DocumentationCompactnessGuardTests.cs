...
public sealed class DocumentationCompactnessGuardTests
{
    ...
    public void ProjectStateStaysCurrentAndHistoricalPassLogIsArchived()
    {
        ...
        Assert.Contains("beta.79 ReleaseEvidence manual handoff test split package sync", projectState, StringComparison.Ordinal);
    ...
    public void IssuesQueueStaysCompactAndDoesNotBecomeAReleaseJournal()
    {
        ...
        AssertSourceContains(
            ...
            "current committed worktree is clean after the beta.79 batch commit",
    ...
    public void CurrentGovernanceDocsDoNotCarryStaleCleanupState()
    {
        ...
        AssertSourceContains(
            ...
            "beta.79 startup remains pending",
            "beta.79 loader proof still needs a fresh run");
        AssertSourceContains(
            docsByPath["docs/worktree-cleanup-audit.md"],
            "Current beta.79 evidence should be read from the latest validated HEAD");
        AssertSourceContains(
            docsByPath["docs/worktree-cleanup-audit.md"],
        ...
        AssertSourceContains(
            docsByPath["docs/features/ancients-rework-v4/completion-audit.md"],
            "avoid copying stale historical commit labels into beta.79 handoff notes");
    ...
    public void CurrentReleaseDocsAvoidReleaseJournalLines()
    {
        ...
        AssertSourceContains(
            ...
            "Detailed pass history lives in `docs/review.md` and `docs/archive/**`.",
            "Fresh loader smoke for the current beta.79 package hash is pending",
