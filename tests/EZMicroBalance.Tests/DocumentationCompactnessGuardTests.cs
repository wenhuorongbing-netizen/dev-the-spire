...
public sealed partial class DocumentationCompactnessGuardTests
{
    ...
    public void DebugGoalStaysCompactAndArchivedPromptDumpStaysOutOfActivePath()
    {
        ...
        AssertSourceContains(
            debug,
            "# Debug Governance",
            "Current beta.117 package truth is RitsuLib-only",
    ...
    public void EventGoalStaysCompactAndFullLedgerStaysArchived()
    {
        ...
        AssertSourceContains(
            ...
            "Current package truth is beta.117 on Slay the Spire 2 `v0.107.1` with STS2-RitsuLib `v0.4.34`.",
    ...
    public void RestructureDocStaysCurrentReadableAndRitsuLibOnly()
    {
        ...
        AssertSourceContains(
            ...
            "Current package/runtime target is Spire Plus `v0.1.0-private-beta.117`",
    ...
    public void RitsuLibIntegrationDocsReflectCurrentActiveDependency()
    {
        ...
        AssertSourceContains(
            ...
            "The RitsuLib integration lane is current for beta.117",
            "compile package",
            "manifest dependency",
            "package parity",
        ...
        AssertSourceContains(
            ...
            "Spire Plus is RitsuLib-only for beta.117.",
        ...
        AssertSourceContains(
            ...
            "`0.4.34`, and Spire Plus `v0.1.0-private-beta.117`.",
            ...
            "Packaged beta.117 evidence covers build, publish, package parity, runtime preflight",
        ...
        AssertSourceContains(
            archiveReadme,
            "Current migration truth is beta.117 RitsuLib-only.",
            "current beta.117 RitsuLib-only routing is consolidated in `docs/goals/historical-revision-boundaries.md`.");
    ...
    public void CurrentValidationStaysCompactAndFullLedgerStaysArchived()
    {
        ...
        AssertSourceContains(
            ...
            "Current package target is Spire Plus `v0.1.0-private-beta.117`",
