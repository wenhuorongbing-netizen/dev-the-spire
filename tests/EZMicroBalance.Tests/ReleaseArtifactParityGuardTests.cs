...
public sealed partial class ReleaseArtifactParityGuardTests
{
    ...
    public void DisabledSpirePlusPlugOffEvidenceSupportsDocs()
    {
        ...
        if (!Directory.Exists(evidenceDir))
        {
            ...
            Assert.Contains("current beta.92 Off proof is loader evidence only and does not prove disable-mod gameplay inside a run", currentDocs, StringComparison.Ordinal);
            return;
        }
