...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Fresh loader smoke for the current beta.74 package hash is pending", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.74 RootBud combat-end split package sync", projectState, StringComparison.Ordinal);
