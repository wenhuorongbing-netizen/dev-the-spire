...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.118 because settings code/resources did not change in the beta.108 pass.", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("Latest package target is beta.118", projectState, StringComparison.Ordinal);
