...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void PrivateBetaReleaseCompletionAuditMapsFinishGoalToActualEvidenceAndOpenBlockers()
    {
        ...
        AssertSourceContains(
            ...
            "## Missing Or Weakly Verified Items",
            "## Conclusion",
            "295 passed / 20 skipped",
            "315 passed / 0 skipped",
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Fresh loader smoke for the current beta.46 package hash is pending", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.46 Trial Branch combat resolution split package sync", projectState, StringComparison.Ordinal);
