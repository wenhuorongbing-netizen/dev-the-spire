...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void TestReadyCompletionAuditMapsGoalToConcreteArtifacts()
    {
        ...
        Assert.Contains("Previous beta.107 clicked Ancient UI smoke is `.tools/runtime-evidence/monkey-stability-beta107-rerun-20260622-144051/`", audit, StringComparison.Ordinal);
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.108 because settings code/resources did not change in the beta.108 pass.", currentDocs, StringComparison.Ordinal);
