...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.135 and should be recaptured if the settings row becomes release-blocking.", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("Latest package target is beta.135", projectState, StringComparison.Ordinal);
