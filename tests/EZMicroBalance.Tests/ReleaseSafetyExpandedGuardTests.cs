...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Fresh loader smoke for the current beta.55 package hash is pending", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.55 Chosen Decree card-state split and Rootblight combat-start repair package sync", projectState, StringComparison.Ordinal);
