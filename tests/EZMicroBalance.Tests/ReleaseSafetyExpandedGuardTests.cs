...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void ReleaseEvidenceVerifierCoversManualBlockersBeforeReleaseClaims()
    {
        ...
        AssertSourceContains(
            verifier,
            "PackageSha256 = \"1AAB42699E3FD7B837ADA9719BEE0F446DF7CD4F590B0C3278C1C411CFD7A7A0\"",
            "PackagePath = \"publish\\SpirePlus-v0.1.0-private-beta.13.zip\"",
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Latest normal Steam-client startup/log verification covers the current beta.13 package hash", currentDocs, StringComparison.Ordinal);
