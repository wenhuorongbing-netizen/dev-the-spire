...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void TestReadyCompletionAuditMapsGoalToConcreteArtifacts()
    {
        ...
        Assert.Contains("Previous beta.108 clicked Ancient UI smoke is `.tools/runtime-evidence/monkey-stability-beta108-20260622-172312/`", audit, StringComparison.Ordinal);
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("- [x] STS2-RitsuLib appears in Mod Settings for the beta.99 RitsuLib-only package; this is previous-package context after beta.113 because settings code/resources did not change in the beta.108 pass.", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("Latest package target is beta.113", projectState, StringComparison.Ordinal);
