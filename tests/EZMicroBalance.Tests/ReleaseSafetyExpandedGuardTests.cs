...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Fresh loader smoke for the current beta.66 package hash is pending", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.66 Vakuu Contract offer split package sync", projectState, StringComparison.Ordinal);
