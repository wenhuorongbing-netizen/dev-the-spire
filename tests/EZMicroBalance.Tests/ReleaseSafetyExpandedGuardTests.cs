...
public sealed class ReleaseSafetyExpandedGuardTests
{
    ...
    public void CurrentFacingDocsStillFailOnFalseReleaseClaims()
    {
        ...
        Assert.Contains("Fresh loader smoke for the current beta.83 package hash is pending", currentDocs, StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.83 Urda Seedbed Harmony patch bugfix", projectState, StringComparison.Ordinal);
