...
public sealed partial class ReleasePackageArtifactGuardTests
{
    ...
    public void CurrentDocsMatchReleaseHashesAndAvoidPinnedStaleTestTotals()
    {
        ...
        Assert.Contains("current beta.95 list plus Spire Plus config-page proof remains pending under release-evidence row `mod-settings-current-display`", docsByPath["docs/release-checklist.md"], StringComparison.Ordinal);
