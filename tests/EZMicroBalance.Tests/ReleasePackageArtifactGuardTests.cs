...
public sealed partial class ReleasePackageArtifactGuardTests
{
    ...
    public void CurrentDocsMatchReleaseHashesAndAvoidPinnedStaleTestTotals()
    {
        ...
        Assert.Contains("Current beta.93 RitsuLib-only Off proof has been recaptured", docsByPath["docs/release-checklist.md"], StringComparison.Ordinal);
        Assert.Contains("Current beta.93 AdditiveBatch1 registration proof has been recaptured", docsByPath["docs/release-checklist.md"], StringComparison.Ordinal);
        ...
        Assert.Contains("current beta.93 list plus Spire Plus config-page proof remains pending under release-evidence row `mod-settings-current-display`", docsByPath["docs/release-checklist.md"], StringComparison.Ordinal);
