...
public sealed partial class AncientHighRiskSourceGuardTests
{
    ...
    public void PickupRewardCompensationAndLockoutPatchesStayScoped()
    {
        ...
        AssertSourceContains(
            ...
            "ModPatchTarget(typeof(RelicModel), nameof(RelicModel.IconPath), MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), nameof(RelicModel.PackedIconPath), MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), \"PackedIconOutlinePath\", MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), \"BigIconPath\", MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), nameof(RelicModel.Icon), MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), nameof(RelicModel.IconOutline), MethodType.Getter)",
            "ModPatchTarget(typeof(RelicModel), nameof(RelicModel.BigIcon), MethodType.Getter)",
