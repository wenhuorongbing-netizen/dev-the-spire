...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        AssertSourceContains(
            ...
            "- [x] Fresh loader smoke for the current beta.86 ZIP hash is clean",
            "- [x] Latest loader smoke for the current beta.86 package hash reached main menu",
            ...
            "current beta.86 list plus Spire Plus config-page proof remains pending under release-evidence row `mod-settings-current-display`",
