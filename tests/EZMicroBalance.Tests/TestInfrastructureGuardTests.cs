...
public sealed class TestInfrastructureGuardTests
{
    ...
    public void OwnerSensitiveLocalMaterialStaysIgnoredAndDecisionTracked()
    {
        ...
        AssertSourceContains(
            ...
            "| `publish/` | Retained current beta.80 package/staging/cover-source output; stale beta.0-beta.78 ZIPs and expanded folders are removed by the guarded prune after confirming current-package hash/path parity. Future prune should happen only after a new package rebuild/hash refresh. |",
