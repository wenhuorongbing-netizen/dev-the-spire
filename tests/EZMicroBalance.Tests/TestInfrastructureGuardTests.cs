...
public sealed class TestInfrastructureGuardTests
{
    ...
    public void OwnerSensitiveLocalMaterialStaysIgnoredAndDecisionTracked()
    {
        ...
        AssertSourceContains(
            ...
            "| `publish/` | Retained current beta.47 package/staging/cover-source output; stale beta.0-beta.46 ZIPs and expanded folders were deleted after confirming current-package hash/path parity. Future prune should happen only after a new package rebuild/hash refresh. |",
