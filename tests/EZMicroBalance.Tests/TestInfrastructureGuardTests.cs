...
public sealed class TestInfrastructureGuardTests
{
    ...
    public void OwnerSensitiveLocalMaterialStaysIgnoredAndDecisionTracked()
    {
        ...
        AssertSourceContains(
            ...
            "| `publish/` | Retained current beta.38 package/staging/cover-source output; stale beta.0-beta.33 ZIPs and expanded package folders were deleted after confirming current-package hash/path parity. Future prune should happen only after a new package rebuild/hash refresh. |",
