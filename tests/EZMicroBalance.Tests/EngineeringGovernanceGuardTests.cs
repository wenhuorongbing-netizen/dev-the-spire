...
public sealed class EngineeringGovernanceGuardTests
{
    ...
    public void ReleaseEvidenceDashboardKeepsLiveRowsOpen()
    {
        ...
        AssertSourceContains(
            ...
            "standalone startup evidence exists for the loader row",
            "copy those files into the handoff row before expecting the verifier to fail closed with 19 remaining manual/live rows",
