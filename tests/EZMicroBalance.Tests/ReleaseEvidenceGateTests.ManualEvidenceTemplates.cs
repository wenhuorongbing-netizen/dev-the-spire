...
public sealed partial class ReleaseEvidenceGateTests
{
    ...
    public void DefaultModeDoesNotRequireLiveEvidenceButBlocksReleaseReadyClaims()
    {
        ...
        Assert.Contains("Fresh beta.93 RitsuLib-only Off proof", projectState, StringComparison.Ordinal);
        Assert.Contains("Fresh beta.93 RitsuLib-only AdditiveBatch1 proof", projectState, StringComparison.Ordinal);
