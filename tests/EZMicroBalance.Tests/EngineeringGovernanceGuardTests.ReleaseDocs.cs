...
public sealed partial class EngineeringGovernanceGuardTests
{
    ...
    public void ReleaseEvidenceDashboardKeepsLiveRowsOpen()
    {
        ...
        AssertSourceContains(
            ...
            "Gameplay, clicked Ancient UI, save-load, preview-tools live behavior, beta.99 direct Off loader proof, current enabled-mode proof, Vakuu, co-op, and full release-evidence packaging rows remain pending",
