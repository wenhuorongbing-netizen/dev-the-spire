...
public sealed partial class EngineeringGovernanceGuardTests
{
    ...
    public void ReleasePlanningDocsExistAndKeepLiveRowsOpen()
    {
        ...
        AssertSourceContains(
            ...
            "Fresh current-package loader smoke | Historical beta.85 `v0.107.0` Off loader smoke was clean for startup only; current beta.92 RitsuLib-only Off/AdditiveBatch1 proof supersedes it for startup/registration, while live gameplay/manual runs are still pending",
