...
| `AncientPlayerFacingPolishGuardTests.cs` / `AncientPlayerFacingPolishGuardTests.Localization.cs` | Player-facing Ancient text, docs, localization, mojibake, rich-text, and readability guards. |
