...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void PatchTargetsAreDeclaredForImplementedAncientSurfaces()
    {
        ...
        AssertSourceContains(
            ...
            "class PrismaticGemPoolPatch : IPatchMethod",
            "IPatchMethod.PatchId => \"prismatic-gem-pool-noop\"",
            "new ModPatchTarget(",
            "typeof(PrismaticGem)",
            "nameof(PrismaticGem.ModifyCardRewardCreationOptions)",
            "[typeof(Player), typeof(CardCreationOptions)])",
            "class PrismaticGemRewardScreenContextPatch : IPatchMethod",
            "IPatchMethod.PatchId => \"prismatic-gem-reward-screen-context\"",
