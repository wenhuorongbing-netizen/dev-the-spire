...
public sealed class AncientBehaviorGuardTests
{
    ...
    {
        var packagePath = RepoPath("publish", "SpirePlus-v0.1.0-private-beta.20.zip");
        ...
        Assert.Contains("Archive: SpirePlus-v0.1.0-private-beta.20.zip", readme, StringComparison.Ordinal);
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        AssertSourceContains(
            ...
            "- [ ] Fresh loader smoke for the current beta.20 ZIP hash is pending.",
