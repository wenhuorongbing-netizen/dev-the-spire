...
public sealed class AncientBehaviorGuardTests
{
    ...
    {
        var packagePath = RepoPath("publish", "SpirePlus-v0.1.0-private-beta.14.zip");
        ...
        Assert.Contains("Archive: SpirePlus-v0.1.0-private-beta.14.zip", readme, StringComparison.Ordinal);
