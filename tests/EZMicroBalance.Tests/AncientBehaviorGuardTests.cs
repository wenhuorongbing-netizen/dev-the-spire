...
public sealed class AncientBehaviorGuardTests
{
    ...
    {
        var packagePath = RepoPath("publish", "SpirePlus-v0.1.0-private-beta.13.zip");
        ...
        Assert.Contains("Archive: SpirePlus-v0.1.0-private-beta.13.zip", readme, StringComparison.Ordinal);
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        AssertSourceContains(
            ...
            "- [ ] Latest loader smoke confirms the game reaches startup completion with only BaseLib and Spire Plus loaded for the current package hash.",
