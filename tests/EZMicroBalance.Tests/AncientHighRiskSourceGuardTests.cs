...
public sealed partial class AncientHighRiskSourceGuardTests
{
    ...
    public void SavedStateKeysAreUniqueSerializableAndScopedToActiveMod()
    {
        ...
        AssertSourceContains(
            savedFields,
            "SavedAttachedState<PrismaticGem, int> PrismaticGemNormalRewardCounter",
            "SavedAttachedState<PaelsTooth, int> PaelsToothNonBossCombatCounter",
            "SavedAttachedState<CardModel, bool> JewelryBoxNonInnateApotheosis",
            "SavedAttachedState<Player, string> UrdaStateKey",
            "SavedAttachedState<CardModel, string> UrdaDeckStateKey",
            "SavedAttachedState<CardModel, bool> UrdaTrialPlantCard",
            ...
            "SavedAttachedState<Player, string> AncientInitialOptionRerollStateKey",
