...
public sealed class WebsiteContentGuardTests
{
    ...
    public void WebsiteHardcodedGameplaySummariesStayCurrent()
    {
        ...
        AssertSourceContains(
            ...
            "Eligible: Temporary Status/Curse cards, Blight Sprouts, and Rootblight",
            "2/3 slots. Immediate plants consume slots",
            "拦截污染牌让抽牌更干净",
            "苗床为什么值得拿",
            "拦截污染牌让抽牌更干净",
            "根蚀种下后冻结状态",
            ...
            "不属于打出、弃牌或消耗",
            "根芽种下后不生成根蚀",
            "Planting removes a card from combat and gives 1 Withered Husk",
            "It is not play, discard, or Exhaust",
            "Eligible: Temporary Status/Curse cards, Blight Sprouts, and Rootblight",
            "Planted Blight Sprouts are resolved and add no Rootblight after combat",
