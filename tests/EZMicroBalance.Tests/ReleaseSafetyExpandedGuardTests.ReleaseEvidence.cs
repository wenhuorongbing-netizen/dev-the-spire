...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void PrivateBetaReleaseCompletionAuditMapsFinishGoalToActualEvidenceAndOpenBlockers()
    {
        ...
        AssertSourceContains(
            ...
            "static suite 15 / 0",
            "beta.97 RitsuLib-only source/build/publish/package refresh",
            "beta.97 loader/settings proof pending, previous beta.96 Off loader proof, previous beta.93 AdditiveBatch1 loader/registration proof",
