...
public sealed partial class ReleaseSafetyExpandedGuardTests
{
    ...
    public void PrivateBetaReleaseCompletionAuditMapsFinishGoalToActualEvidenceAndOpenBlockers()
    {
        ...
        AssertSourceContains(
            ...
            "static suite 15 / 0",
            "beta.129 RitsuLib-only source/build/publish/package refresh",
            "runtime preflight, and source-workspace validation; previous beta.128 clicked Ancient UI smoke remains previous-package smoke-level proof.",
