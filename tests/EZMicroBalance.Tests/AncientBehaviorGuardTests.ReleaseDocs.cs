...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        AssertSourceContains(
            ...
            "- [x] Fresh RitsuLib-only Off loader smoke for the current beta.91 ZIP hash is captured after the latest RitsuLib package refresh",
            ...
            "Current beta.91 AdditiveBatch1 registration proof has been recaptured under `.tools\\runtime-evidence\\v01071-beta91-ritsulib0428-additivebatch1-direct-20260620`",
            ...
            "current beta.91 list plus Spire Plus config-page proof remains pending under release-evidence row `mod-settings-current-display`",
