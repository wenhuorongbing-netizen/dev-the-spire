...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        AssertSourceContains(
            ...
            "Previous beta.99 RitsuLib Mod Settings UI proof is captured under `.tools\\runtime-evidence\\mod-settings-beta99-ritsulib-click-20260621-223210`",
        ...
        Assert.Contains("Status: automated gates passed for the current RitsuLib-only beta.107 package shape.", manualMatrix, StringComparison.Ordinal);
        Assert.Contains("Beta.107 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-beta107-rerun-20260622-144051/`", manualMatrix, StringComparison.Ordinal);
