...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        Assert.Contains("Status: automated gates passed for the current RitsuLib-only beta.122 package shape.", manualMatrix, StringComparison.Ordinal);
        Assert.Contains("Current beta.122 clicked Ancient UI smoke is captured under `.tools/runtime-evidence/monkey-stability-beta122-20260622-230109/`", manualMatrix, StringComparison.Ordinal);
