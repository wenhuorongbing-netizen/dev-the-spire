...
public sealed partial class AncientBehaviorGuardTests
{
    ...
    public void ReleaseChecklistKeepsPendingRuntimeGatesAndManualRowsExplicit()
    {
        ...
        Assert.Contains("Status: automated gates passed for the current RitsuLib-only beta.131 no-launch package shape; previous beta.128 clicked UI smoke is retained separately.", manualMatrix, StringComparison.Ordinal);
