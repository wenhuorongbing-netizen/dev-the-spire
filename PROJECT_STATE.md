...
- Latest in-progress validation target 2026-05-25 is the beta.19 Seedbed explanation and mod-overview refresh: Seedbed is strengthened to 8/12 Block, immediately plants 1/2 eligible draw/discard cards, and the mod/site text now explains that Planting removes a card from this combat without playing, discarding, or exhausting it. `publish/SpirePlus-v0.1.0-private-beta.19.zip` was rebuilt and copied to the game root. The beta.17 Steam-client loader smoke under `.tools/runtime-evidence/beta17-loader-smoke-20260525-194311` remains historical startup evidence only; beta.19 needs a fresh loader smoke before startup parity is claimed. Gameplay, clicked UI, save-load, route traversal, preview-tools, Vakuu, and co-op rows remain pending.
...
- The previous Steam-client loader smoke under `.tools/runtime-evidence/release-ready-manual/fresh-current-package-loader-smoke` remains beta.13 historical startup context. The beta.17 package has newer historical loader/startup evidence; current beta.19 startup, Vakuu Sere Talon event-option, relic-bar, inspect-screen, hover, gameplay, save-load, and co-op rows remain pending.
...
- Current source defines 30 SavedSpireFields. The latest Steam-client startup/log evidence under `.tools/runtime-evidence/beta17-loader-smoke-20260525-194311` loaded exactly BaseLib plus Spire Plus, config registered, `Found 30 SavedSpireFields`, startup completion reached, 0 release-blocking log signatures were found, stopped the game, and helper restore completed. That row is now beta.17 historical evidence; beta.19 has not been live-loader-smoked. Previous beta.13, `20260524-161744`, `20260523-current`, `Found 22 SavedSpireFields`, and 16-field loader logs remain historical context only.
