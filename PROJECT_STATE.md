...
- Latest pushed cleanup/package evidence baseline: the latest beta.37 package-evidence baseline remains `efb3dc4 Refresh beta37 package evidence and Royal Decree guard`; later docs-only cleanup commits may move HEAD without changing package evidence.
