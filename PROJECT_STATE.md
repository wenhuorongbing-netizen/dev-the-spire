...
- Latest in-progress validation target 2026-05-25 is the beta.18 Seedbed explanation and mod-overview refresh: Seedbed is strengthened to 8/12 Block, immediately plants 1/2 eligible draw/discard cards, and the mod/site text now explains that Planting removes a card from this combat without playing, discarding, or exhausting it. `publish/SpirePlus-v0.1.0-private-beta.18.zip` was rebuilt and copied to the game root. The beta.17 Steam-client loader smoke under `.tools/runtime-evidence/beta17-loader-smoke-20260525-194311` remains historical startup evidence only; beta.18 needs a fresh loader smoke before startup parity is claimed. Gameplay, clicked UI, save-load, route traversal, preview-tools, Vakuu, and co-op rows remain pending.
...
- The previous Steam-client loader smoke under `.tools/runtime-evidence/release-ready-manual/fresh-current-package-loader-smoke` remains beta.13 historical startup context. The beta.17 package has newer historical loader/startup evidence; current beta.18 startup, Vakuu Sere Talon event-option, relic-bar, inspect-screen, hover, gameplay, save-load, and co-op rows remain pending.
